    ...
    `}tempToColor(e){if(null==e)return"#64b5f6";const t=(Math.max(50,Math.min(140,e))-50)/90;if(t<.33){return`rgb(${Math.round(30+3*t*70)},${Math.round(130+3*t*70)},${Math.round(245-3*t*50)})`}if(t<.66){const e=(t-.33)/.33;return`rgb(${Math.round(100+155*e)},${Math.round(200-50*e)},${Math.round(195-145*e)})`}{const e=(t-.66)/.34;return`rgb(${Math.round(255)},${Math.round(150-80*e)},${Math.round(50-30*e)})`}}renderFloorSystem(){const e=this.floorSystem;if(!e)return null;const t=e.return_temp?.value,r=e.supply_temp?.value,s=this.tempToColor(t),o=this.tempToColor(r),i=e.return_temp?.unit??"°",n=e.supply_temp?.unit??"°",a=this._config.floor_system,l=(!1!==a&&a?.heater_image?.trim()?a.heater_image.trim():void 0)??"data:image/png;base64,",c=136,d=136,p=132,u=12,A=14,f=180.96,h=p+77.52;return D`
      <div class="floor-system tankless-visual">
        <svg class="tankless-svg" viewBox="0 0 400 210" preserveAspectRatio="xMidYMid meet">
          ...
          <rect x="${173.96}" y="${146}" width="14" height="10" rx="2" fill="#b87333" stroke="#8b5a2b" stroke-width="0.5"/>
          <rect x="${h-7}" y="${146}" width="14" height="10" rx="2" fill="#b87333" stroke="#8b5a2b" stroke-width="0.5"/>

          <!-- Outlet pipe (hot supply) — sweeps from left edge down and curves up into heater stub -->
          <path d="M 0,${169} L ${140.96},${169} Q ${f},${169} ${f},${156}"
          ...
          <path d="M 400,${169} L ${h+40},${169} Q ${h},${169} ${h},${156}"
            fill="none" stroke="rgba(200,200,210,0.35)" stroke-width="${A}" stroke-linecap="round"/>
          <path d="M 400,${169} L ${h+40},${169} Q ${h},${169} ${h},${156}"
            fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="${12}" stroke-linecap="round"/>
          <path d="M 397,${169} L ${h+40},${169} Q ${h},${169} ${h},${156}"
            fill="none" stroke="url(#inletFlow)" stroke-width="${10}" stroke-linecap="round"/>
          <!-- Glass highlight on horizontal section -->
          <path d="M ${h+44},${164} L 394,${164}"
            fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="2" stroke-linecap="round"/>
          ...
          ${null!=e.delta_t?D`
                <rect x="170" y="${190}" width="60" height="16" rx="8" fill="rgba(255,255,255,0.08)" stroke="rgba(255,255,255,0.15)" stroke-width="0.8"/>
                <text x="200" y="${202}" font-size="9" text-anchor="middle" fill="rgba(255,255,255,0.7)" font-family="sans-serif" font-weight="600">ΔT ${e.delta_t}°</text>
              `:""}
        </svg>
      </div>
