...
`;function me(e,t,r){const s=t.sensor_heights?.[e];return null==s||Number.isNaN(s)?r?.isFloor?0:r?.isRoom?5:void 0:s}function ge(e,t,r){const s=t.reference_height_ft??5,o=function(e,t,r){const s=[],o=t.sensor_heights??{},n=t.zone_heights??{},i=(e,r,n,i)=>{if(null==r)return;const a=(n?o[n]:void 0)??me(n??"",t,i);null!=a&&s.push({label:e,temp:r,height_ft:a})};if(null!=e.sensors.floor&&i("Floor",e.sensors.floor,e.linked_sensor_ids?.floor,{isFloor:!0}),null!=e.sensors.room&&i("Room",e.sensors.room,e.linked_sensor_ids?.room,{isRoom:!0}),null!=r){const o=n[e.climate_entity]??t.reference_height_ft??5;s.push({label:"Thermostat",temp:r,height_ft:o})}for(const t of e.roomSensors)null!=t.value&&null!=t.height_ft&&s.push({label:t.name,temp:t.value,height_ft:t.height_ft});return s}(e,t,r);if(!o.length)return null;const n=Math.round(o.reduce((e,t)=>e+t.temp,0)/o.length*10)/10,{value:i,gradient:a}=function(e,t){if(!e.length)return{};if(1===e.length)return{value:e[0].temp};const r=e.length,s=e.reduce((e,t)=>e+t.height_ft,0),o=e.reduce((e,t)=>e+t.temp,0),n=e.reduce((e,t)=>e+t.height_ft*t.temp,0),i=e.reduce((e,t)=>e+t.height_ft*t.height_ft,0),a=r*i-s*s;if(Math.abs(a)<1e-6){const e=o/r;return{value:Math.round(10*e)/10}}const l=(r*n-s*o)/a,c=l*t+(o-l*s)/r;return{value:Math.round(10*c)/10,gradient:Math.round(100*l)/100}}(o,s);return{reference_height_ft:s,point_count:o.length,simple_average:n,estimated_at_reference:i,gradient_per_ft:a}}const be=["deye","sunsynk","sol-ark","battery","oven","cavity","inverter","outdoor","outside","exterior","sensorlinx","ubiquiti","unifi","udm","usg","usw","uap","uxg","udr","unvr","unifi_","dream machine","dream router","ultra switch","ap ","ap_backyard","ap_","xgs","_poe","port_","clients","wlan","speedtest","wan ","lan ","firmware","device tracker","poe temperature","switch temperature","cpu","memory","utilization","uptime","signal level","cloud connection","access point","printer","toner","cartridge"," ink","officejet","laserjet","envy","deskjet","tankless","water heater","hot water","inlet temp","outlet temp","weather","tempest","weatherflow","wet bulb","dew point","feels like","heat index","wind chill","wind speed","wind gust","wind bearing","wind direction","barometric","sea level pressure","air density","solar radiation","uv index","lightning","precipitation","rain rate","rain accumulation","visibility","cloud base","beaufort"],ve=["outlet","plug","switch","hallway","flex","unifi","usw","uap","udm","signal level","cloud connection","network","uptime","cpu","memory","mac","energy","power","voltage","current","consumption","co2","voc","aqi","auto-off","auto-update","led","overheated","smooth on","smooth off"],xe=[{name:"Main Floor",zones:["Laundry","Living Room","Main Area","Main Office","Redmond Thermostat"],room_sensors:["Family Room","Kitchen","Hallway","Stairs","Entryway","Primary Bath","Primary Bedroom"]},{name:"Upper Floor",zones:[],room_sensors:["Hunters","Sydney","Upstair Office","Upstairs Office"]}],ye={office:"Main Floor","Main Office":"Main Floor",upstairs_office:"Upper Floor",upstairs_hallway:"Upper Floor",hunters_room:"Upper Floor",sidney_s_room:"Upper Floor","Upstairs Office":"Upper Floor","Upstairs Hallway":"Upper Floor","Hunters Room":"Upper Floor","Sidney's Room":"Upper Floor"},ze={};function we(e,t){const r=Re(e),s=Re(t);if(r===s)return!0;const o=r.split(" "),n=s.split(" ");return o[0]===n[0]&&o.length>1&&n.length>1&&"main"===o[0]?o.slice(1).join(" ")===n.slice(1).join(" "):r.includes(s)||s.includes(r)}function ke(e){const t=e.areas;return t?Object.entries(t).map(([e,t])=>({area_id:e,name:t.name??e})).filter(e=>!["weather","whole_house_energy"].includes(e.area_id)).sort((e,t)=>e.name.localeCompare(t.name)):[]}function Se(e){return(e.floors??xe).map(e=>e.name)}function Ee(e,t,r){const s=function(e){return{...ye,...e.area_floor_map??{}}}(r);return e&&s[e]?s[e]:t&&s[t]?s[t]:void 0}function We(e,t,r=t.floors??xe){const s=function(e){return{...ze,...e.zone_floors??{}}}(t);if(s[e.climate_entity])return s[e.climate_entity];for(const t of r)if(t.zones?.some(t=>we(e.name,t)))return t.name;const o=Ee(e.area_id,e.area,t);return o||(e.floor?e.floor:Je(e.name,e.area,r))}function Ve(e){const t=e.trim().split(/\s+/);if(t.length>=2&&t.length%2==0){const e=t.length/2;if(t.slice(0,e).join(" ")===t.slice(e).join(" "))return t.slice(0,e).join(" ")}return e}function Re(e){return e.toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Ze(e){return e.attributes.friendly_name??e.entity_id}function Ne(e,t){const r=e.entities?.[t];if(r?.area_id)return r.area_id;const s=r?.device_id;if(s){const t=e.devices?.[s]?.area_id;if(t)return t}}function Ce(e,t){if(!t)return;const r=e.areas;return r?.[t]?.name}function qe(e){if(!e||"unavailable"===e.state||"unknown"===e.state)return;const t=parseFloat(e.state);return isNaN(t)?void 0:Math.round(10*t)/10}function Oe(e,t){if(t)return e.states[t]}function Ie(e){const t=new Set(e.exclude_entities??[]);for(const r of e.sensor_assignments??[])r.hidden&&t.add(r.entity_id);return t}function Pe(e){const t=new Map(Object.entries(e.sensor_map??{}));for(const r of e.sensor_assignments??[])r.zone&&!r.hidden&&t.set(r.entity_id,r.zone);return t}function Me(e,t,r=[]){const s=`${Re(e)} ${Re(t)}`;return[...be,...r].some(e=>s.includes(Re(e)))}function je(e){const t=e.replace(/^climate\./,""),r=t.split("_");if(r.length>=2&&r.length%2==0){const e=r.length/2,t=r.slice(0,e).join("_");if(t===r.slice(e).join("_"))return t}return t}function Xe(e,t,r){if(r.has(e))return!0;const s=Re(t);return s.includes("current temperature")&&s.includes("thermostat")}function He(e){const t=e.attributes.device_class;if("temperature"===t||"humidity"===t)return!0;const r=e.attributes.state_class,s=e.attributes.unit_of_measurement;if("measurement"===r&&s){if("%"===s)return!0;if(/°|deg/i.test(s))return!0}return!1}function Te(e,t,r,s){return function(e,t,r){const s=`${Re(e)} ${Re(t)}`;return r.some(e=>s.includes(Re(e)))}(e,t,s)?"other":"temperature"===r||"humidity"===r?"room":"other"}function Fe(e,t,r,s){const o=Re(e),n=Re(r),i=Re(t),a=Re(s);let l=0;return(o.includes(n)||i.includes(n.replace(/\s+/g,"_")))&&(l+=3),o.includes(a)&&(l+=4),"humidity"===a&&(e.includes("%")||t.includes("humidity"))&&(l+=2),l}function De(e,t,r,s,o){const n=o?Ne(e,o):void 0;let i;for(const o of Object.values(e.states)){if(!o.entity_id.startsWith("sensor."))continue;if(o.attributes.device_class!==s)continue;const a=Ze(o);if(Me(a,o.entity_id))continue;let l=Fe(a,o.entity_id,t,r);n&&Ne(e,o.entity_id)===n&&(l+=6),l>=5&&(!i||l>i.score)&&(i={id:o.entity_id,score:l})}return i?.id}function Ge(e,t){const r="on"===t;return{entity_id:e,position:r?100:0,active:r}}function Le(e,t){const r=parseFloat(t);if(!isNaN(r))return{entity_id:e,position:r,active:r>0}}function Qe(e,t){return{floor:t.floor_sensor??De(e,t.name,"floor temperature","temperature",t.climate_entity),room:t.room_sensor??De(e,t.name,"room temperature","temperature",t.climate_entity),humidity:t.humidity_sensor??De(e,t.name,"humidity","humidity",t.climate_entity)}}function Be(e,t,r,s){const o=s?.zone_kinds?.[t.climate_entity];if(o)return o;if(null!=r.floor)return"floor_heat";if(Re(t.name).includes("thermostat"))return"thermostat";const n=Oe(e,t.climate_entity);return(n?.attributes.hvac_modes??[]).includes("heat_cool")?"thermostat":"floor_heat"}function Je(e,t,r){const s=Re(`${e} ${t??""}`);for(const e of r){const t=e.zones?.some(e=>s.includes(Re(e))),r=e.room_sensors?.some(e=>s.includes(Re(e)));if(t||r)return e.name}return/hunter|sydney|upstair/.test(s)?"Upper Floor":"Main Floor"}function Ye(e,t){let r=Ve(e.replace(/\s+(temperature|humidity|temp)$/i,""));const s=`${Re(e)} ${Re(t)}`;if(s.includes("outdoor reset")){const t=e.match(/:\s*(.+)$/);return t?`Outdoor reset target (${t[1].trim()})`:"Outdoor reset target"}return s.includes("ecobee")&&s.includes("remote")&&(r=r.replace(/\s*ecobee\s*/i," ").trim(),/remote/i.test(r)||(r=`${r} (Remote)`)),r}function Ke(e,t,r,s){const o=Oe(e,t);if(!o)return;const n=o.attributes.device_class,i=Ze(o),a=Ye(i,t),l=o.attributes.unit_of_measurement??("humidity"===n?"%":"°"),c=Te(i,t,n,r),d=/floor/i.test(i)||/floor/i.test(t),p=Ne(e,t);return{name:a,entity_id:t,area:Ce(e,p),area_id:p,value:qe(o),unit:l,kind:c,height_ft:me(t,s,{isFloor:d,isRoom:"room"===c&&!d})}}function Ue(e,t,r){if(t.room_sensors?.length)return[...t.room_sensors];const s=function(e,t,r){const s=new Set;for(const e of t.zones??[])e.floor_sensor&&s.add(e.floor_sensor),e.room_sensor&&s.add(e.room_sensor),e.humidity_sensor&&s.add(e.humidity_sensor);for(const o of r){const r=t.zones?.find(e=>e.climate_entity===o.climate_entity)??{name:o.name,climate_entity:o.climate_entity};for(const t of[r.floor_sensor??De(e,o.name,"floor temperature","temperature",o.climate_entity),r.room_sensor??De(e,o.name,"room temperature","temperature",o.climate_entity),r.humidity_sensor??De(e,o.name,"humidity","humidity",o.climate_entity)])t&&s.add(t)}return s}(e,t,r),o=function(e){const t=new Set;for(const r of Object.values(e.states)){if(!r.entity_id.startsWith("climate."))continue;const e=je(r.entity_id);t.add(`sensor.${e}_floor_temperature`),t.add(`sensor.${e}_room_temperature`)}return t}(e),n=[];for(const t of Object.values(e.states)){if(!t.entity_id.startsWith("sensor."))continue;if(!He(t))continue;if(s.has(t.entity_id))continue;const e=Ze(t);Me(e,t.entity_id)||(Xe(t.entity_id,e,o)||n.push(t.entity_id))}for(const e of Pe(t).keys())n.includes(e)||n.push(e);return n.sort()}function _e(e,t){if(e.area_id){const r=t.find(t=>t.area_id&&t.area_id===e.area_id);if(r)return r}const r=t.find(t=>function(e,t){return!(!e||!t)&&Re(e)===Re(t)}(e.area,t.area));return r||t.find(t=>function(e,t){const r=Re(e),s=Re(t.name);return r.includes(s)||s.includes(r)}(e.name,t))}function $e(e,t,r){const s=Pe(r).get(e.entity_id);return s?function(e,t){return t.find(t=>t.climate_entity===e||Re(t.name)===Re(e)||Re(t.climate_entity)===Re(e))}(s,t):_e(e,t)}function et(e,t){const r=t.zones?.length?t.zones:t.auto_discover?function(e){return Object.values(e.states).filter(e=>e.entity_id.startsWith("climate.")).map(t=>{const r=t.attributes.friendly_name??t.entity_id.replace("climate.","").replace(/_/g," "),s=Ne(e,t.entity_id);return{name:Ve(r),climate_entity:t.entity_id,area:Ce(e,s),area_id:s}}).sort((e,t)=>e.name.localeCompare(t.name))}(e):[];return r.map(r=>{const s=function(e,t){const r=Qe(e,t)??{},s=Oe(e,r.floor),o=Oe(e,r.room),n=Oe(e,r.humidity);return{floor:qe(s),room:qe(o),humidity:qe(n)}}(e,r),o=r.area_id??Ne(e,r.climate_entity),n=r.area??Ce(e,o),i=Qe(e,r),a=function(e,t,r){const s=je(t),o=s.split("_").filter(e=>e.length>2),n=Re(s.replace(/_/g," ")),i=e.states;if(r?.valve_entity){const e=i[r.valve_entity];if(e){const t=Le(r.valve_entity,e.state);return t?[t]:[Ge(r.valve_entity,e.state)]}}const a=[];for(const[e,t]of Object.entries(i))if(e.includes(s)&&e.includes("valve"))if(e.startsWith("number.")||e.startsWith("sensor.")){const r=Le(e,t.state);r&&a.push(r)}else(e.startsWith("switch.")||e.startsWith("binary_sensor."))&&a.push(Ge(e,t.state));if(a.length)return a;for(const[e,t]of Object.entries(i)){if(!e.startsWith("switch.")||!e.includes("floor_control_mode"))continue;const r=e.split("floor_control_mode_").pop()??"",o=Re(r.replace(/_/g," "));if(o===n||Re(r)===Re(s)||o===Re(s.replace(/_/g," ")))return[Ge(e,t.state)]}const l=Object.entries(i).filter(([e])=>e.startsWith("binary_sensor.")&&e.includes("redawghome_zone"));if(l.length){const e=i[t],r=Re(e?.attributes?.friendly_name??"").replace(/thm|climate|thermostat/g,"").trim().split(/\s+/).filter(e=>e.length>2),s=Object.entries(i).filter(([e])=>e.startsWith("number.")&&e.includes("valve_count")).map(([e,t])=>({eid:e,state:t,idNorm:Re(e)})).sort((e,t)=>e.idNorm.localeCompare(t.idNorm));let a,c=0;for(const e of s){const t=parseFloat(e.state.state),s=e.idNorm.includes(n)||o.every(t=>e.idNorm.includes(Re(t))),i=r.some(t=>e.idNorm.includes(t));if(s||i){!isNaN(t)&&t>0&&(a=t);break}!isNaN(t)&&t>0&&(c+=t)}const d=l.map(([e,t])=>{const r=parseInt(e.match(/zone_(\d+)/)?.[1]??"",10);return{eid:e,state:t,zoneNum:r}}).filter(e=>!isNaN(e.zoneNum)).sort((e,t)=>e.zoneNum-t.zoneNum),p=null!=a&&a>0?d.slice(c,c+a):d.filter(({eid:e})=>{const t=Re(e);return o.some(e=>t.includes(Re(e)))});if(p.length)return p.map(({eid:e,state:t})=>Ge(e,t.state))}const c=Ne(e,t);if(c){const t=[];for(const[r,s]of Object.entries(i)){if(!r.startsWith("binary_sensor."))continue;const o=s.attributes,n=o.device_class;if("running"!==n&&"heat"!==n)continue;const i=o.icon,a=i?.includes("valve")||i?.includes("pipe"),l=`${o.friendly_name??""} ${r}`.toLowerCase();(a||l.includes("valve")||l.includes("relay")||l.includes("zone")||r.includes("redawghome_zone"))&&(Ne(e,r)===c&&t.push(Ge(r,s.state)))}if(t.length)return t}const d=i[t],p=Re(d?.attributes?.friendly_name??"");if(p){const e=[];for(const[t,r]of Object.entries(i)){if(!t.startsWith("binary_sensor."))continue;const s=r.attributes,o=s.device_class;if("running"!==o&&"heat"!==o)continue;const n=Re(s.friendly_name??""),i=p.replace(/thm|climate|thermostat/g,"").trim().split(/\s+/).filter(e=>e.length>2);i.some(e=>n.includes(e))&&e.push(Ge(t,r.state))}if(e.length)return e}return[]}(e,r.climate_entity,r),l=a[0];return{name:r.name,climate_entity:r.climate_entity,area:n,area_id:o,floor:r.floor,kind:Be(e,r,s,t),sensors:s,roomSensors:[],otherSensors:[],linked_sensor_ids:i,valves:a.length?a:void 0,valve_entity:l?.entity_id,valve_position:l?.position,valve_active:l?.active}})}function tt(e,t){const r=t.floors??xe,s=et(e,t),{zones:o,unassigned:n}=function(e,t,r){if(!1===t.show_room_sensors)return{zones:r,unassigned:[]};const s=Ie(t),o=t.other_sensor_patterns??ve,n=[],i=r.map(e=>({...e,roomSensors:[],otherSensors:[]}));for(const a of Ue(e,t,r)){if(s.has(a))continue;const r=Ke(e,a,o,t);if(!r||null==r.value)continue;const l=$e(r,i,t);if(!l){n.push(r);continue}const c=i.find(e=>e.climate_entity===l.climate_entity);"other"===r.kind?c.otherSensors.push(r):c.roomSensors.push(r)}for(const e of i)e.roomSensors.sort((e,t)=>e.name.localeCompare(t.name)),e.otherSensors.sort((e,t)=>e.name.localeCompare(t.name));return n.sort((e,t)=>e.name.localeCompare(t.name)),{zones:i,unassigned:n}}(e,t,s);if(!(!1!==t.group_by_floor))return[{name:"Climate Zones",zones:o,unassignedSensors:n}];const i=new Map;for(const e of r)i.set(e.name,{name:e.name,zones:[],unassignedSensors:[]});const a={name:"Other",zones:[],unassignedSensors:[]},l=e=>We(e,t,r);for(const e of o){const t=l(e),r=i.get(t);r?r.zones.push(e):a.zones.push(e)}for(const e of n){const s=Ee(e.area_id,e.area,t)??Je(e.name,e.area,r),o=i.get(s);o?o.unassignedSensors.push(e):a.unassignedSensors.push(e)}const c=r.map(e=>i.get(e.name)).filter(e=>e.zones.length||e.unassignedSensors.length);return(a.zones.length||a.unassignedSensors.length)&&c.push(a),c}const rt=["supply","return","flow","manifold","boiler","water_temp","pump","optimal","inlet","outlet","water heater","tankless","hot water"],st=["supply","supply temp","supply water","supply temperature","outlet","outlet temp","hot water","outgoing"],ot=["return","return temp","return water","return temperature","inlet","inlet temp","cold water","incoming"],nt=["flow rate","flow","water flow"],it=["pump","boiler","circulator","manifold pump"];function at(e,t){const r=`${Re(e)} ${Re(t)}`;return rt.some(e=>r.includes(Re(e)))}function lt(e,t,r){const s=`${Re(e)} ${Re(t)}`;return r.some(e=>s.includes(Re(e)))}function ct(e,t){const r=Oe(e,t);if(!r)return;const s=qe(r);if(null==s)return;return{entity_id:t,value:s,unit:r.attributes.unit_of_measurement??("humidity"===r.attributes.device_class?"%":"°")}}function dt(e,t,r){const s=`${Re(t)} ${Re(r)}`,o=s.includes("inlet"),n=s.includes("outlet");let i=0;return"supply"===e?(n&&(i+=10),o&&!n&&(i-=12),(r.includes("outlet_temp")||r.endsWith("outlet_temperature"))&&(i+=6)):(o&&(i+=10),n&&!o&&(i-=12),(r.includes("inlet_temp")||r.endsWith("inlet_temperature"))&&(i+=6)),i}function pt(e,t){const r=t.floor_system;if(!1===r)return null;const s=r||{auto_discover:!0},o=s.supply_temp||s.return_temp||s.flow_rate||s.pump_status||(s.extra_sensors?.length??0)>0,n=s.auto_discover||!o,i=new Set,a={},l=(t,r)=>t||(n?function(e,t,r){const s={supply:st,return:ot,flow:nt,pump:it}[t];let o;for(const n of Object.values(e.states)){if(r.has(n.entity_id))continue;const e=Ze(n);if(!at(e,n.entity_id))continue;if("pump"===t){if(!n.entity_id.startsWith("binary_sensor.")&&!n.entity_id.startsWith("switch."))continue}else if(!n.entity_id.startsWith("sensor."))continue;if(!lt(e,n.entity_id,s))continue;let i=0;(Re(e).includes("optimal")||Re(n.entity_id).includes("optimal"))&&(i+=2),"supply"!==t&&"return"!==t||(i+=dt(t,e,n.entity_id)),"supply"===t&&Re(e).includes("supply")&&(i+=2),"return"===t&&Re(e).includes("return")&&(i+=2),"flow"===t&&Re(e).includes("flow")&&(i+=4),"pump"===t&&(Re(e).includes("pump")||Re(e).includes("boiler")||Re(e).includes("heating"))&&(i+=4),i<0||(!o||i>o.score)&&(o={id:n.entity_id,score:i})}return o?.id}(e,r,i):void 0),c=l(s.supply_temp,"supply");c&&(i.add(c),a.supply_temp=ct(e,c));const d=l(s.return_temp,"return");d&&(i.add(d),a.return_temp=ct(e,d)),null!=a.supply_temp?.value&&null!=a.return_temp?.value&&(a.delta_t=Math.round(10*(a.supply_temp.value-a.return_temp.value))/10);const p=l(s.flow_rate,"flow");p&&(i.add(p),a.flow_rate=ct(e,p));const u=l(s.pump_status,"pump");if(u){i.add(u);const t=Oe(e,u);t&&(a.pump_entity=u,a.pump_active=function(e){const t=e.state;return"unavailable"!==t&&"unknown"!==t&&(e.entity_id.startsWith("binary_sensor.")||e.entity_id.startsWith("switch.")?"on"===t:"on"===t||"running"===t||"heat"===t||"heating"===t)}(t))}const A=Object.values(e.states).find(e=>e.entity_id.startsWith("water_heater."));if(A){a.heater_entity=A.entity_id;const e=A.attributes.temperature;null!=e&&(a.set_temp=e,a.set_temp_unit=A.attributes.unit_of_measurement??A.attributes.temperature_unit??"°")}const h=s.extra_sensors??[],f=[];for(const t of h){if(i.has(t))continue;const r=Oe(e,t);if(!r)continue;const s=qe(r);if(null==s)continue;const o=Ye(Ze(r),t),n=r.attributes.unit_of_measurement??("humidity"===r.attributes.device_class?"%":"");f.push({entity_id:t,name:o,value:s,unit:n}),i.add(t)}f.length&&(a.extra=f);return a.supply_temp||a.return_temp||a.flow_rate||a.pump_entity||(a.extra?.length??0)>0?a:null}let ut=class extends ae{setConfig(e){this._config={auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e}}_valueChanged(e,t){const r=new CustomEvent("config-changed",{detail:{config:{...this._config,[e]:t}}});this.dispatchEvent(r)}_zoneChanged(e,t,r){const s=[...this._config.zones??[]];s[e]={...s[e],[t]:r},this._valueChanged("zones",s),this._valueChanged("auto_discover",!1)}_addZone(){const e=[...this._config.zones??[],{name:"New Zone",climate_entity:""}];this._valueChanged("zones",e),this._valueChanged("auto_discover",!1)}_removeZone(e){const t=(this._config.zones??[]).filter((t,r)=>r!==e);this._valueChanged("zones",t)}_sensorAssignmentChanged(e,t){const r={...this._config.sensor_map??{}},s=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(s.add(e),delete r[e]):"__auto__"===t?(s.delete(e),delete r[e]):(s.delete(e),r[e]=t),this._valueChanged("sensor_map",r),this._valueChanged("exclude_entities",[...s])}_climateEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("climate."))}_sensorEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("sensor."))}_zoneOptions(){return et(this.hass,this._config).map(e=>({id:e.climate_entity,name:`${e.name}${e.area?` (${e.area})`:""}`}))}_sensorHeightChanged(e,t){const r={...this._config.sensor_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];this._valueChanged("sensor_heights",r)}_referenceHeightChanged(e){const t=parseFloat(e);Number.isNaN(t)||t<0||this._valueChanged("reference_height_ft",t)}_zoneFloorChanged(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t,this._valueChanged("zone_floors",r)}render(){if(!this.hass)return D``;const e=function(e,t){const r=et(e,t),s=Ie(t),o=Pe(t),n=t.other_sensor_patterns??ve;return Ue(e,t,r).map(i=>{const a=Ke(e,i,n,t),l=o.get(i),c=a?_e(a,r):void 0;return{entity_id:i,name:a?.name??i,area:a?.area,area_id:a?.area_id,value:a?.value,unit:a?.unit,kind:a?.kind??"other",assigned_zone:l,auto_zone:c?.climate_entity,auto_zone_name:c?.name,hidden:s.has(i),height_ft:a?.height_ft}})}(this.hass,this._config),t=et(this.hass,this._config),r=ke(this.hass),s=Se(this._config);return D`
      <div class="editor">
        <div class="field">
          <label>Title</label>
          <input
    ...
    `}};e([ue({attribute:!1})],ut.prototype,"hass",void 0),e([Ae()],ut.prototype,"_config",void 0),ut=e([ce("climate-command-center-editor")],ut);let At=class extends ae{constructor(){super(...arguments),this._expandedZone=null,this._editSensors=!1,this._setupMode=!1,this._setupSaveReminder=!1,this._view="cards",this._placingThermostat=null,this._forecast=null}static get styles(){return fe}setConfig(e){if(!e.zones?.length&&!e.auto_discover)throw new Error("Configure zones or enable auto_discover");this._config={title:"Climate Command Center",auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e,floors:e.floors?.length?e.floors:xe}}getCardSize(){return 6}connectedCallback(){super.connectedCallback(),this._subscribeForecast()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeForecast()}updated(e){e.has("hass")&&!this._forecastUnsub&&this._subscribeForecast()}async _subscribeForecast(){if(this._unsubscribeForecast(),!this.hass)return;const e=this._config.weather_entity??Object.keys(this.hass.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(this.hass.states).find(e=>e.startsWith("weather."));if(e)try{this._forecastUnsub=await this.hass.connection.subscribeMessage(e=>{e.forecast&&(this._forecast=e.forecast.slice(0,8))},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:e})}catch{}}_unsubscribeForecast(){this._forecastUnsub&&(this._forecastUnsub(),this._forecastUnsub=void 0)}get sections(){return tt(this.hass,this._config)}get weather(){if(!this._config.show_weather)return null;const e=function(e,t){const r=t.weather_entity??Object.keys(e.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(e.states).find(e=>e.startsWith("weather.")),s=r?Oe(e,r):null,o=s?.attributes??{},n=(t,r,s=[])=>Object.values(e.states).find(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const o=Re(Ze(e)),n=`${Re(e.entity_id)} ${o}`;if(r&&e.attributes.device_class!==r)return!1;if(!(n.includes("weather")||n.includes("tempest")||n.includes("weatherflow")))return!1;const i=t.some(e=>n.includes(Re(e))),a=s.some(e=>n.includes(Re(e)));return i&&!a})?.entity_id,i=o.temperature??qe(Oe(e,t.weather_temperature??n(["temperature"],"temperature",["wet bulb","dew","feels","heat index","wind chill"])));if(null==i&&!s)return null;const a={label:s?Ze(s).replace(/\s*(Weather|Forecast|Cloud)$/i,"")||"Weather":"Outside",temperature:i,condition:s?.state,humidity:o.humidity??qe(Oe(e,t.weather_humidity??n(["humidity"],"humidity"))),feels_like:qe(Oe(e,t.weather_feels_like??n(["feels like","apparent"],"temperature"))),dew_point:qe(Oe(e,t.weather_dew_point??n(["dew point"],"temperature"))),wind_speed:o.wind_speed??qe(Oe(e,n(["wind speed","wind avg"],void 0))),wind_bearing:o.wind_bearing,wind_gust:qe(Oe(e,n(["wind gust","gust"],void 0))),pressure:o.pressure??qe(Oe(e,n(["pressure","barometric"],"pressure"))),uv_index:qe(Oe(e,n(["uv","ultraviolet"],void 0,["solar"]))),visibility:o.visibility,precipitation:qe(Oe(e,n(["precipitation","rain"],void 0,["probability","lightning"])))};if(r&&s){const e=o.forecast;e?.length&&(a.forecast=e.slice(0,8))}return a}(this.hass,this._config);return e&&this._forecast?.length&&!e.forecast?.length&&(e.forecast=this._forecast),e}get floorSystem(){return pt(this.hass,this._config)}get sunData(){return function(e){const t=Oe(e,"sun.sun");if(!t)return null;const r=t.attributes.elevation??0,s=t.attributes.azimuth??180,o=t.state,n=t.attributes.next_rising,i=t.attributes.next_setting;if(!n||!i)return null;let a=new Date(n),l=new Date(i);const c=new Date;if("above_horizon"===o){const e=new Date(a.getTime()-864e5);a=e}else{const e=new Date(l.getTime()-864e5);l=e;const t=new Date(a.getTime()-864e5);a=t}const d=l.getTime()-a.getTime(),p=c.getTime()-a.getTime(),u=d>0?p/d:0,A=Math.round(d/6e4),h=Math.max(0,Math.round((l.getTime()-c.getTime())/6e4));return{state:o,elevation:r,azimuth:s,rising:a,setting:l,progress:u,daylight_minutes:A,remaining_minutes:h}}(this.hass)}get totalZones(){return this.sections.reduce((e,t)=>e+t.zones.length,0)}get zoneOptions(){return et(this.hass,this._config)}get haAreas(){return ke(this.hass)}get floorOptions(){return Se(this._config)}async setEntityHaArea(e,t){const r=this.hass;r.callWS&&await r.callWS({type:"config/entity_registry/update",entity_id:e,area_id:t})}async updateSensorAssignment(e,t){if(t.startsWith("area:")){const r=t.slice(5);try{await this.setEntityHaArea(e,r)}catch(t){console.error("Failed to set HA area",e,r,t)}return void this.updateSensorMap(e,"__auto__")}this.updateSensorMap(e,t)}updateZoneFloor(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t;const s={...this._config,zone_floors:r};this._config=s,he(this,"config-changed",{config:s})}updateZoneKind(e,t){const r={...this._config.zone_kinds??{}};r[e]=t;const s={...this._config,zone_kinds:r};this._config=s,he(this,"config-changed",{config:s})}toggleSetupMode(){this._setupMode?(this._setupMode=!1,this._setupSaveReminder=!0):(this._setupMode=!0,this._editSensors=!1,this._setupSaveReminder=!1)}updateFloorSystem(e,t){if("disabled"===e){const e="true"===t?{...this._config,floor_system:!1}:{...this._config,floor_system:void 0};return this._config=e,void he(this,"config-changed",{config:e})}if(!1===this._config.floor_system)return;const r={...this._config.floor_system??{}};""===t||"__auto__"===t?delete r[e]:r[e]=t;const s=r.supply_temp||r.return_temp||r.flow_rate||r.pump_status||r.heater_image||(r.extra_sensors?.length??0)>0,o={...this._config,floor_system:s?r:void 0};this._config=o,he(this,"config-changed",{config:o})}floorSystemEntityOptions(e){const t=Object.values(this.hass.states),r=(e,t)=>t.some(t=>e.includes(t)),s=e=>{const t=(e.attributes.friendly_name??"").toLowerCase();return`${e.entity_id.toLowerCase()} ${t}`};switch(e){case"supply_temp":case"return_temp":{const o="supply_temp"===e?["supply","hot","outlet","output"]:["return","cold","inlet","input"];return t.filter(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const t=s(e);return!("temperature"!==e.attributes.device_class&&"°F"!==e.attributes.unit_of_measurement&&"°C"!==e.attributes.unit_of_measurement&&!t.includes("temperature")&&!t.includes("temp"))&&(!!r(t,o)||!(!t.includes("water")||!t.includes("heater")))}).map(e=>e.entity_id).sort()}case"flow_rate":return t.filter(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const t=s(e);return r(t,["flow","gpm","gallons","flow_rate"])}).map(e=>e.entity_id).sort();case"pump_status":return t.filter(e=>{const t=e.entity_id.toLowerCase();if(!t.startsWith("switch.")&&!t.startsWith("binary_sensor.")&&!t.startsWith("input_boolean."))return!1;const o=s(e);return r(o,["pump","boiler","circulator","heater","water_heater"])}).map(e=>e.entity_id).sort();default:return[]}}floorSystemFieldValue(e){if(!1===this._config.floor_system)return"__auto__";const t=this._config.floor_system;return t?t[e]??"__auto__":"__auto__"}floorSystemStatusLabel(){if(!1===this._config.floor_system)return"Disabled";const e=this._config.floor_system;if(!e)return"Auto-discovered";return e.supply_temp||e.return_temp||e.flow_rate||e.pump_status?"Configured":"Auto-discovered"}entityOptionLabel(e){const t=this.hass.states[e];return`${t?.attributes?.friendly_name??e} (${e})`}renderFloorSystemFieldSelect(e,t){const r=this.floorSystemEntityOptions(t),s=this.floorSystemFieldValue(t),o=!1===this._config.floor_system;return D`
    ...
    `}tempToColor(e){if(null==e)return"#64b5f6";const t=(Math.max(50,Math.min(140,e))-50)/90;if(t<.33){return`rgb(${Math.round(30+3*t*70)},${Math.round(130+3*t*70)},${Math.round(245-3*t*50)})`}if(t<.66){const e=(t-.33)/.33;return`rgb(${Math.round(100+155*e)},${Math.round(200-50*e)},${Math.round(195-145*e)})`}{const e=(t-.66)/.34;return`rgb(${Math.round(255)},${Math.round(150-80*e)},${Math.round(50-30*e)})`}}renderFloorSystem(){const e=this.floorSystem;if(!e)return null;const t=e.return_temp?.value,r=e.supply_temp?.value,s=this.tempToColor(t),o=this.tempToColor(r),n=e.return_temp?.unit??"°",i=e.supply_temp?.unit??"°",a=this._config.floor_system,l=(!1!==a&&a?.heater_image?.trim()?a.heater_image.trim():void 0)??"data:image/png;base64,",c=136,d=136,p=132,u=12,A=14,h=180.96,f=p+77.52;return D`
      <div class="floor-system tankless-visual">
        <svg class="tankless-svg" viewBox="0 0 400 210" preserveAspectRatio="xMidYMid meet">
          ...
          <rect x="${f-7}" y="${146}" width="14" height="10" rx="2" fill="#b87333" stroke="#8b5a2b" stroke-width="0.5"/>

          <!-- Outlet pipe (hot supply) — sweeps from left edge down and curves up into heater stub -->
          <path d="M 0,${169} L ${140.96},${169} Q ${h},${169} ${h},${156}"
          ...
          <path d="M 3,${169} L ${140.96},${169} Q ${h},${169} ${h},${156}"
          ...
          <path d="M 400,${169} L ${f+40},${169} Q ${f},${169} ${f},${156}"
            fill="none" stroke="rgba(200,200,210,0.35)" stroke-width="${A}" stroke-linecap="round"/>
          <path d="M 400,${169} L ${f+40},${169} Q ${f},${169} ${f},${156}"
            fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="${12}" stroke-linecap="round"/>
          <path d="M 397,${169} L ${f+40},${169} Q ${f},${169} ${f},${156}"
            fill="none" stroke="url(#inletFlow)" stroke-width="${10}" stroke-linecap="round"/>
          <!-- Glass highlight on horizontal section -->
          <path d="M ${f+44},${164} L 394,${164}"
            fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="2" stroke-linecap="round"/>
    ...
    `}renderSensorAssign(e){if(!this._editSensors)return null;const t=this._config.sensor_map?.[e.entity_id]??(this._config.exclude_entities?.includes(e.entity_id)?"__hidden__":"__auto__"),r=_e(e,this.zoneOptions),s=e.area?`Auto (HA: ${e.area}${r?` → ${r.name}`:""})`:r?`Auto (→ ${r.name})`:"Auto (by HA area)";return D`
      <select
    ...
    `:D``}renderZone(e){const t=this.hass.states[e.climate_entity];if(!t)return D``;const r=t.attributes,s=r.current_temperature,o=r.temperature,n=r.humidity,i=r.hvac_action,a=t.state,l=this._expandedZone===e.climate_entity,c=e.sensors,d=r.hvac_modes??["heat","off"],p="floor_heat"===e.kind?d.filter(e=>"heat"===e||"off"===e):d;return D`
    ...
    `}get fpThermostats(){return this._config.floor_plan?.thermostats??[]}fpEntityData(e){const t=this.hass.states[e];if(!t)return null;const r=t.attributes??{},s=e.startsWith("climate.");return{state:t.state,action:s?r.hvac_action:void 0,current:s?r.current_temperature:parseFloat(t.state)||void 0,target:s?r.temperature:void 0,name:r.friendly_name??e,unit:r.unit_of_measurement??""}}handleFpClick(e){if(!this._placingThermostat)return;const t=e.currentTarget.getBoundingClientRect(),r=Math.round((e.clientX-t.left)/t.width*100),s=Math.round((e.clientY-t.top)/t.height*100),o={entity_id:"",label:"wall"===this._placingThermostat?"Wall Thermostat":"Floor Sensor",kind:this._placingThermostat,x:Math.max(0,Math.min(100,r)),y:Math.max(0,Math.min(100,s))},n=[...this.fpThermostats];n.push(o);const i={...this._config,floor_plan:{...this._config.floor_plan,thermostats:n}};this._config=i,he(this,"config-changed",{config:i}),this._placingThermostat=null}removeFpThermostat(e){const t=[...this.fpThermostats];t.splice(e,1);const r={...this._config,floor_plan:{...this._config.floor_plan,thermostats:t}};this._config=r,he(this,"config-changed",{config:r})}updateFpThermostat(e,t,r){const s=this.fpThermostats.map((s,o)=>o===e?{...s,[t]:r}:s),o={...this._config,floor_plan:{...this._config.floor_plan,thermostats:s}};this._config=o,he(this,"config-changed",{config:o})}renderFloorPlan(){const e=this.fpThermostats,t=this._placingThermostat,r=Object.keys(this.hass.states).filter(e=>e.startsWith("climate.")||e.startsWith("sensor.")).sort();return D`
    ...
    `}};e([ue({attribute:!1})],At.prototype,"hass",void 0),e([ue({attribute:!1})],At.prototype,"_config",void 0),e([Ae()],At.prototype,"_expandedZone",void 0),e([Ae()],At.prototype,"_editSensors",void 0),e([Ae()],At.prototype,"_setupMode",void 0),e([Ae()],At.prototype,"_setupSaveReminder",void 0),e([Ae()],At.prototype,"_view",void 0),e([Ae()],At.prototype,"_placingThermostat",void 0),e([Ae()],At.prototype,"_forecast",void 0),At=e([ce("climate-command-center")],At),window.customCards=window.customCards??[],window.customCards.push({type:"climate-command-center",name:"Climate Command Center",description:"Unified dashboard for thermostats, heated floors, and weather sensors",preview:!0}),console.info("%c CLIMATE-COMMAND-CENTER %c v0.5.1 ","color: white; background: #0288d1; font-weight: 700;","color: #0288d1; background: white; font-weight: 700;");const ht=()=>At,ft=()=>document.createElement("climate-command-center-editor");export{At as ClimateCommandCenterCard,ht as getCard,ft as getCardEditor};
