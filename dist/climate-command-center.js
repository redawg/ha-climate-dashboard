...
`;function be(e,t,r){const s=t.sensor_heights?.[e];return null==s||Number.isNaN(s)?r?.isFloor?0:r?.isRoom?5:void 0:s}function ve(e,t,r){const s=t.reference_height_ft??5,o=function(e,t,r){const s=[],o=t.sensor_heights??{},n=t.zone_heights??{},i=(e,r,n,i)=>{if(null==r)return;const a=(n?o[n]:void 0)??be(n??"",t,i);null!=a&&s.push({label:e,temp:r,height_ft:a})};if(null!=e.sensors.floor&&i("Floor",e.sensors.floor,e.linked_sensor_ids?.floor,{isFloor:!0}),null!=e.sensors.room&&i("Room",e.sensors.room,e.linked_sensor_ids?.room,{isRoom:!0}),null!=r){const o=n[e.climate_entity]??t.reference_height_ft??5;s.push({label:"Thermostat",temp:r,height_ft:o})}for(const t of e.roomSensors)null!=t.value&&null!=t.height_ft&&s.push({label:t.name,temp:t.value,height_ft:t.height_ft});return s}(e,t,r);if(!o.length)return null;const n=Math.round(o.reduce((e,t)=>e+t.temp,0)/o.length*10)/10,{value:i,gradient:a}=function(e,t){if(!e.length)return{};if(1===e.length)return{value:e[0].temp};const r=e.length,s=e.reduce((e,t)=>e+t.height_ft,0),o=e.reduce((e,t)=>e+t.temp,0),n=e.reduce((e,t)=>e+t.height_ft*t.temp,0),i=e.reduce((e,t)=>e+t.height_ft*t.height_ft,0),a=r*i-s*s;if(Math.abs(a)<1e-6){const e=o/r;return{value:Math.round(10*e)/10}}const l=(r*n-s*o)/a,c=l*t+(o-l*s)/r;return{value:Math.round(10*c)/10,gradient:Math.round(100*l)/100}}(o,s);return{reference_height_ft:s,point_count:o.length,simple_average:n,estimated_at_reference:i,gradient_per_ft:a}}const xe=["deye","sunsynk","sol-ark","battery","oven","cavity","inverter","outdoor","outside","exterior","sensorlinx","ubiquiti","unifi","udm","usg","usw","uap","uxg","udr","unvr","poe temperature","switch temperature","printer","toner","cartridge"," ink","officejet","laserjet","envy","deskjet","weather","tempest","wet bulb","dew point","feels like"],ye=["outlet","plug","switch","hallway","flex","unifi","usw","uap","udm","signal level","cloud connection","network","uptime","cpu","memory","mac","energy","power","voltage","current","consumption","co2","voc","aqi","auto-off","auto-update","led","overheated","smooth on","smooth off"],ze=[{name:"Main Floor",zones:["Laundry","Living Room","Main Area","Main Office","Redmond Thermostat"],room_sensors:["Family Room","Kitchen","Hallway","Stairs","Entryway","Primary Bath","Primary Bedroom"]},{name:"Upper Floor",zones:[],room_sensors:["Hunters","Sydney","Upstair Office","Upstairs Office"]}],we={office:"Main Floor","Main Office":"Main Floor",upstairs_office:"Upper Floor",upstairs_hallway:"Upper Floor",hunters_room:"Upper Floor",sidney_s_room:"Upper Floor","Upstairs Office":"Upper Floor","Upstairs Hallway":"Upper Floor","Hunters Room":"Upper Floor","Sidney's Room":"Upper Floor"},Ee={};function ke(e,t){const r=Ie(e),s=Ie(t);if(r===s)return!0;const o=r.split(" "),n=s.split(" ");return o[0]===n[0]&&o.length>1&&n.length>1&&"main"===o[0]?o.slice(1).join(" ")===n.slice(1).join(" "):r.includes(s)||s.includes(r)}function We(e){const t=e.areas;return t?Object.entries(t).map(([e,t])=>({area_id:e,name:t.name??e})).filter(e=>!["weather","whole_house_energy"].includes(e.area_id)).sort((e,t)=>e.name.localeCompare(t.name)):[]}function Se(e){return(e.floors??ze).map(e=>e.name)}function Re(e,t,r){const s=function(e){return{...we,...e.area_floor_map??{}}}(r);return e&&s[e]?s[e]:t&&s[t]?s[t]:void 0}function Ze(e,t,r=t.floors??ze){const s=function(e){return{...Ee,...e.zone_floors??{}}}(t);if(s[e.climate_entity])return s[e.climate_entity];for(const t of r)if(t.zones?.some(t=>ke(e.name,t)))return t.name;const o=Re(e.area_id,e.area,t);return o||(e.floor?e.floor:Ge(e.name,e.area,r))}function Ce(e){const t=e.trim().split(/\s+/);if(t.length>=2&&t.length%2==0){const e=t.length/2;if(t.slice(0,e).join(" ")===t.slice(e).join(" "))return t.slice(0,e).join(" ")}return e}function Ie(e){return e.toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function je(e){return e.attributes.friendly_name??e.entity_id}function Pe(e,t){const r=e.entities?.[t];if(r?.area_id)return r.area_id;const s=r?.device_id;if(s){const t=e.devices?.[s]?.area_id;if(t)return t}}function Ve(e,t){if(!t)return;const r=e.areas;return r?.[t]?.name}function Oe(e){if(!e||"unavailable"===e.state||"unknown"===e.state)return;const t=parseFloat(e.state);return isNaN(t)?void 0:Math.round(10*t)/10}function Ne(e,t){if(t)return e.states[t]}function qe(e){const t=new Set(e.exclude_entities??[]);for(const r of e.sensor_assignments??[])r.hidden&&t.add(r.entity_id);return t}function He(e){const t=new Map(Object.entries(e.sensor_map??{}));for(const r of e.sensor_assignments??[])r.zone&&!r.hidden&&t.set(r.entity_id,r.zone);return t}function Xe(e,t,r=[]){const s=`${Ie(e)} ${Ie(t)}`;return[...xe,...r].some(e=>s.includes(Ie(e)))}function Me(e){const t=e.replace(/^climate\./,""),r=t.split("_");if(r.length>=2&&r.length%2==0){const e=r.length/2,t=r.slice(0,e).join("_");if(t===r.slice(e).join("_"))return t}return t}function Fe(e,t,r){if(r.has(e))return!0;const s=Ie(t);return s.includes("current temperature")&&s.includes("thermostat")}function De(e){const t=e.attributes.device_class;if("temperature"===t||"humidity"===t)return!0;const r=e.attributes.state_class,s=e.attributes.unit_of_measurement;if("measurement"===r&&s){if("%"===s)return!0;if(/°|deg/i.test(s))return!0}return!1}function Te(e,t,r,s){return function(e,t,r){const s=`${Ie(e)} ${Ie(t)}`;return r.some(e=>s.includes(Ie(e)))}(e,t,s)?"other":"temperature"===r||"humidity"===r?"room":"other"}function Le(e,t,r,s){const o=Ie(e),n=Ie(r),i=Ie(t),a=Ie(s);let l=0;return(o.includes(n)||i.includes(n.replace(/\s+/g,"_")))&&(l+=3),o.includes(a)&&(l+=4),"humidity"===a&&(e.includes("%")||t.includes("humidity"))&&(l+=2),l}function Je(e,t,r,s,o){const n=o?Pe(e,o):void 0;let i;for(const o of Object.values(e.states)){if(!o.entity_id.startsWith("sensor."))continue;if(o.attributes.device_class!==s)continue;const a=je(o);if(Xe(a,o.entity_id))continue;let l=Le(a,o.entity_id,t,r);n&&Pe(e,o.entity_id)===n&&(l+=6),l>=5&&(!i||l>i.score)&&(i={id:o.entity_id,score:l})}return i?.id}function Qe(e,t){return{floor:t.floor_sensor??Je(e,t.name,"floor temperature","temperature",t.climate_entity),room:t.room_sensor??Je(e,t.name,"room temperature","temperature",t.climate_entity),humidity:t.humidity_sensor??Je(e,t.name,"humidity","humidity",t.climate_entity)}}function Be(e,t,r,s){const o=s?.zone_kinds?.[t.climate_entity];if(o)return o;if(null!=r.floor)return"floor_heat";if(Ie(t.name).includes("thermostat"))return"thermostat";const n=Ne(e,t.climate_entity);return(n?.attributes.hvac_modes??[]).includes("heat_cool")?"thermostat":"floor_heat"}function Ge(e,t,r){const s=Ie(`${e} ${t??""}`);for(const e of r){const t=e.zones?.some(e=>s.includes(Ie(e))),r=e.room_sensors?.some(e=>s.includes(Ie(e)));if(t||r)return e.name}return/hunter|sydney|upstair/.test(s)?"Upper Floor":"Main Floor"}function Ke(e,t){let r=Ce(e.replace(/\s+(temperature|humidity|temp)$/i,""));const s=`${Ie(e)} ${Ie(t)}`;if(s.includes("outdoor reset")){const t=e.match(/:\s*(.+)$/);return t?`Outdoor reset target (${t[1].trim()})`:"Outdoor reset target"}return s.includes("ecobee")&&s.includes("remote")&&(r=r.replace(/\s*ecobee\s*/i," ").trim(),/remote/i.test(r)||(r=`${r} (Remote)`)),r}function Ue(e,t,r,s){const o=Ne(e,t);if(!o)return;const n=o.attributes.device_class,i=je(o),a=Ke(i,t),l=o.attributes.unit_of_measurement??("humidity"===n?"%":"°"),c=Te(i,t,n,r),d=/floor/i.test(i)||/floor/i.test(t),A=Pe(e,t);return{name:a,entity_id:t,area:Ve(e,A),area_id:A,value:Oe(o),unit:l,kind:c,height_ft:be(t,s,{isFloor:d,isRoom:"room"===c&&!d})}}function Ye(e,t,r){if(t.room_sensors?.length)return[...t.room_sensors];const s=function(e,t,r){const s=new Set;for(const e of t.zones??[])e.floor_sensor&&s.add(e.floor_sensor),e.room_sensor&&s.add(e.room_sensor),e.humidity_sensor&&s.add(e.humidity_sensor);for(const o of r){const r=t.zones?.find(e=>e.climate_entity===o.climate_entity)??{name:o.name,climate_entity:o.climate_entity};for(const t of[r.floor_sensor??Je(e,o.name,"floor temperature","temperature",o.climate_entity),r.room_sensor??Je(e,o.name,"room temperature","temperature",o.climate_entity),r.humidity_sensor??Je(e,o.name,"humidity","humidity",o.climate_entity)])t&&s.add(t)}return s}(e,t,r),o=function(e){const t=new Set;for(const r of Object.values(e.states)){if(!r.entity_id.startsWith("climate."))continue;const e=Me(r.entity_id);t.add(`sensor.${e}_floor_temperature`),t.add(`sensor.${e}_room_temperature`)}return t}(e),n=[];for(const t of Object.values(e.states)){if(!t.entity_id.startsWith("sensor."))continue;if(!De(t))continue;if(s.has(t.entity_id))continue;const e=je(t);Xe(e,t.entity_id)||(Fe(t.entity_id,e,o)||n.push(t.entity_id))}for(const e of He(t).keys())n.includes(e)||n.push(e);return n.sort()}function _e(e,t){if(e.area_id){const r=t.find(t=>t.area_id&&t.area_id===e.area_id);if(r)return r}const r=t.find(t=>function(e,t){return!(!e||!t)&&Ie(e)===Ie(t)}(e.area,t.area));return r||t.find(t=>function(e,t){const r=Ie(e),s=Ie(t.name);return r.includes(s)||s.includes(r)}(e.name,t))}function $e(e,t,r){const s=He(r).get(e.entity_id);return s?function(e,t){return t.find(t=>t.climate_entity===e||Ie(t.name)===Ie(e)||Ie(t.climate_entity)===Ie(e))}(s,t):_e(e,t)}function et(e,t){const r=t.zones?.length?t.zones:t.auto_discover?function(e){return Object.values(e.states).filter(e=>e.entity_id.startsWith("climate.")).map(t=>{const r=t.attributes.friendly_name??t.entity_id.replace("climate.","").replace(/_/g," "),s=Pe(e,t.entity_id);return{name:Ce(r),climate_entity:t.entity_id,area:Ve(e,s),area_id:s}}).sort((e,t)=>e.name.localeCompare(t.name))}(e):[];return r.map(r=>{const s=function(e,t){const r=Qe(e,t),s=Ne(e,r.floor),o=Ne(e,r.room),n=Ne(e,r.humidity);return{floor:Oe(s),room:Oe(o),humidity:Oe(n)}}(e,r),o=r.area_id??Pe(e,r.climate_entity),n=r.area??Ve(e,o),i=Qe(e,r);return{name:r.name,climate_entity:r.climate_entity,area:n,area_id:o,floor:r.floor,kind:Be(e,r,s,t),sensors:s,roomSensors:[],otherSensors:[],linked_sensor_ids:i}})}function tt(e,t){const r=t.floors??ze,s=et(e,t),{zones:o,unassigned:n}=function(e,t,r){if(!1===t.show_room_sensors)return{zones:r,unassigned:[]};const s=qe(t),o=t.other_sensor_patterns??ye,n=[],i=r.map(e=>({...e,roomSensors:[],otherSensors:[]}));for(const a of Ye(e,t,r)){if(s.has(a))continue;const r=Ue(e,a,o,t);if(!r||null==r.value)continue;const l=$e(r,i,t);if(!l){n.push(r);continue}const c=i.find(e=>e.climate_entity===l.climate_entity);"other"===r.kind?c.otherSensors.push(r):c.roomSensors.push(r)}for(const e of i)e.roomSensors.sort((e,t)=>e.name.localeCompare(t.name)),e.otherSensors.sort((e,t)=>e.name.localeCompare(t.name));return n.sort((e,t)=>e.name.localeCompare(t.name)),{zones:i,unassigned:n}}(e,t,s);if(!(!1!==t.group_by_floor))return[{name:"Climate Zones",zones:o,unassignedSensors:n}];const i=new Map;for(const e of r)i.set(e.name,{name:e.name,zones:[],unassignedSensors:[]});const a={name:"Other",zones:[],unassignedSensors:[]},l=e=>Ze(e,t,r);for(const e of o){const t=l(e),r=i.get(t);r?r.zones.push(e):a.zones.push(e)}for(const e of n){const s=Re(e.area_id,e.area,t)??Ge(e.name,e.area,r),o=i.get(s);o?o.unassignedSensors.push(e):a.unassignedSensors.push(e)}const c=r.map(e=>i.get(e.name)).filter(e=>e.zones.length||e.unassignedSensors.length);return(a.zones.length||a.unassignedSensors.length)&&c.push(a),c}const rt=["supply","return","flow","manifold","boiler","water_temp","pump","optimal"],st=["supply","supply temp","supply water","supply temperature"],ot=["return","return temp","return water","return temperature"],nt=["flow rate","flow","water flow"],it=["pump","boiler","circulator","manifold pump"];function at(e,t){const r=`${Ie(e)} ${Ie(t)}`;return rt.some(e=>r.includes(Ie(e)))}function lt(e,t,r){const s=`${Ie(e)} ${Ie(t)}`;return r.some(e=>s.includes(Ie(e)))}function ct(e,t){const r=Ne(e,t);if(!r)return;const s=Oe(r);if(null==s)return;return{entity_id:t,value:s,unit:r.attributes.unit_of_measurement??("humidity"===r.attributes.device_class?"%":"°")}}function dt(e,t){const r=t.floor_system;if(!r)return null;const s=r.supply_temp||r.return_temp||r.flow_rate||r.pump_status||(r.extra_sensors?.length??0)>0,o=r.auto_discover||!s,n=new Set,i={},a=(t,r)=>t||(o?function(e,t,r){const s={supply:st,return:ot,flow:nt,pump:it}[t];let o;for(const n of Object.values(e.states)){if(r.has(n.entity_id))continue;const e=je(n);if(!at(e,n.entity_id))continue;if("pump"===t){if(!n.entity_id.startsWith("binary_sensor.")&&!n.entity_id.startsWith("switch."))continue}else if(!n.entity_id.startsWith("sensor."))continue;if(!lt(e,n.entity_id,s))continue;let i=0;(Ie(e).includes("optimal")||Ie(n.entity_id).includes("optimal"))&&(i+=2),"supply"===t&&Ie(e).includes("supply")&&(i+=4),"return"===t&&Ie(e).includes("return")&&(i+=4),"flow"===t&&Ie(e).includes("flow")&&(i+=4),"pump"===t&&(Ie(e).includes("pump")||Ie(e).includes("boiler"))&&(i+=4),(!o||i>o.score)&&(o={id:n.entity_id,score:i})}return o?.id}(e,r,n):void 0),l=a(r.supply_temp,"supply");l&&(n.add(l),i.supply_temp=ct(e,l));const c=a(r.return_temp,"return");c&&(n.add(c),i.return_temp=ct(e,c)),null!=i.supply_temp?.value&&null!=i.return_temp?.value&&(i.delta_t=Math.round(10*(i.supply_temp.value-i.return_temp.value))/10);const d=a(r.flow_rate,"flow");d&&(n.add(d),i.flow_rate=ct(e,d));const A=a(r.pump_status,"pump");if(A){n.add(A);const t=Ne(e,A);t&&(i.pump_entity=A,i.pump_active=function(e){const t=e.state;return"unavailable"!==t&&"unknown"!==t&&(e.entity_id.startsWith("binary_sensor.")||e.entity_id.startsWith("switch.")?"on"===t:"on"===t||"running"===t||"heat"===t||"heating"===t)}(t))}const p=r.extra_sensors??[],u=[];for(const t of p){if(n.has(t))continue;const r=Ne(e,t);if(!r)continue;const s=Oe(r);if(null==s)continue;const o=Ke(je(r),t),i=r.attributes.unit_of_measurement??("humidity"===r.attributes.device_class?"%":"");u.push({entity_id:t,name:o,value:s,unit:i}),n.add(t)}u.length&&(i.extra=u);return i.supply_temp||i.return_temp||i.flow_rate||i.pump_entity||(i.extra?.length??0)>0?i:null}let At=class extends ae{setConfig(e){this._config={auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e}}_valueChanged(e,t){const r=new CustomEvent("config-changed",{detail:{config:{...this._config,[e]:t}}});this.dispatchEvent(r)}_zoneChanged(e,t,r){const s=[...this._config.zones??[]];s[e]={...s[e],[t]:r},this._valueChanged("zones",s),this._valueChanged("auto_discover",!1)}_addZone(){const e=[...this._config.zones??[],{name:"New Zone",climate_entity:""}];this._valueChanged("zones",e),this._valueChanged("auto_discover",!1)}_removeZone(e){const t=(this._config.zones??[]).filter((t,r)=>r!==e);this._valueChanged("zones",t)}_sensorAssignmentChanged(e,t){const r={...this._config.sensor_map??{}},s=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(s.add(e),delete r[e]):"__auto__"===t?(s.delete(e),delete r[e]):(s.delete(e),r[e]=t),this._valueChanged("sensor_map",r),this._valueChanged("exclude_entities",[...s])}_climateEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("climate."))}_sensorEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("sensor."))}_zoneOptions(){return et(this.hass,this._config).map(e=>({id:e.climate_entity,name:`${e.name}${e.area?` (${e.area})`:""}`}))}_sensorHeightChanged(e,t){const r={...this._config.sensor_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];this._valueChanged("sensor_heights",r)}_referenceHeightChanged(e){const t=parseFloat(e);Number.isNaN(t)||t<0||this._valueChanged("reference_height_ft",t)}_zoneFloorChanged(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t,this._valueChanged("zone_floors",r)}render(){if(!this.hass)return T``;const e=function(e,t){const r=et(e,t),s=qe(t),o=He(t),n=t.other_sensor_patterns??ye;return Ye(e,t,r).map(i=>{const a=Ue(e,i,n,t),l=o.get(i),c=a?_e(a,r):void 0;return{entity_id:i,name:a?.name??i,area:a?.area,area_id:a?.area_id,value:a?.value,unit:a?.unit,kind:a?.kind??"other",assigned_zone:l,auto_zone:c?.climate_entity,auto_zone_name:c?.name,hidden:s.has(i),height_ft:a?.height_ft}})}(this.hass,this._config),t=et(this.hass,this._config),r=We(this.hass),s=Se(this._config);return T`
      <div class="editor">
        <div class="field">
          <label>Title</label>
          <input
        ...
        <div class="sensors-section">
          ...
          ${e.map(e=>{const t=e.hidden?"__hidden__":e.assigned_zone??"__auto__",s=e.area?`Auto (HA: ${e.area}${e.auto_zone_name?` → ${e.auto_zone_name}`:""})`:e.auto_zone_name?`Auto (→ ${e.auto_zone_name})`:"Auto (by HA area)";return T`
                ...
                <div class="sensor-row-controls">
                  ...
                  >
                    ...
                    <optgroup label="HA Areas (set on dashboard)">
                      ${r.map(e=>T`<option disabled value=${`area:${e.area_id}`}>${e.name}</option>`)}
                    </optgroup>
                    <optgroup label="Climate zones">
                      ${this._zoneOptions().map(e=>T`<option value=${e.id}>${e.name}</option>`)}
                    </optgroup>
          ...
          ${t.map(e=>T`
              <div class="zone-floor-row">
                ...
                >
                  ...
                  ${s.map(e=>T`<option value=${e}>${e}</option>`)}
                </select>
              </div>
            `)}
        </div>

        ${this._config.auto_discover??1?"":T`
              <div class="zones-section">
                <div class="section-header">
                  <span>Zones</span>
                  <button @click=${this._addZone}>+ Add Zone</button>
                </div>
                ${(this._config.zones??[]).map((e,t)=>T`
                    <div class="zone-editor">
                      ...
                      >
                        ...
                        ${this._climateEntities().map(e=>T`<option value=${e}>${e}</option>`)}
                      </select>
    ...
    `}};e([pe({attribute:!1})],At.prototype,"hass",void 0),e([ue()],At.prototype,"_config",void 0),At=e([ce("climate-command-center-editor")],At);let pt=class extends ae{constructor(){super(...arguments),this._expandedZone=null,this._editSensors=!1,this._setupMode=!1,this._view="cards",this._placingThermostat=null,this._forecast=null}static get styles(){return ge}setConfig(e){if(!e.zones?.length&&!e.auto_discover)throw new Error("Configure zones or enable auto_discover");this._config={title:"Climate Command Center",auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e,floors:e.floors?.length?e.floors:ze}}getCardSize(){return 6}connectedCallback(){super.connectedCallback(),this._subscribeForecast()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeForecast()}updated(e){e.has("hass")&&!this._forecastUnsub&&this._subscribeForecast()}async _subscribeForecast(){if(this._unsubscribeForecast(),!this.hass)return;const e=this._config.weather_entity??Object.keys(this.hass.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(this.hass.states).find(e=>e.startsWith("weather."));if(e)try{this._forecastUnsub=await this.hass.connection.subscribeMessage(e=>{e.forecast&&(this._forecast=e.forecast.slice(0,5))},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e})}catch{}}_unsubscribeForecast(){this._forecastUnsub&&(this._forecastUnsub(),this._forecastUnsub=void 0)}get sections(){return tt(this.hass,this._config)}get weather(){if(!this._config.show_weather)return null;const e=function(e,t){const r=t.weather_entity??Object.keys(e.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(e.states).find(e=>e.startsWith("weather.")),s=r?Ne(e,r):null,o=s?.attributes??{},n=(t,r,s=[])=>Object.values(e.states).find(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const o=Ie(je(e)),n=`${Ie(e.entity_id)} ${o}`;if(r&&e.attributes.device_class!==r)return!1;if(!(n.includes("weather")||n.includes("tempest")||n.includes("weatherflow")))return!1;const i=t.some(e=>n.includes(Ie(e))),a=s.some(e=>n.includes(Ie(e)));return i&&!a})?.entity_id,i=o.temperature??Oe(Ne(e,t.weather_temperature??n(["temperature"],"temperature",["wet bulb","dew","feels","heat index","wind chill"])));if(null==i&&!s)return null;const a={label:s?je(s).replace(/\s*(Weather|Forecast|Cloud)$/i,"")||"Weather":"Outside",temperature:i,condition:s?.state,humidity:o.humidity??Oe(Ne(e,t.weather_humidity??n(["humidity"],"humidity"))),feels_like:Oe(Ne(e,t.weather_feels_like??n(["feels like","apparent"],"temperature"))),dew_point:Oe(Ne(e,t.weather_dew_point??n(["dew point"],"temperature"))),wind_speed:o.wind_speed??Oe(Ne(e,n(["wind speed","wind avg"],void 0))),wind_bearing:o.wind_bearing,wind_gust:Oe(Ne(e,n(["wind gust","gust"],void 0))),pressure:o.pressure??Oe(Ne(e,n(["pressure","barometric"],"pressure"))),uv_index:Oe(Ne(e,n(["uv","ultraviolet"],void 0,["solar"]))),visibility:o.visibility,precipitation:Oe(Ne(e,n(["precipitation","rain"],void 0,["probability","lightning"])))};if(r&&s){const e=o.forecast;e?.length&&(a.forecast=e.slice(0,5))}return a}(this.hass,this._config);return e&&this._forecast?.length&&!e.forecast?.length&&(e.forecast=this._forecast),e}get floorSystem(){return dt(this.hass,this._config)}get totalZones(){return this.sections.reduce((e,t)=>e+t.zones.length,0)}get zoneOptions(){return et(this.hass,this._config)}get haAreas(){return We(this.hass)}get floorOptions(){return Se(this._config)}async setEntityHaArea(e,t){const r=this.hass;r.callWS&&await r.callWS({type:"config/entity_registry/update",entity_id:e,area_id:t})}async updateSensorAssignment(e,t){if(t.startsWith("area:")){const r=t.slice(5);try{await this.setEntityHaArea(e,r)}catch(t){console.error("Failed to set HA area",e,r,t)}return void this.updateSensorMap(e,"__auto__")}this.updateSensorMap(e,t)}updateZoneFloor(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t;const s={...this._config,zone_floors:r};this._config=s,fe(this,"config-changed",{config:s})}updateZoneKind(e,t){const r={...this._config.zone_kinds??{}};r[e]=t;const s={...this._config,zone_kinds:r};this._config=s,fe(this,"config-changed",{config:s})}async updateZoneHaArea(e,t){if(t)try{await this.setEntityHaArea(e,t)}catch(r){console.error("Failed to set zone HA area",e,t,r)}}callService(e,t,r){this.hass.callService(e,t,r)}setClimate(e,t){this.callService("climate","set_temperature",{entity_id:e,...t})}setHvacMode(e,t){this.callService("climate","set_hvac_mode",{entity_id:e,hvac_mode:t})}adjustSetpoint(e,t,r){const s=t??70;this.setClimate(e,{temperature:Math.round(s+r)})}toggleExpand(e){this._expandedZone=this._expandedZone===e?null:e}updateSensorMap(e,t){const r={...this._config.sensor_map??{}},s=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(s.add(e),delete r[e]):"__auto__"===t?(s.delete(e),delete r[e]):(s.delete(e),r[e]=t);const o={...this._config,sensor_map:r,exclude_entities:[...s]};this._config=o,fe(this,"config-changed",{config:o})}updateSensorHeight(e,t){const r={...this._config.sensor_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];const o={...this._config,sensor_heights:r};this._config=o,fe(this,"config-changed",{config:o})}updateZoneHeight(e,t){const r={...this._config.zone_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];const o={...this._config,zone_heights:r};this._config=o,fe(this,"config-changed",{config:o})}renderHeightEditor(e,t){return this._editSensors?T`
    ...
    `:null}renderHeightBadge(e){return null==e?null:T`<span class="height-badge">${e} ft</span>`}renderZoneHeightStats(e,t){const r=ve(e,this._config,t);return r?T`
          ...
          ${e.supply_temp?T`
                <div class="floor-system-metric supply">
                  ...
                  <span class="floor-system-metric-value">
                    ${e.supply_temp.value}${e.supply_temp.unit}
                  </span>
                </div>
              `:""}
          ${e.return_temp?T`
                <div class="floor-system-metric return">
                  ...
                  <span class="floor-system-metric-value">
                    ${e.return_temp.value}${e.return_temp.unit}
                  </span>
                </div>
              `:""}
          ${null!=e.delta_t?T`
                <div class="floor-system-metric delta">
                  ...
                  <span class="floor-system-metric-value">${e.delta_t}\u00B0</span>
                </div>
              `:""}
          ${e.flow_rate?T`
                <div class="floor-system-metric flow">
                  ...
                  <span class="floor-system-metric-value">
                    ${e.flow_rate.value}${e.flow_rate.unit}
                  </span>
                </div>
              `:""}
          ${null!=e.pump_entity?T`
                <div class="floor-system-metric pump ${e.pump_active?"active":"inactive"}">
                  <span class="floor-system-metric-label">Pump</span>
                  <span class="floor-system-metric-value">
                    ${e.pump_active?"On":"Off"}
                  </span>
                </div>
              `:""}
        </div>
              ...
              <div class="floor-system-extra">
                ${e.extra.map(e=>T`
                    <span class="floor-system-extra-chip">
                      <span class="floor-system-extra-name">${e.name}</span>
                      <span class="floor-system-extra-value">${e.value}${e.unit}</span>
                    </span>
                  `)}
              </div>
            `:""}
      </div>
    `:null}conditionIcon(e){return{"clear-night":"🌙",sunny:"☀️",partlycloudy:"⛅",cloudy:"☁️",rainy:"🌧️",snowy:"❄️","snowy-rainy":"🌨️",hail:"🌨️",lightning:"⚡","lightning-rainy":"⛈️",fog:"🌫️",windy:"💨","windy-variant":"💨",exceptional:"⚠️",pouring:"🌧️"}[e??""]??"🌤️"}renderWeatherStrip(){const e=this.weather;return e?T`
      <div class="weather-strip">
        ...
        <div class="weather-stats">
          ${null!=e.humidity?T`<span>\uD83D\uDCA7 ${Math.round(e.humidity)}%</span>`:""}
          ${null!=e.feels_like?T`<span>Feels ${Math.round(e.feels_like)}\u00B0</span>`:""}
          ${null!=e.dew_point?T`<span>Dew ${Math.round(e.dew_point)}\u00B0</span>`:""}
          ${null!=e.wind_speed?T`<span>\uD83D\uDCA8 ${Math.round(e.wind_speed)}${e.wind_gust?` (${Math.round(e.wind_gust)})`:""} mph</span>`:""}
          ${null!=e.pressure?T`<span>\uD83D\uDCCA ${Math.round(e.pressure)} mb</span>`:""}
          ${null!=e.uv_index?T`<span>\u2600\uFE0F UV ${e.uv_index}</span>`:""}
        </div>
        ${e.forecast?.length?T`
              <div class="weather-forecast">
                ${e.forecast.map(e=>{const t=new Date(e.datetime).toLocaleDateString("en-US",{weekday:"short"});return T`
                    <div class="forecast-day">
                      ...
                      ${null!=e.precipitation_probability?T`<span class="forecast-precip">\uD83D\uDCA7${e.precipitation_probability}%</span>`:""}
                    </div>
                  `})}
              </div>
            `:""}
      </div>
    `:null}renderSensorRow(e,t,r="°"){return T`
      <div class="sensor-row">
        <span class="sensor-label">${e}</span>
        <span class="sensor-value">${null!=t?`${t}${r}`:"—"}</span>
      </div>
    `}renderSensorAssign(e){if(!this._editSensors)return null;const t=this._config.sensor_map?.[e.entity_id]??(this._config.exclude_entities?.includes(e.entity_id)?"__hidden__":"__auto__"),r=_e(e,this.zoneOptions),s=e.area?`Auto (HA: ${e.area}${r?` → ${r.name}`:""})`:r?`Auto (→ ${r.name})`:"Auto (by HA area)";return T`
      <select
      ...
      >
        ...
        <optgroup label="HA Areas (updates Home Assistant)">
          ${this.haAreas.map(e=>T`<option value=${`area:${e.area_id}`}>${e.name}</option>`)}
        </optgroup>
        <optgroup label="Climate zones">
          ${this.zoneOptions.map(e=>T`<option value=${e.climate_entity}>${e.name}${e.area?` (${e.area})`:""}</option>`)}
        </optgroup>
        <option value="__hidden__">Hide</option>
      </select>
    `}renderZoneFloorEdit(e){if(!this._editSensors)return null;const t=this._config.zone_floors?.[e.climate_entity]??"__default__";return T`
      <label class="zone-floor-edit" @click=${e=>e.stopPropagation()}>
        ...
        >
          <option value="__default__">Auto (from HA area)</option>
          ${this.floorOptions.map(e=>T`<option value=${e}>${e}</option>`)}
        </select>
      </label>
    `}renderZoneKindSetup(e){const t=this._config.zone_kinds?.[e.climate_entity]??e.kind,r=!!this._config.zone_kinds?.[e.climate_entity];return T`
    ...
    `}renderZoneAreaEdit(e){return this._editSensors?T`
      <label class="zone-area-edit" @click=${e=>e.stopPropagation()}>
        ...
        >
          <option value="">\u2014</option>
          ${this.haAreas.map(e=>T`<option value=${e.area_id}>${e.name}</option>`)}
        </select>
      </label>
    `:null}renderAreaLabel(e){return e.area?T`<div class="room-sensor-area">${e.area}</div>`:null}renderRoomSensorChip(e){return T`
    ...
    `}renderOtherSensorChip(e){return T`
    ...
    `}renderZoneSensorsBlock(e){const t=e.roomSensors.length>0,r=e.otherSensors.length>0;return t||r?T`
    ...
    `:T``}renderZone(e){const t=this.hass.states[e.climate_entity];if(!t)return T``;const r=t.attributes,s=r.current_temperature,o=r.temperature,n=r.humidity,i=r.hvac_action,a=t.state,l=this._expandedZone===e.climate_entity,c=e.sensors,d=r.hvac_modes??["heat","off"],A="floor_heat"===e.kind?d.filter(e=>"heat"===e||"off"===e):d;return T`
      <div class="zone-card ${l?"expanded":""} ${e.kind} ${this.modeClass(a)} ${this.actionClass(i)}">
        <div class="zone-header" @click=${()=>this.toggleExpand(e.climate_entity)}>
          <div class="zone-info">
            ...
            ${e.area?T`<div class="zone-area-label">${e.area}</div>`:""}
        ...
        <div class="zone-temp-grid">
          ...
          ${null!=c.room?T`
              ...
              `:""}
          ${null!=s&&null==c.floor&&null==c.room?T`
                <div class="temp-cell">
    ...
    `}get fpThermostats(){return this._config.floor_plan?.thermostats??[]}fpEntityData(e){const t=this.hass.states[e];if(!t)return null;const r=t.attributes??{},s=e.startsWith("climate.");return{state:t.state,action:s?r.hvac_action:void 0,current:s?r.current_temperature:parseFloat(t.state)||void 0,target:s?r.temperature:void 0,name:r.friendly_name??e,unit:r.unit_of_measurement??""}}handleFpClick(e){if(!this._placingThermostat)return;const t=e.currentTarget.getBoundingClientRect(),r=Math.round((e.clientX-t.left)/t.width*100),s=Math.round((e.clientY-t.top)/t.height*100),o={entity_id:"",label:"wall"===this._placingThermostat?"Wall Thermostat":"Floor Sensor",kind:this._placingThermostat,x:Math.max(0,Math.min(100,r)),y:Math.max(0,Math.min(100,s))},n=[...this.fpThermostats];n.push(o);const i={...this._config,floor_plan:{...this._config.floor_plan,thermostats:n}};this._config=i,fe(this,"config-changed",{config:i}),this._placingThermostat=null}removeFpThermostat(e){const t=[...this.fpThermostats];t.splice(e,1);const r={...this._config,floor_plan:{...this._config.floor_plan,thermostats:t}};this._config=r,fe(this,"config-changed",{config:r})}updateFpThermostat(e,t,r){const s=this.fpThermostats.map((s,o)=>o===e?{...s,[t]:r}:s),o={...this._config,floor_plan:{...this._config.floor_plan,thermostats:s}};this._config=o,fe(this,"config-changed",{config:o})}renderFloorPlan(){const e=this.fpThermostats,t=this._placingThermostat,r=Object.keys(this.hass.states).filter(e=>e.startsWith("climate.")||e.startsWith("sensor.")).sort();return T`
      <div class="floor-plan-container">
        ...
        ${t?T`<div class="fp-placing-hint">Click on the floor plan to place a ${"wall"===t?"wall thermostat":"floor sensor"}</div>`:""}
        ...
        <div class="fp-map ${t?"placing":""}"
          ...
          ${e.map(e=>{const t=e.entity_id?this.fpEntityData(e.entity_id):null,r="wall"===e.kind;return T`
              <div class="fp-marker ${r?"wall":"floor"}"
                ...
                <div class="fp-marker-info">
                  ...
                  ${t?T`<span class="fp-marker-temp">${t.current??"—"}${t.unit||"°"}</span>`:""}
                </div>
              </div>
            `})}
        </div>
    ...
    `}renderUnassigned(e){return e.unassignedSensors.length?T`
    ...
    `:null}renderFloorSection(e){return T`
      <section class="floor-section">
        ...
        ${e.zones.length?T`<div class="zones-grid">${e.zones.map(e=>this.renderZone(e))}</div>`:""}
        ${this.renderUnassigned(e)}
      </section>
    `}render(){const e=this.sections,t=!1!==this._config.allow_sensor_reassign,r="floorplan"===this._view;return T`
      <ha-card>
        ...
        ${r?T`
            ...
            `:T`
              ${this._setupMode?T`<div class="edit-hint">Set each zone's heating type: Floor Heat or HVAC. Save the dashboard to keep changes.</div>`:this._editSensors?T`<div class="edit-hint">Assign sensors to HA areas or zones, set floor per zone, or hide. Save the dashboard to keep layout changes.</div>`:""}
              <div class="top-strip">
                ${this.renderWeatherStrip()}
                ${this.renderFloorSystem()}
              </div>
              ${e.length?e.map(e=>this.renderFloorSection(e)):T`<div class="empty">No climate zones found. Check your configuration.</div>`}
            `}
      </ha-card>
