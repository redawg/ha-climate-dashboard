        ...
        <svg class="tankless-svg" viewBox="0 0 400 230" preserveAspectRatio="xMidYMid meet">
          <defs>
            <clipPath id="heaterClip">
              <rect x="${h}" y="${f}" width="${u}" height="${A}" rx="8"/>
            </clipPath>
          ...
          <path d="M 0,${169} L ${g-40},${169} Q ${g},${169} ${g},${156}"
            fill="none" stroke="rgba(200,200,210,0.35)" stroke-width="${m}" stroke-linecap="round"/>
          <path d="M 0,${169} L ${g-40},${169} Q ${g},${169} ${g},${156}"
            fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="${12}" stroke-linecap="round"/>
          <path d="M 3,${169} L ${g-40},${169} Q ${g},${169} ${g},${156}"
            fill="none" stroke="${p?"url(#outletFlow)":"rgba(120,130,150,0.25)"}" stroke-width="${10}" stroke-linecap="round"/>
          <!-- Glass highlight on horizontal section -->
          <path d="M 6,${164} L ${g-44},${164}"
          ...
          <path d="M 400,${169} L ${237.28},${169} Q ${b},${169} ${b},${156}"
            fill="none" stroke="rgba(200,200,210,0.35)" stroke-width="${m}" stroke-linecap="round"/>
          <path d="M 400,${169} L ${237.28},${169} Q ${b},${169} ${b},${156}"
            fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="${12}" stroke-linecap="round"/>
          <path d="M 397,${169} L ${237.28},${169} Q ${b},${169} ${b},${156}"
            fill="none" stroke="${p?"url(#inletFlow)":"rgba(120,130,150,0.25)"}" stroke-width="${10}" stroke-linecap="round"/>
          <!-- Glass highlight on horizontal section -->
