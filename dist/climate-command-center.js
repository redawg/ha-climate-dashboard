...
`;function be(e,t,r){const o=t.sensor_heights?.[e];return null==o||Number.isNaN(o)?r?.isFloor?0:r?.isRoom?5:void 0:o}function ve(e,t,r){const o=t.reference_height_ft??5,s=function(e,t,r){const o=[],s=t.sensor_heights??{},n=t.zone_heights??{},i=(e,r,n,i)=>{if(null==r)return;const a=(n?s[n]:void 0)??be(n??"",t,i);null!=a&&o.push({label:e,temp:r,height_ft:a})};if(null!=e.sensors.floor&&i("Floor",e.sensors.floor,e.linked_sensor_ids?.floor,{isFloor:!0}),null!=e.sensors.room&&i("Room",e.sensors.room,e.linked_sensor_ids?.room,{isRoom:!0}),null!=r){const s=n[e.climate_entity]??t.reference_height_ft??5;o.push({label:"Thermostat",temp:r,height_ft:s})}for(const t of e.roomSensors)null!=t.value&&null!=t.height_ft&&o.push({label:t.name,temp:t.value,height_ft:t.height_ft});return o}(e,t,r);if(!s.length)return null;const n=Math.round(s.reduce((e,t)=>e+t.temp,0)/s.length*10)/10,{value:i,gradient:a}=function(e,t){if(!e.length)return{};if(1===e.length)return{value:e[0].temp};const r=e.length,o=e.reduce((e,t)=>e+t.height_ft,0),s=e.reduce((e,t)=>e+t.temp,0),n=e.reduce((e,t)=>e+t.height_ft*t.temp,0),i=e.reduce((e,t)=>e+t.height_ft*t.height_ft,0),a=r*i-o*o;if(Math.abs(a)<1e-6){const e=s/r;return{value:Math.round(10*e)/10}}const l=(r*n-o*s)/a,c=l*t+(s-l*o)/r;return{value:Math.round(10*c)/10,gradient:Math.round(100*l)/100}}(s,o);return{reference_height_ft:o,point_count:s.length,simple_average:n,estimated_at_reference:i,gradient_per_ft:a}}const xe=["deye","sunsynk","sol-ark","battery","oven","cavity","inverter","outdoor","outside","exterior","sensorlinx","ubiquiti","unifi","udm","usg","usw","uap","uxg","udr","unvr","unifi_","dream machine","dream router","ultra switch","ap ","ap_backyard","ap_","xgs","_poe","port_","clients","wlan","speedtest","wan ","lan ","firmware","device tracker","poe temperature","switch temperature","cpu","memory","utilization","uptime","signal level","cloud connection","access point","printer","toner","cartridge"," ink","officejet","laserjet","envy","deskjet","tankless","water heater","hot water","inlet temp","outlet temp","weather","tempest","weatherflow","wet bulb","dew point","feels like","heat index","wind chill","wind speed","wind gust","wind bearing","wind direction","barometric","sea level pressure","air density","solar radiation","uv index","lightning","precipitation","rain rate","rain accumulation","visibility","cloud base","beaufort"],ye=["outlet","plug","switch","hallway","flex","unifi","usw","uap","udm","signal level","cloud connection","network","uptime","cpu","memory","mac","energy","power","voltage","current","consumption","co2","voc","aqi","auto-off","auto-update","led","overheated","smooth on","smooth off"],ze=[{name:"Main Floor",zones:["Laundry","Living Room","Main Area","Main Office","Redmond Thermostat"],room_sensors:["Family Room","Kitchen","Hallway","Stairs","Entryway","Primary Bath","Primary Bedroom"]},{name:"Upper Floor",zones:[],room_sensors:["Hunters","Sydney","Upstair Office","Upstairs Office"]}],we={office:"Main Floor","Main Office":"Main Floor",upstairs_office:"Upper Floor",upstairs_hallway:"Upper Floor",hunters_room:"Upper Floor",sidney_s_room:"Upper Floor","Upstairs Office":"Upper Floor","Upstairs Hallway":"Upper Floor","Hunters Room":"Upper Floor","Sidney's Room":"Upper Floor"},ke={};function Ee(e,t){const r=Ie(e),o=Ie(t);if(r===o)return!0;const s=r.split(" "),n=o.split(" ");return s[0]===n[0]&&s.length>1&&n.length>1&&"main"===s[0]?s.slice(1).join(" ")===n.slice(1).join(" "):r.includes(o)||o.includes(r)}function Se(e){const t=e.areas;return t?Object.entries(t).map(([e,t])=>({area_id:e,name:t.name??e})).filter(e=>!["weather","whole_house_energy"].includes(e.area_id)).sort((e,t)=>e.name.localeCompare(t.name)):[]}function We(e){return(e.floors??ze).map(e=>e.name)}function Re(e,t,r){const o=function(e){return{...we,...e.area_floor_map??{}}}(r);return e&&o[e]?o[e]:t&&o[t]?o[t]:void 0}function Ze(e,t,r=t.floors??ze){const o=function(e){return{...ke,...e.zone_floors??{}}}(t);if(o[e.climate_entity])return o[e.climate_entity];for(const t of r)if(t.zones?.some(t=>Ee(e.name,t)))return t.name;const s=Re(e.area_id,e.area,t);return s||(e.floor?e.floor:Ge(e.name,e.area,r))}function Ce(e){const t=e.trim().split(/\s+/);if(t.length>=2&&t.length%2==0){const e=t.length/2;if(t.slice(0,e).join(" ")===t.slice(e).join(" "))return t.slice(0,e).join(" ")}return e}function Ie(e){return e.toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Pe(e){return e.attributes.friendly_name??e.entity_id}function je(e,t){const r=e.entities?.[t];if(r?.area_id)return r.area_id;const o=r?.device_id;if(o){const t=e.devices?.[o]?.area_id;if(t)return t}}function Ne(e,t){if(!t)return;const r=e.areas;return r?.[t]?.name}function Oe(e){if(!e||"unavailable"===e.state||"unknown"===e.state)return;const t=parseFloat(e.state);return isNaN(t)?void 0:Math.round(10*t)/10}function Ve(e,t){if(t)return e.states[t]}function qe(e){const t=new Set(e.exclude_entities??[]);for(const r of e.sensor_assignments??[])r.hidden&&t.add(r.entity_id);return t}function Me(e){const t=new Map(Object.entries(e.sensor_map??{}));for(const r of e.sensor_assignments??[])r.zone&&!r.hidden&&t.set(r.entity_id,r.zone);return t}function He(e,t,r=[]){const o=`${Ie(e)} ${Ie(t)}`;return[...xe,...r].some(e=>o.includes(Ie(e)))}function Xe(e){const t=e.replace(/^climate\./,""),r=t.split("_");if(r.length>=2&&r.length%2==0){const e=r.length/2,t=r.slice(0,e).join("_");if(t===r.slice(e).join("_"))return t}return t}function Fe(e,t,r){if(r.has(e))return!0;const o=Ie(t);return o.includes("current temperature")&&o.includes("thermostat")}function Te(e){const t=e.attributes.device_class;if("temperature"===t||"humidity"===t)return!0;const r=e.attributes.state_class,o=e.attributes.unit_of_measurement;if("measurement"===r&&o){if("%"===o)return!0;if(/°|deg/i.test(o))return!0}return!1}function De(e,t,r,o){return function(e,t,r){const o=`${Ie(e)} ${Ie(t)}`;return r.some(e=>o.includes(Ie(e)))}(e,t,o)?"other":"temperature"===r||"humidity"===r?"room":"other"}function Le(e,t,r,o){const s=Ie(e),n=Ie(r),i=Ie(t),a=Ie(o);let l=0;return(s.includes(n)||i.includes(n.replace(/\s+/g,"_")))&&(l+=3),s.includes(a)&&(l+=4),"humidity"===a&&(e.includes("%")||t.includes("humidity"))&&(l+=2),l}function Je(e,t,r,o,s){const n=s?je(e,s):void 0;let i;for(const s of Object.values(e.states)){if(!s.entity_id.startsWith("sensor."))continue;if(s.attributes.device_class!==o)continue;const a=Pe(s);if(He(a,s.entity_id))continue;let l=Le(a,s.entity_id,t,r);n&&je(e,s.entity_id)===n&&(l+=6),l>=5&&(!i||l>i.score)&&(i={id:s.entity_id,score:l})}return i?.id}function Qe(e,t){return{floor:t.floor_sensor??Je(e,t.name,"floor temperature","temperature",t.climate_entity),room:t.room_sensor??Je(e,t.name,"room temperature","temperature",t.climate_entity),humidity:t.humidity_sensor??Je(e,t.name,"humidity","humidity",t.climate_entity)}}function Be(e,t,r,o){const s=o?.zone_kinds?.[t.climate_entity];if(s)return s;if(null!=r.floor)return"floor_heat";if(Ie(t.name).includes("thermostat"))return"thermostat";const n=Ve(e,t.climate_entity);return(n?.attributes.hvac_modes??[]).includes("heat_cool")?"thermostat":"floor_heat"}function Ge(e,t,r){const o=Ie(`${e} ${t??""}`);for(const e of r){const t=e.zones?.some(e=>o.includes(Ie(e))),r=e.room_sensors?.some(e=>o.includes(Ie(e)));if(t||r)return e.name}return/hunter|sydney|upstair/.test(o)?"Upper Floor":"Main Floor"}function Ke(e,t){let r=Ce(e.replace(/\s+(temperature|humidity|temp)$/i,""));const o=`${Ie(e)} ${Ie(t)}`;if(o.includes("outdoor reset")){const t=e.match(/:\s*(.+)$/);return t?`Outdoor reset target (${t[1].trim()})`:"Outdoor reset target"}return o.includes("ecobee")&&o.includes("remote")&&(r=r.replace(/\s*ecobee\s*/i," ").trim(),/remote/i.test(r)||(r=`${r} (Remote)`)),r}function Ue(e,t,r,o){const s=Ve(e,t);if(!s)return;const n=s.attributes.device_class,i=Pe(s),a=Ke(i,t),l=s.attributes.unit_of_measurement??("humidity"===n?"%":"°"),c=De(i,t,n,r),d=/floor/i.test(i)||/floor/i.test(t),A=je(e,t);return{name:a,entity_id:t,area:Ne(e,A),area_id:A,value:Oe(s),unit:l,kind:c,height_ft:be(t,o,{isFloor:d,isRoom:"room"===c&&!d})}}function Ye(e,t,r){if(t.room_sensors?.length)return[...t.room_sensors];const o=function(e,t,r){const o=new Set;for(const e of t.zones??[])e.floor_sensor&&o.add(e.floor_sensor),e.room_sensor&&o.add(e.room_sensor),e.humidity_sensor&&o.add(e.humidity_sensor);for(const s of r){const r=t.zones?.find(e=>e.climate_entity===s.climate_entity)??{name:s.name,climate_entity:s.climate_entity};for(const t of[r.floor_sensor??Je(e,s.name,"floor temperature","temperature",s.climate_entity),r.room_sensor??Je(e,s.name,"room temperature","temperature",s.climate_entity),r.humidity_sensor??Je(e,s.name,"humidity","humidity",s.climate_entity)])t&&o.add(t)}return o}(e,t,r),s=function(e){const t=new Set;for(const r of Object.values(e.states)){if(!r.entity_id.startsWith("climate."))continue;const e=Xe(r.entity_id);t.add(`sensor.${e}_floor_temperature`),t.add(`sensor.${e}_room_temperature`)}return t}(e),n=[];for(const t of Object.values(e.states)){if(!t.entity_id.startsWith("sensor."))continue;if(!Te(t))continue;if(o.has(t.entity_id))continue;const e=Pe(t);He(e,t.entity_id)||(Fe(t.entity_id,e,s)||n.push(t.entity_id))}for(const e of Me(t).keys())n.includes(e)||n.push(e);return n.sort()}function _e(e,t){if(e.area_id){const r=t.find(t=>t.area_id&&t.area_id===e.area_id);if(r)return r}const r=t.find(t=>function(e,t){return!(!e||!t)&&Ie(e)===Ie(t)}(e.area,t.area));return r||t.find(t=>function(e,t){const r=Ie(e),o=Ie(t.name);return r.includes(o)||o.includes(r)}(e.name,t))}function $e(e,t,r){const o=Me(r).get(e.entity_id);return o?function(e,t){return t.find(t=>t.climate_entity===e||Ie(t.name)===Ie(e)||Ie(t.climate_entity)===Ie(e))}(o,t):_e(e,t)}function et(e,t){const r=t.zones?.length?t.zones:t.auto_discover?function(e){return Object.values(e.states).filter(e=>e.entity_id.startsWith("climate.")).map(t=>{const r=t.attributes.friendly_name??t.entity_id.replace("climate.","").replace(/_/g," "),o=je(e,t.entity_id);return{name:Ce(r),climate_entity:t.entity_id,area:Ne(e,o),area_id:o}}).sort((e,t)=>e.name.localeCompare(t.name))}(e):[];return r.map(r=>{const o=function(e,t){const r=Qe(e,t),o=Ve(e,r.floor),s=Ve(e,r.room),n=Ve(e,r.humidity);return{floor:Oe(o),room:Oe(s),humidity:Oe(n)}}(e,r),s=r.area_id??je(e,r.climate_entity),n=r.area??Ne(e,s),i=Qe(e,r);return{name:r.name,climate_entity:r.climate_entity,area:n,area_id:s,floor:r.floor,kind:Be(e,r,o,t),sensors:o,roomSensors:[],otherSensors:[],linked_sensor_ids:i}})}function tt(e,t){const r=t.floors??ze,o=et(e,t),{zones:s,unassigned:n}=function(e,t,r){if(!1===t.show_room_sensors)return{zones:r,unassigned:[]};const o=qe(t),s=t.other_sensor_patterns??ye,n=[],i=r.map(e=>({...e,roomSensors:[],otherSensors:[]}));for(const a of Ye(e,t,r)){if(o.has(a))continue;const r=Ue(e,a,s,t);if(!r||null==r.value)continue;const l=$e(r,i,t);if(!l){n.push(r);continue}const c=i.find(e=>e.climate_entity===l.climate_entity);"other"===r.kind?c.otherSensors.push(r):c.roomSensors.push(r)}for(const e of i)e.roomSensors.sort((e,t)=>e.name.localeCompare(t.name)),e.otherSensors.sort((e,t)=>e.name.localeCompare(t.name));return n.sort((e,t)=>e.name.localeCompare(t.name)),{zones:i,unassigned:n}}(e,t,o);if(!(!1!==t.group_by_floor))return[{name:"Climate Zones",zones:s,unassignedSensors:n}];const i=new Map;for(const e of r)i.set(e.name,{name:e.name,zones:[],unassignedSensors:[]});const a={name:"Other",zones:[],unassignedSensors:[]},l=e=>Ze(e,t,r);for(const e of s){const t=l(e),r=i.get(t);r?r.zones.push(e):a.zones.push(e)}for(const e of n){const o=Re(e.area_id,e.area,t)??Ge(e.name,e.area,r),s=i.get(o);s?s.unassignedSensors.push(e):a.unassignedSensors.push(e)}const c=r.map(e=>i.get(e.name)).filter(e=>e.zones.length||e.unassignedSensors.length);return(a.zones.length||a.unassignedSensors.length)&&c.push(a),c}const rt=["supply","return","flow","manifold","boiler","water_temp","pump","optimal","inlet","outlet","water heater","tankless","hot water"],ot=["supply","supply temp","supply water","supply temperature","outlet","outlet temp","hot water","outgoing"],st=["return","return temp","return water","return temperature","inlet","inlet temp","cold water","incoming"],nt=["flow rate","flow","water flow"],it=["pump","boiler","circulator","manifold pump"];function at(e,t){const r=`${Ie(e)} ${Ie(t)}`;return rt.some(e=>r.includes(Ie(e)))}function lt(e,t,r){const o=`${Ie(e)} ${Ie(t)}`;return r.some(e=>o.includes(Ie(e)))}function ct(e,t){const r=Ve(e,t);if(!r)return;const o=Oe(r);if(null==o)return;return{entity_id:t,value:o,unit:r.attributes.unit_of_measurement??("humidity"===r.attributes.device_class?"%":"°")}}function dt(e,t){const r=t.floor_system;if(!r)return null;const o=r.supply_temp||r.return_temp||r.flow_rate||r.pump_status||(r.extra_sensors?.length??0)>0,s=r.auto_discover||!o,n=new Set,i={},a=(t,r)=>t||(s?function(e,t,r){const o={supply:ot,return:st,flow:nt,pump:it}[t];let s;for(const n of Object.values(e.states)){if(r.has(n.entity_id))continue;const e=Pe(n);if(!at(e,n.entity_id))continue;if("pump"===t){if(!n.entity_id.startsWith("binary_sensor.")&&!n.entity_id.startsWith("switch."))continue}else if(!n.entity_id.startsWith("sensor."))continue;if(!lt(e,n.entity_id,o))continue;let i=0;(Ie(e).includes("optimal")||Ie(n.entity_id).includes("optimal"))&&(i+=2),"supply"===t&&Ie(e).includes("supply")&&(i+=4),"return"===t&&Ie(e).includes("return")&&(i+=4),"flow"===t&&Ie(e).includes("flow")&&(i+=4),"pump"===t&&(Ie(e).includes("pump")||Ie(e).includes("boiler"))&&(i+=4),(!s||i>s.score)&&(s={id:n.entity_id,score:i})}return s?.id}(e,r,n):void 0),l=a(r.supply_temp,"supply");l&&(n.add(l),i.supply_temp=ct(e,l));const c=a(r.return_temp,"return");c&&(n.add(c),i.return_temp=ct(e,c)),null!=i.supply_temp?.value&&null!=i.return_temp?.value&&(i.delta_t=Math.round(10*(i.supply_temp.value-i.return_temp.value))/10);const d=a(r.flow_rate,"flow");d&&(n.add(d),i.flow_rate=ct(e,d));const A=a(r.pump_status,"pump");if(A){n.add(A);const t=Ve(e,A);t&&(i.pump_entity=A,i.pump_active=function(e){const t=e.state;return"unavailable"!==t&&"unknown"!==t&&(e.entity_id.startsWith("binary_sensor.")||e.entity_id.startsWith("switch.")?"on"===t:"on"===t||"running"===t||"heat"===t||"heating"===t)}(t))}const p=r.extra_sensors??[],u=[];for(const t of p){if(n.has(t))continue;const r=Ve(e,t);if(!r)continue;const o=Oe(r);if(null==o)continue;const s=Ke(Pe(r),t),i=r.attributes.unit_of_measurement??("humidity"===r.attributes.device_class?"%":"");u.push({entity_id:t,name:s,value:o,unit:i}),n.add(t)}u.length&&(i.extra=u);return i.supply_temp||i.return_temp||i.flow_rate||i.pump_entity||(i.extra?.length??0)>0?i:null}let At=class extends ae{setConfig(e){this._config={auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e}}_valueChanged(e,t){const r=new CustomEvent("config-changed",{detail:{config:{...this._config,[e]:t}}});this.dispatchEvent(r)}_zoneChanged(e,t,r){const o=[...this._config.zones??[]];o[e]={...o[e],[t]:r},this._valueChanged("zones",o),this._valueChanged("auto_discover",!1)}_addZone(){const e=[...this._config.zones??[],{name:"New Zone",climate_entity:""}];this._valueChanged("zones",e),this._valueChanged("auto_discover",!1)}_removeZone(e){const t=(this._config.zones??[]).filter((t,r)=>r!==e);this._valueChanged("zones",t)}_sensorAssignmentChanged(e,t){const r={...this._config.sensor_map??{}},o=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(o.add(e),delete r[e]):"__auto__"===t?(o.delete(e),delete r[e]):(o.delete(e),r[e]=t),this._valueChanged("sensor_map",r),this._valueChanged("exclude_entities",[...o])}_climateEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("climate."))}_sensorEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("sensor."))}_zoneOptions(){return et(this.hass,this._config).map(e=>({id:e.climate_entity,name:`${e.name}${e.area?` (${e.area})`:""}`}))}_sensorHeightChanged(e,t){const r={...this._config.sensor_heights??{}},o=t.trim();if(o){const t=parseFloat(o);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];this._valueChanged("sensor_heights",r)}_referenceHeightChanged(e){const t=parseFloat(e);Number.isNaN(t)||t<0||this._valueChanged("reference_height_ft",t)}_zoneFloorChanged(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t,this._valueChanged("zone_floors",r)}render(){if(!this.hass)return D``;const e=function(e,t){const r=et(e,t),o=qe(t),s=Me(t),n=t.other_sensor_patterns??ye;return Ye(e,t,r).map(i=>{const a=Ue(e,i,n,t),l=s.get(i),c=a?_e(a,r):void 0;return{entity_id:i,name:a?.name??i,area:a?.area,area_id:a?.area_id,value:a?.value,unit:a?.unit,kind:a?.kind??"other",assigned_zone:l,auto_zone:c?.climate_entity,auto_zone_name:c?.name,hidden:o.has(i),height_ft:a?.height_ft}})}(this.hass,this._config),t=et(this.hass,this._config),r=Se(this.hass),o=We(this._config);return D`
    ...
    `:null}renderSunTracker(){if(!1===this._config.show_sun_tracker)return null;const e=this.sunData;if(!e)return null;const t="above_horizon"===e.state,r=Math.max(0,Math.min(1,(e.azimuth-45)/270)),o=Math.max(0,e.elevation)/90,s=[];for(let e=0;e<=100;e++){const t=e/100,r=4+92*t,o=88-55*Math.sin(t*Math.PI);s.push(`${r},${o}`)}const n=`M ${s.join(" L ")}`,i=4+92*r,a=t?88-55*o:95,l=e=>e.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}),c=l(e.rising),d=l(e.setting),A=Math.floor(e.remaining_minutes/60),p=e.remaining_minutes%60,u=t?`${A}h ${p}m left`:"Night";return D`
      <div class="sun-tracker">
        <svg class="sun-tracker-svg" viewBox="0 0 400 55">
          <defs>
            <linearGradient id="skyBg" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stop-color="${t?"rgba(25,118,210,0.35)":"rgba(20,20,60,0.6)"}" />
              <stop offset="100%" stop-color="${t?"rgba(255,183,77,0.08)":"rgba(30,30,80,0.2)"}" />
            </linearGradient>
          ...
          <!-- Full arc (dashed) -->
          <path d="${n}" fill="none" stroke="rgba(255,235,59,0.15)" stroke-width="0.6" stroke-dasharray="2,1.5"
                transform="scale(4,0.55) translate(0,0)"/>

          <!-- Traveled arc -->
          ${t?D`
            <path d="M ${s.slice(0,Math.round(100*r)+1).join(" L ")}"
          ...
          <!-- Sun / Moon -->
          ${t?D`
            <circle cx="${4*i}" cy="${.55*a}" r="12" fill="url(#sunG)"/>
            <circle cx="${4*i}" cy="${.55*a}" r="4" fill="#FFD54F" stroke="#FFF176" stroke-width="0.5"/>
          `:D`
          ...
          <!-- Sunrise label -->
          <text x="22" y="13" font-size="8" fill="#FFB74D" font-family="sans-serif" font-weight="600">↗ ${c}</text>

          <!-- Sunset label -->
          <text x="378" y="13" font-size="8" fill="#FF8A50" font-family="sans-serif" font-weight="600" text-anchor="end">${d} ↘</text>

          <!-- Center info -->
          <text x="200" y="46" font-size="8" fill="rgba(255,255,255,0.6)" font-family="sans-serif" text-anchor="middle">
            ${t?`${Math.round(e.elevation)}° · ${u}`:"Night"}
          </text>
        </svg>
      </div>
