...
`,ge="number.sensorlinx_outdoor_reset_heating_curve_shutdown_temp",be="switch.sensorlinx_outdoor_reset_outdoor_reset_enabled";function ve(e){if(null==e||"unavailable"===e||"unknown"===e)return;const t=Number(e);return Number.isFinite(t)?t:void 0}function ye(e){if(!e)return;const t=e.replace("°","").trim().toUpperCase();return"F"===t||"FAHRENHEIT"===t?"F":"C"===t||"CELSIUS"===t?"C":void 0}function xe(e,t){return"C"===t?9*e/5+32:e}function we(e,t){if(!t)return{};const r=e.states[t];if(!r)return{};return{value:ve(r.state),unit:ye(r.attributes.unit_of_measurement)??ye(r.attributes.temperature_unit)}}function ze(e,t){const r=function(e,t){return t.weather_entity?t.weather_entity:Object.keys(e.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(e.states).find(e=>e.startsWith("weather."))}(e,t);if(!r)return{};const s=e.states[r];if(!s)return{};const o=t.weather_temperature?we(e,t.weather_temperature):{};if(null!=o.value)return o;const n=s.attributes.temperature;if(null!=n&&Number.isFinite(n)){return{value:n,unit:ye(s.attributes.temperature_unit)??ye(e.config?.unit_system?.temperature)}}const i=ve(s.state);return null!=i?{value:i,unit:"F"}:{}}let ke=null;function Se(){ke=null}let Ee=null;function We(e,t){const r=Object.keys(e.states).length,s=function(e){return JSON.stringify({auto_discover:e.auto_discover,zones:e.zones,room_sensors:e.room_sensors,sensor_map:e.sensor_map,exclude_entities:e.exclude_entities,sensor_assignments:e.sensor_assignments,zone_kinds:e.zone_kinds,other_sensor_patterns:e.other_sensor_patterns})}(t);if(ke&&ke.entityCount===r&&ke.configKey===s)return ke;if(!Ee)throw new Error("entity-index: registerEntityIndexDeps not called");const o=[],n=[],i=[],a=new Set;for(const t of Object.values(e.states)){const e=t.entity_id;if(e.startsWith("climate.")){o.push(e);const t=Ee.climateZoneSlug(e);a.add(`sensor.${t}_floor_temperature`),a.add(`sensor.${t}_room_temperature`)}else if(e.startsWith("sensor.")){const r=t.attributes.device_class;"temperature"===r?n.push(e):"humidity"===r&&i.push(e)}}o.sort();const l=t.zones?.length?t.zones:o.map(t=>{const r=e.states[t];return{name:r?.attributes?.friendly_name??t.replace("climate.","").replace(/_/g," "),climate_entity:t,area_id:Ee.entityAreaId(e,t)}}),c=[...n,...i],d=t.room_sensors?.length?null:Ee.buildAssignableSensorIds(e,t,a,c,l,n,i),p=new Map,u=new Set;for(const t of l){const r=Ee.discoverValveEntityIds(e,t.climate_entity,t);p.set(t.climate_entity,r);for(const e of r)u.add(e)}return ke={entityCount:r,configKey:s,climateIds:o,temperatureSensorIds:n,humiditySensorIds:i,floorHeatLinkedIds:a,assignableSensorIds:d,valveIdsByClimate:p,allValveEntityIds:u},ke}function Ce(e,t){const r=[];for(const s of t){const t=e.states[s];if(t)if(s.startsWith("number.")||s.startsWith("sensor.")){const e=parseFloat(t.state);isNaN(e)||r.push({entity_id:s,position:e,active:e>0})}else if(s.startsWith("switch.")||s.startsWith("binary_sensor.")){const e="on"===t.state;r.push({entity_id:s,position:e?100:0,active:e})}}return r}function Ne(e,t){return t.weather_entity?t.weather_entity:Object.keys(e.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(e.states).find(e=>e.startsWith("weather."))}function Ve(e,t,r,s){const o=new Set(r.climateIds);o.add("sun.sun");const n=Ne(e,t);if(n&&o.add(n),r.assignableSensorIds)for(const e of r.assignableSensorIds)o.add(e);else if(t.room_sensors?.length)for(const e of t.room_sensors)o.add(e);for(const e of r.allValveEntityIds)o.add(e);if(s?.length)for(const e of s)o.add(e);for(const e of Object.keys(t.sensor_map??{}))o.add(e);for(const r of function(e,t){const r=new Set;t.wwsd_entity&&r.add(t.wwsd_entity);const s=t.wwsd_shutdown_temp_entity??ge;return e.states[s]&&r.add(s),e.states[be]&&r.add(be),t.wwsd_outdoor_temp_entity&&r.add(t.wwsd_outdoor_temp_entity),t.weather_temperature&&r.add(t.weather_temperature),[...r]}(e,t))o.add(r);return[...o]}function Ie(e,t,r){const s=t.sensor_heights?.[e];return null==s||Number.isNaN(s)?r?.isFloor?0:r?.isRoom?5:void 0:s}function Re(e,t,r){const s=t.reference_height_ft??5,o=function(e,t,r){const s=[],o=t.sensor_heights??{},n=t.zone_heights??{},i=(e,r,n,i)=>{if(null==r)return;const a=(n?o[n]:void 0)??Ie(n??"",t,i);null!=a&&s.push({label:e,temp:r,height_ft:a})};if(null!=e.sensors.floor&&i("Floor",e.sensors.floor,e.linked_sensor_ids?.floor,{isFloor:!0}),null!=e.sensors.room&&i("Room",e.sensors.room,e.linked_sensor_ids?.room,{isRoom:!0}),null!=r){const o=n[e.climate_entity]??t.reference_height_ft??5;s.push({label:"Thermostat",temp:r,height_ft:o})}for(const t of e.roomSensors)null!=t.value&&null!=t.height_ft&&s.push({label:t.name,temp:t.value,height_ft:t.height_ft});return s}(e,t,r);if(!o.length)return null;const n=Math.round(o.reduce((e,t)=>e+t.temp,0)/o.length*10)/10,{value:i,gradient:a}=function(e,t){if(!e.length)return{};if(1===e.length)return{value:e[0].temp};const r=e.length,s=e.reduce((e,t)=>e+t.height_ft,0),o=e.reduce((e,t)=>e+t.temp,0),n=e.reduce((e,t)=>e+t.height_ft*t.temp,0),i=e.reduce((e,t)=>e+t.height_ft*t.height_ft,0),a=r*i-s*s;if(Math.abs(a)<1e-6){const e=o/r;return{value:Math.round(10*e)/10}}const l=(r*n-s*o)/a,c=l*t+(o-l*s)/r;return{value:Math.round(10*c)/10,gradient:Math.round(100*l)/100}}(o,s);return{reference_height_ft:s,point_count:o.length,simple_average:n,estimated_at_reference:i,gradient_per_ft:a}}const Ze=["deye","sunsynk","sol-ark","battery","oven","cavity","inverter","outdoor","outside","exterior","sensorlinx","ubiquiti","unifi","udm","usg","usw","uap","uxg","udr","unvr","unifi_","dream machine","dream router","ultra switch","ap ","ap_backyard","ap_","xgs","_poe","port_","clients","wlan","speedtest","wan ","lan ","firmware","device tracker","poe temperature","switch temperature","cpu","memory","utilization","uptime","signal level","cloud connection","access point","printer","toner","cartridge"," ink","officejet","laserjet","envy","deskjet","tankless","water heater","hot water","inlet temp","outlet temp","weather","tempest","weatherflow","wet bulb","dew point","feels like","heat index","wind chill","wind speed","wind gust","wind bearing","wind direction","barometric","sea level pressure","air density","solar radiation","uv index","lightning","precipitation","rain rate","rain accumulation","visibility","cloud base","beaufort"],qe=["outlet","plug","switch","hallway","flex","unifi","usw","uap","udm","signal level","cloud connection","network","uptime","cpu","memory","mac","energy","power","voltage","current","consumption","co2","voc","aqi","auto-off","auto-update","led","overheated","smooth on","smooth off"],Oe=[{name:"Main Floor",zones:["Laundry","Living Room","Main Area","Main Office","Redmond Thermostat"],room_sensors:["Family Room","Kitchen","Hallway","Stairs","Entryway","Primary Bath","Primary Bedroom"]},{name:"Upper Floor",zones:[],room_sensors:["Hunters","Sydney","Upstair Office","Upstairs Office"]}],Pe={office:"Main Floor","Main Office":"Main Floor",upstairs_office:"Upper Floor",upstairs_hallway:"Upper Floor",hunters_room:"Upper Floor",sidney_s_room:"Upper Floor","Upstairs Office":"Upper Floor","Upstairs Hallway":"Upper Floor","Hunters Room":"Upper Floor","Sidney's Room":"Upper Floor"},Me={};function je(e,t){const r=Le(e),s=Le(t);if(r===s)return!0;const o=r.split(" "),n=s.split(" ");return o[0]===n[0]&&o.length>1&&n.length>1&&"main"===o[0]?o.slice(1).join(" ")===n.slice(1).join(" "):r.includes(s)||s.includes(r)}function Te(e){const t=e.areas;return t?Object.entries(t).map(([e,t])=>({area_id:e,name:t.name??e})).filter(e=>!["weather","whole_house_energy"].includes(e.area_id)).sort((e,t)=>e.name.localeCompare(t.name)):[]}function He(e){return(e.floors??Oe).map(e=>e.name)}function Xe(e,t,r){const s=function(e){return{...Pe,...e.area_floor_map??{}}}(r);return e&&s[e]?s[e]:t&&s[t]?s[t]:void 0}function Fe(e,t,r=t.floors??Oe){const s=function(e){return{...Me,...e.zone_floors??{}}}(t);if(s[e.climate_entity])return s[e.climate_entity];for(const t of r)if(t.zones?.some(t=>je(e.name,t)))return t.name;const o=Xe(e.area_id,e.area,t);return o||(e.floor?e.floor:dt(e.name,e.area,r))}function De(e){const t=e.trim().split(/\s+/);if(t.length>=2&&t.length%2==0){const e=t.length/2;if(t.slice(0,e).join(" ")===t.slice(e).join(" "))return t.slice(0,e).join(" ")}return e}function Le(e){return e.toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Ge(e){return e.attributes.friendly_name??e.entity_id}function Qe(e,t){const r=e.entities?.[t];if(r?.area_id)return r.area_id;const s=r?.device_id;if(s){const t=e.devices?.[s]?.area_id;if(t)return t}}function Be(e,t){if(!t)return;const r=e.areas;return r?.[t]?.name}function Je(e,t=1){if(!e||"unavailable"===e.state||"unknown"===e.state)return;const r=parseFloat(e.state);if(isNaN(r))return;const s=10**t;return Math.round(r*s)/s}function Ue(e,t){if(t)return e.states[t]}function Ye(e){const t=new Set(e.exclude_entities??[]);for(const r of e.sensor_assignments??[])r.hidden&&t.add(r.entity_id);return t}function Ke(e){const t=new Map(Object.entries(e.sensor_map??{}));for(const r of e.sensor_assignments??[])r.zone&&!r.hidden&&t.set(r.entity_id,r.zone);return t}function _e(e,t,r=[]){const s=`${Le(e)} ${Le(t)}`;return[...Ze,...r].some(e=>s.includes(Le(e)))}function $e(e){const t=e.replace(/^climate\./,""),r=t.split("_");if(r.length>=2&&r.length%2==0){const e=r.length/2,t=r.slice(0,e).join("_");if(t===r.slice(e).join("_"))return t}return t}function et(e,t,r){if(r.has(e))return!0;const s=Le(t);return s.includes("current temperature")&&s.includes("thermostat")}function tt(e){const t=e.attributes.device_class;if("temperature"===t||"humidity"===t)return!0;const r=e.attributes.state_class,s=e.attributes.unit_of_measurement;if("measurement"===r&&s){if("%"===s)return!0;if(/°|deg/i.test(s))return!0}return!1}function rt(e,t,r,s){return function(e,t,r){const s=`${Le(e)} ${Le(t)}`;return r.some(e=>s.includes(Le(e)))}(e,t,s)?"other":"temperature"===r||"humidity"===r?"room":"other"}function st(e,t,r,s){const o=Le(e),n=Le(r),i=Le(t),a=Le(s);let l=0;return(o.includes(n)||i.includes(n.replace(/\s+/g,"_")))&&(l+=3),o.includes(a)&&(l+=4),"humidity"===a&&(e.includes("%")||t.includes("humidity"))&&(l+=2),l}function ot(e,t,r,s,o,n){const i=o?Qe(e,o):void 0;let a;const l=n?.length?n.map(t=>e.states[t]).filter(e=>!!e):Object.values(e.states).filter(e=>e.entity_id.startsWith("sensor.")&&e.attributes.device_class===s);for(const o of l){if(o.attributes.device_class!==s)continue;const n=Ge(o);if(_e(n,o.entity_id))continue;let l=st(n,o.entity_id,t,r);i&&Qe(e,o.entity_id)===i&&(l+=6),l>=5&&(!a||l>a.score)&&(a={id:o.entity_id,score:l})}return a?.id}function nt(e,t){const r="on"===t;return{entity_id:e,position:r?100:0,active:r}}function it(e,t,r){const s=$e(t),o=s.split("_").filter(e=>e.length>2),n=Le(s.replace(/_/g," ")),i=e.states;if(r?.valve_entity&&i[r.valve_entity])return[r.valve_entity];const a=[];for(const[e,t]of Object.entries(i))e.includes(s)&&e.includes("valve")&&(e.startsWith("number.")||e.startsWith("sensor.")?isNaN(parseFloat(t.state))||a.push(e):(e.startsWith("switch.")||e.startsWith("binary_sensor."))&&a.push(e));if(a.length)return a;for(const[e]of Object.entries(i)){if(!e.startsWith("switch.")||!e.includes("floor_control_mode"))continue;const t=e.split("floor_control_mode_").pop()??"",r=Le(t.replace(/_/g," "));if(r===n||Le(t)===Le(s)||r===Le(s.replace(/_/g," ")))return[e]}const l=Object.entries(i).filter(([e])=>e.startsWith("binary_sensor.")&&e.includes("redawghome_zone"));if(l.length){const e=i[t],r=Le(e?.attributes?.friendly_name??"").replace(/thm|climate|thermostat/g,"").trim().split(/\s+/).filter(e=>e.length>2),s=Object.entries(i).filter(([e])=>e.startsWith("number.")&&e.includes("valve_count")).map(([e,t])=>({eid:e,state:t,idNorm:Le(e)})).sort((e,t)=>e.idNorm.localeCompare(t.idNorm));let a,c=0;for(const e of s){const t=parseFloat(e.state.state),s=e.idNorm.includes(n)||o.every(t=>e.idNorm.includes(Le(t))),i=r.some(t=>e.idNorm.includes(t));if(s||i){!isNaN(t)&&t>0&&(a=t);break}!isNaN(t)&&t>0&&(c+=t)}const d=l.map(([e,t])=>{const r=parseInt(e.match(/zone_(\d+)/)?.[1]??"",10);return{eid:e,state:t,zoneNum:r}}).filter(e=>!isNaN(e.zoneNum)).sort((e,t)=>e.zoneNum-t.zoneNum),p=null!=a&&a>0?d.slice(c,c+a):d.filter(({eid:e})=>{const t=Le(e);return o.some(e=>t.includes(Le(e)))});if(p.length)return p.map(({eid:e})=>e)}const c=Qe(e,t);if(c){const t=[];for(const[r,s]of Object.entries(i)){if(!r.startsWith("binary_sensor."))continue;const o=s.attributes,n=o.device_class;if("running"!==n&&"heat"!==n)continue;const i=o.icon,a=i?.includes("valve")||i?.includes("pipe"),l=`${o.friendly_name??""} ${r}`.toLowerCase();if(!(a||l.includes("valve")||l.includes("relay")||l.includes("zone")||r.includes("redawghome_zone")))continue;Qe(e,r)===c&&t.push(r)}if(t.length)return t}const d=i[t],p=Le(d?.attributes?.friendly_name??"");if(p){const e=[];for(const[t,r]of Object.entries(i)){if(!t.startsWith("binary_sensor."))continue;const s=r.attributes,o=s.device_class;if("running"!==o&&"heat"!==o)continue;const n=Le(s.friendly_name??""),i=p.replace(/thm|climate|thermostat/g,"").trim().split(/\s+/).filter(e=>e.length>2);i.some(e=>n.includes(e))&&e.push(t)}if(e.length)return e}return[]}function at(e,t,r,s){if(r?.valve_entity){const t=e.states[r.valve_entity];if(t){const e=function(e,t){const r=parseFloat(t);if(!isNaN(r))return{entity_id:e,position:r,active:r>0}}(r.valve_entity,t.state);return e?[e]:[nt(r.valve_entity,t.state)]}}if(s){const r=We(e,s).valveIdsByClimate.get(t);if(r?.length)return Ce(e,r)}return Ce(e,it(e,t,r))}function lt(e,t,r){const s=r?.temperatureSensorIds,o=r?.humiditySensorIds;return{floor:t.floor_sensor??ot(e,t.name,"floor temperature","temperature",t.climate_entity,s),room:t.room_sensor??ot(e,t.name,"room temperature","temperature",t.climate_entity,s),humidity:t.humidity_sensor??ot(e,t.name,"humidity","humidity",t.climate_entity,o)}}function ct(e,t,r,s){const o=s?.zone_kinds?.[t.climate_entity];if(o)return o;if(null!=r.floor)return"floor_heat";if(Le(t.name).includes("thermostat"))return"thermostat";const n=Ue(e,t.climate_entity);return(n?.attributes.hvac_modes??[]).includes("heat_cool")?"thermostat":"floor_heat"}function dt(e,t,r){const s=Le(`${e} ${t??""}`);for(const e of r){const t=e.zones?.some(e=>s.includes(Le(e))),r=e.room_sensors?.some(e=>s.includes(Le(e)));if(t||r)return e.name}return/hunter|sydney|upstair/.test(s)?"Upper Floor":"Main Floor"}function pt(e,t){let r=De(e.replace(/\s+(temperature|humidity|temp)$/i,""));const s=`${Le(e)} ${Le(t)}`;if(s.includes("outdoor reset")){const t=e.match(/:\s*(.+)$/);return t?`Outdoor reset target (${t[1].trim()})`:"Outdoor reset target"}return s.includes("ecobee")&&s.includes("remote")&&(r=r.replace(/\s*ecobee\s*/i," ").trim(),/remote/i.test(r)||(r=`${r} (Remote)`)),r}function ut(e,t,r,s){const o=Ue(e,t);if(!o)return;const n=o.attributes.device_class,i=Ge(o),a=pt(i,t),l=o.attributes.unit_of_measurement??("humidity"===n?"%":"°"),c=rt(i,t,n,r),d=/floor/i.test(i)||/floor/i.test(t),p=Qe(e,t);return{name:a,entity_id:t,area:Be(e,p),area_id:p,value:Je(o),unit:l,kind:c,height_ft:Ie(t,s,{isFloor:d,isRoom:"room"===c&&!d})}}function At(e,t,r){if(t.room_sensors?.length)return[...t.room_sensors];const s=We(e,t);if(s.assignableSensorIds)return s.assignableSensorIds;const o=function(e,t,r,s){const o=new Set;for(const e of t.zones??[])e.floor_sensor&&o.add(e.floor_sensor),e.room_sensor&&o.add(e.room_sensor),e.humidity_sensor&&o.add(e.humidity_sensor);const n=s?.temperatureSensorIds,i=s?.humiditySensorIds;for(const s of r){const r=t.zones?.find(e=>e.climate_entity===s.climate_entity)??{name:s.name,climate_entity:s.climate_entity};for(const t of[r.floor_sensor??ot(e,s.name,"floor temperature","temperature",s.climate_entity,n),r.room_sensor??ot(e,s.name,"room temperature","temperature",s.climate_entity,n),r.humidity_sensor??ot(e,s.name,"humidity","humidity",s.climate_entity,i)])t&&o.add(t)}return o}(e,t,r,s),n=s.floorHeatLinkedIds,i=[],a=[...s.temperatureSensorIds,...s.humiditySensorIds];for(const t of a){const r=Ue(e,t);if(!r)continue;if(!tt(r))continue;if(o.has(t))continue;const s=Ge(r);_e(s,t)||(et(t,s,n)||i.push(t))}for(const e of Ke(t).keys())i.includes(e)||i.push(e);return i.sort()}function ht(e,t){if(e.area_id){const r=t.find(t=>t.area_id&&t.area_id===e.area_id);if(r)return r}const r=t.find(t=>function(e,t){return!(!e||!t)&&Le(e)===Le(t)}(e.area,t.area));return r||t.find(t=>function(e,t){const r=Le(e),s=Le(t.name);return r.includes(s)||s.includes(r)}(e.name,t))}function ft(e,t,r){const s=Ke(r).get(e.entity_id);return s?function(e,t){return t.find(t=>t.climate_entity===e||Le(t.name)===Le(e)||Le(t.climate_entity)===Le(e))}(s,t):ht(e,t)}function mt(e,t){const r=We(e,t),s=t.zones?.length?t.zones:t.auto_discover?function(e,t){return We(e,t).climateIds.map(t=>{const r=e.states[t],s=r?.attributes?.friendly_name??t.replace("climate.","").replace(/_/g," "),o=Qe(e,t);return{name:De(s),climate_entity:t,area:Be(e,o),area_id:o}})}(e,t):[];return s.map(s=>{const o=function(e,t,r){const s=lt(e,t,r)??{},o=Ue(e,s.floor),n=Ue(e,s.room),i=Ue(e,s.humidity);return{floor:Je(o),room:Je(n),humidity:Je(i)}}(e,s,r),n=s.area_id??Qe(e,s.climate_entity),i=s.area??Be(e,n),a=lt(e,s,r),l=at(e,s.climate_entity,s,t),c=l[0];return{name:s.name,climate_entity:s.climate_entity,area:i,area_id:n,floor:s.floor,kind:ct(e,s,o,t),sensors:o,roomSensors:[],otherSensors:[],linked_sensor_ids:a,valves:l.length?l:void 0,valve_entity:c?.entity_id,valve_position:c?.position,valve_active:c?.active}})}function gt(e,t){const r=t.floors??Oe,s=mt(e,t),{zones:o,unassigned:n}=function(e,t,r){if(!1===t.show_room_sensors)return{zones:r,unassigned:[]};const s=Ye(t),o=t.other_sensor_patterns??qe,n=[],i=r.map(e=>({...e,roomSensors:[],otherSensors:[]}));for(const a of At(e,t,r)){if(s.has(a))continue;const r=ut(e,a,o,t);if(!r||null==r.value)continue;const l=ft(r,i,t);if(!l){n.push(r);continue}const c=i.find(e=>e.climate_entity===l.climate_entity);"other"===r.kind?c.otherSensors.push(r):c.roomSensors.push(r)}for(const e of i)e.roomSensors.sort((e,t)=>e.name.localeCompare(t.name)),e.otherSensors.sort((e,t)=>e.name.localeCompare(t.name));return n.sort((e,t)=>e.name.localeCompare(t.name)),{zones:i,unassigned:n}}(e,t,s);if(!(!1!==t.group_by_floor))return[{name:"Climate Zones",zones:o,unassignedSensors:n}];const i=new Map;for(const e of r)i.set(e.name,{name:e.name,zones:[],unassignedSensors:[]});const a={name:"Other",zones:[],unassignedSensors:[]},l=e=>Fe(e,t,r);for(const e of o){const t=l(e),r=i.get(t);r?r.zones.push(e):a.zones.push(e)}for(const e of n){const s=Xe(e.area_id,e.area,t)??dt(e.name,e.area,r),o=i.get(s);o?o.unassignedSensors.push(e):a.unassignedSensors.push(e)}const c=r.map(e=>i.get(e.name)).filter(e=>e.zones.length||e.unassignedSensors.length);return(a.zones.length||a.unassignedSensors.length)&&c.push(a),c}const bt=["supply","return","flow","manifold","boiler","water_temp","pump","optimal","inlet","outlet","water heater","tankless","hot water"],vt=["supply","supply temp","supply water","supply temperature","outlet","outlet temp","hot water","outgoing"],yt=["return","return temp","return water","return temperature","inlet","inlet temp","cold water","incoming"],xt=["flow rate","flow","water flow"],wt=["pump","boiler","circulator","manifold pump"],zt=["power","watt","consumption","current consumption","energy usage","power draw"];function kt(e,t){const r=`${Le(e)} ${Le(t)}`;return bt.some(e=>r.includes(Le(e)))}function St(e,t,r){const s=`${Le(e)} ${Le(t)}`;return r.some(e=>s.includes(Le(e)))}function Et(e,t,r=1){const s=Ue(e,t);if(!s)return;const o=Je(s,r);if(null==o)return;return{entity_id:t,value:o,unit:s.attributes.unit_of_measurement??("humidity"===s.attributes.device_class?"%":"°")}}function Wt(e,t,r){const s=`${Le(t)} ${Le(r)}`,o=s.includes("inlet"),n=s.includes("outlet");let i=0;return"supply"===e?(n&&(i+=10),o&&!n&&(i-=12),(r.includes("outlet_temp")||r.endsWith("outlet_temperature"))&&(i+=6)):(o&&(i+=10),n&&!o&&(i-=12),(r.includes("inlet_temp")||r.endsWith("inlet_temperature"))&&(i+=6)),i}function Ct(e,t){const r=t.floor_system;if(!1===r)return null;const s=r||{auto_discover:!0},o=s.supply_temp||s.return_temp||s.flow_rate||s.pump_status||s.power||(s.extra_sensors?.length??0)>0,n=s.auto_discover||!o,i=new Set,a=(t,r)=>t||(n?function(e,t,r){const s={supply:vt,return:yt,flow:xt,pump:wt,power:zt}[t];let o;for(const n of Object.values(e.states)){if(r.has(n.entity_id))continue;const e=Ge(n);if(!kt(e,n.entity_id))continue;if("pump"===t){if(!n.entity_id.startsWith("binary_sensor.")&&!n.entity_id.startsWith("switch."))continue}else if(!n.entity_id.startsWith("sensor."))continue;if(!St(e,n.entity_id,s))continue;let i=0;if((Le(e).includes("optimal")||Le(n.entity_id).includes("optimal"))&&(i+=2),"supply"!==t&&"return"!==t||(i+=Wt(t,e,n.entity_id)),"supply"===t&&Le(e).includes("supply")&&(i+=2),"return"===t&&Le(e).includes("return")&&(i+=2),"flow"===t&&Le(e).includes("flow")&&(i+=4),"pump"===t&&(Le(e).includes("pump")||Le(e).includes("boiler")||Le(e).includes("heating"))&&(i+=4),"power"===t){const t=(n.attributes.unit_of_measurement??"").toLowerCase();"w"!==t&&"kw"!==t||(i+=4),(Le(e).includes("power")||Le(e).includes("watt"))&&(i+=3),Le(e).includes("consumption")&&(i+=2)}i<0||(!o||i>o.score)&&(o={id:n.entity_id,score:i})}return o?.id}(e,r,i):void 0),l={},c=a(s.supply_temp,"supply");c&&i.add(c),l.supply_temp=c;const d=a(s.return_temp,"return");d&&i.add(d),l.return_temp=d;const p=a(s.flow_rate,"flow");p&&i.add(p),l.flow_rate=p;const u=a(s.pump_status,"pump");u&&i.add(u),l.pump_status=u;const A=a(s.power,"power");A&&i.add(A),l.power=A;const h=Object.values(e.states).find(e=>e.entity_id.startsWith("water_heater."));h&&(l.heater=h.entity_id);const f=s.extra_sensors??[];f.length&&(l.extra=f.filter(e=>!i.has(e)));return l.supply_temp||l.return_temp||l.flow_rate||l.pump_status||l.power||l.heater||(l.extra?.length??0)>0?l:null}var Nt;Nt={normalize:Le,friendlyName:Ge,entityAreaId:Qe,climateZoneSlug:$e,isExcluded:_e,isClimateSensorEntity:tt,isClimateLinkedSensor:et,discoverValveEntityIds:it,buildAssignableSensorIds:function(e,t,r,s,o,n,i){const a=o.map(e=>({name:e.name,climate_entity:e.climate_entity,kind:"floor_heat",sensors:{},roomSensors:[],otherSensors:[]})),l=new Set;for(const e of t.zones??[])e.floor_sensor&&l.add(e.floor_sensor),e.room_sensor&&l.add(e.room_sensor),e.humidity_sensor&&l.add(e.humidity_sensor);for(const r of a){const s=t.zones?.find(e=>e.climate_entity===r.climate_entity)??{name:r.name,climate_entity:r.climate_entity};for(const t of[s.floor_sensor??ot(e,r.name,"floor temperature","temperature",r.climate_entity,n),s.room_sensor??ot(e,r.name,"room temperature","temperature",r.climate_entity,n),s.humidity_sensor??ot(e,r.name,"humidity","humidity",r.climate_entity,i)])t&&l.add(t)}const c=[];for(const t of s){const s=Ue(e,t);if(!s)continue;if(!tt(s))continue;if(l.has(t))continue;const o=Ge(s);_e(o,t)||et(t,o,r)||c.push(t)}for(const e of Ke(t).keys())c.includes(e)||c.push(e);return c.sort()}},Ee=Nt;let Vt=class extends ce{setConfig(e){this._config={auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e}}_valueChanged(e,t){const r=new CustomEvent("config-changed",{detail:{config:{...this._config,[e]:t}}});this.dispatchEvent(r)}_zoneChanged(e,t,r){const s=[...this._config.zones??[]];s[e]={...s[e],[t]:r},this._valueChanged("zones",s),this._valueChanged("auto_discover",!1)}_addZone(){const e=[...this._config.zones??[],{name:"New Zone",climate_entity:""}];this._valueChanged("zones",e),this._valueChanged("auto_discover",!1)}_removeZone(e){const t=(this._config.zones??[]).filter((t,r)=>r!==e);this._valueChanged("zones",t)}_sensorAssignmentChanged(e,t){const r={...this._config.sensor_map??{}},s=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(s.add(e),delete r[e]):"__auto__"===t?(s.delete(e),delete r[e]):(s.delete(e),r[e]=t),this._valueChanged("sensor_map",r),this._valueChanged("exclude_entities",[...s])}_climateEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("climate."))}_sensorEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("sensor."))}_zoneOptions(){return mt(this.hass,this._config).map(e=>({id:e.climate_entity,name:`${e.name}${e.area?` (${e.area})`:""}`}))}_sensorHeightChanged(e,t){const r={...this._config.sensor_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];this._valueChanged("sensor_heights",r)}_referenceHeightChanged(e){const t=parseFloat(e);Number.isNaN(t)||t<0||this._valueChanged("reference_height_ft",t)}_zoneFloorChanged(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t,this._valueChanged("zone_floors",r)}render(){if(!this.hass)return L``;const e=function(e,t){const r=mt(e,t),s=Ye(t),o=Ke(t),n=t.other_sensor_patterns??qe;return At(e,t,r).map(i=>{const a=ut(e,i,n,t),l=o.get(i),c=a?ht(a,r):void 0;return{entity_id:i,name:a?.name??i,area:a?.area,area_id:a?.area_id,value:a?.value,unit:a?.unit,kind:a?.kind??"other",assigned_zone:l,auto_zone:c?.climate_entity,auto_zone_name:c?.name,hidden:s.has(i),height_ft:a?.height_ft}})}(this.hass,this._config),t=mt(this.hass,this._config),r=Te(this.hass),s=He(this._config);return L`
      <div class="editor">
        <div class="field">
          <label>Title</label>
          <input
    ...
    `}};e([he({attribute:!1})],Vt.prototype,"hass",void 0),e([fe()],Vt.prototype,"_config",void 0),Vt=e([pe("climate-command-center-editor")],Vt);let It=class extends ce{constructor(){super(...arguments),this._expandedZone=null,this._editSensors=!1,this._setupMode=!1,this._setupSaveReminder=!1,this._view="cards",this._placingThermostat=null,this._forecast=null,this._savePending=!1,this._sectionsCache=null,this._trackedEntityIds=[],this._lastStateCount=0,this._pendingSaveConfig=null}_persistConfig(e){this._config=e,this._invalidateSections(),Se(),function(e,t,r){const s=new CustomEvent(t,{detail:r,bubbles:!0,composed:!0});e.dispatchEvent(s)}(this,"config-changed",{config:e}),this._scheduleSaveToLovelace(e)}_scheduleSaveToLovelace(e){this._pendingSaveConfig=e,this._saveDebounceTimer&&clearTimeout(this._saveDebounceTimer),this._saveDebounceTimer=setTimeout(()=>{const e=this._pendingSaveConfig;this._pendingSaveConfig=null,e&&this._saveToLovelace(e)},300)}async _saveToLovelace(e){if(this._hass&&!this._savePending){this._savePending=!0;try{const t=this._detectUrlPath(),r=await this._hass.callWS({type:"lovelace/config",url_path:t});if(!r?.views)return;const s=r.views,o={...e};delete o._llInstances,this._findAndReplace(s,o)&&await this._hass.callWS({type:"lovelace/config/save",config:r,url_path:t})}catch(e){console.warn("climate-command-center: config save failed",e)}finally{this._savePending=!1}}}_findAndReplace(e,t){for(const r of e)if(this._replaceInCards(r.cards,t))return!0;return!1}_replaceInCards(e,t){if(!e)return!1;for(let r=0;r<e.length;r++){const s=e[r];if("custom:climate-command-center"===s.type)return e[r]=t,!0;const o=s.cards??s.card;if(Array.isArray(o)&&this._replaceInCards(o,t))return!0;if(o&&!Array.isArray(o)&&"custom:climate-command-center"===o.type)return s.card&&(s.card=t),!0}return!1}_detectUrlPath(){try{const e=window.location.pathname.match(/^\/([^/]+)/),t=e?.[1];return t&&"lovelace"!==t?t:null}catch{return null}}static get styles(){return me}get hass(){return this._hass}set hass(e){const t=this._hass;this._hass=e,!this._floorSystemEntityIds&&e&&this._config&&(this._floorSystemEntityIds=Ct(e,this._config)),!this._forecastUnsub&&e&&this._subscribeForecast();const r=Object.keys(e.states).length;return r!==this._lastStateCount?(this._lastStateCount=r,Se(),this._rebuildTrackedEntities(),this._invalidateSections(),void this.requestUpdate()):t&&this._config?void(function(e,t,r){for(const s of r){const r=e.states[s],o=t.states[s];if(r&&o){if(r.state!==o.state)return!0;if(r.last_updated!==o.last_updated)return!0}else if(r!==o)return!0}return!1}(t,e,this._trackedEntityIds)&&(this._invalidateSections(),this.requestUpdate())):(this._rebuildTrackedEntities(),void this.requestUpdate())}_rebuildTrackedEntities(){if(!this._hass||!this._config)return void(this._trackedEntityIds=[]);const e=We(this._hass,this._config);this._trackedEntityIds=Ve(this._hass,this._config,e,this._floorSystemEntityIds?function(e){const t=[];return e.supply_temp&&t.push(e.supply_temp),e.return_temp&&t.push(e.return_temp),e.flow_rate&&t.push(e.flow_rate),e.pump_status&&t.push(e.pump_status),e.power&&t.push(e.power),e.heater&&t.push(e.heater),e.extra?.length&&t.push(...e.extra),t}(this._floorSystemEntityIds):void 0)}_invalidateSections(){this._sectionsCache=null}setConfig(e){if(!e.zones?.length&&!e.auto_discover)throw new Error("Configure zones or enable auto_discover");this._config={title:"Climate Command Center",auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e,floors:e.floors?.length?e.floors:Oe},this._floorSystemEntityIds=void 0,this._invalidateSections(),Se(),this._hass&&(this._floorSystemEntityIds=Ct(this._hass,this._config),this._rebuildTrackedEntities())}getCardSize(){return 6}connectedCallback(){super.connectedCallback(),this._subscribeForecast()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeForecast(),this._saveDebounceTimer&&clearTimeout(this._saveDebounceTimer)}async _subscribeForecast(){if(this._unsubscribeForecast(),!this.hass)return;const e=this._config.weather_entity??Object.keys(this.hass.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(this.hass.states).find(e=>e.startsWith("weather."));if(e)try{this._forecastUnsub=await this.hass.connection.subscribeMessage(e=>{e.forecast&&(this._forecast=e.forecast.slice(0,8))},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:e})}catch{}}_unsubscribeForecast(){this._forecastUnsub&&(this._forecastUnsub(),this._forecastUnsub=void 0)}get sections(){if(this._sectionsCache)return this._sectionsCache;const e=gt(this.hass,this._config);return this._sectionsCache=e,e}get weather(){if(!this._config.show_weather)return null;const e=function(e,t){const r=Ne(e,t),s=r?Ue(e,r):null,o=s?.attributes??{},n=(t,r,s=[])=>Object.values(e.states).find(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const o=Le(Ge(e)),n=`${Le(e.entity_id)} ${o}`;if(r&&e.attributes.device_class!==r)return!1;if(!(n.includes("weather")||n.includes("tempest")||n.includes("weatherflow")))return!1;const i=t.some(e=>n.includes(Le(e))),a=s.some(e=>n.includes(Le(e)));return i&&!a})?.entity_id,i=o.temperature??Je(Ue(e,t.weather_temperature??n(["temperature"],"temperature",["wet bulb","dew","feels","heat index","wind chill"])));if(null==i&&!s)return null;const a={label:s?Ge(s).replace(/\s*(Weather|Forecast|Cloud)$/i,"")||"Weather":"Outside",temperature:i,condition:s?.state,humidity:o.humidity??Je(Ue(e,t.weather_humidity??n(["humidity"],"humidity"))),feels_like:Je(Ue(e,t.weather_feels_like??n(["feels like","apparent"],"temperature"))),dew_point:Je(Ue(e,t.weather_dew_point??n(["dew point"],"temperature"))),wind_speed:o.wind_speed??Je(Ue(e,n(["wind speed","wind avg"],void 0))),wind_bearing:o.wind_bearing,wind_gust:Je(Ue(e,n(["wind gust","gust"],void 0))),pressure:o.pressure??Je(Ue(e,n(["pressure","barometric"],"pressure"))),uv_index:Je(Ue(e,n(["uv","ultraviolet"],void 0,["solar"]))),visibility:o.visibility,precipitation:Je(Ue(e,n(["precipitation","rain"],void 0,["probability","lightning"])))};if(r&&s){const e=o.forecast;e?.length&&(a.forecast=e.slice(0,8))}return a}(this.hass,this._config);return e&&this._forecast?.length&&!e.forecast?.length&&(e.forecast=this._forecast),e}get floorSystem(){return this._hass?(void 0===this._floorSystemEntityIds&&(this._floorSystemEntityIds=Ct(this._hass,this._config)),this._floorSystemEntityIds?function(e,t){const r={};if(t.supply_temp&&(r.supply_temp=Et(e,t.supply_temp)),t.return_temp&&(r.return_temp=Et(e,t.return_temp)),null!=r.supply_temp?.value&&null!=r.return_temp?.value&&(r.delta_t=Math.round(10*(r.supply_temp.value-r.return_temp.value))/10),t.flow_rate&&(r.flow_rate=Et(e,t.flow_rate)),t.pump_status){const s=Ue(e,t.pump_status);s&&(r.pump_entity=t.pump_status,r.pump_active=function(e){const t=e.state;return"unavailable"!==t&&"unknown"!==t&&(e.entity_id.startsWith("binary_sensor.")||e.entity_id.startsWith("switch.")?"on"===t:"on"===t||"running"===t||"heat"===t||"heating"===t)}(s))}if(t.power&&(r.power=Et(e,t.power,3)),t.heater){const s=Ue(e,t.heater);if(s){r.heater_entity=t.heater,r.heater_state=s.state;const e=s.attributes.temperature;null!=e&&(r.set_temp=e,r.set_temp_unit=s.attributes.unit_of_measurement??s.attributes.temperature_unit??"°")}}if(t.extra?.length){const s=[];for(const r of t.extra){const t=Ue(e,r);if(!t)continue;const o=Je(t);if(null==o)continue;const n=pt(Ge(t),r),i=t.attributes.unit_of_measurement??("humidity"===t.attributes.device_class?"%":"");s.push({entity_id:r,name:n,value:o,unit:i})}s.length&&(r.extra=s)}return r.supply_temp||r.return_temp||r.flow_rate||r.pump_entity||r.power||(r.extra?.length??0)>0?r:null}(this._hass,this._floorSystemEntityIds):null):null}formatPowerKw(e,t){if(!e||!this._hass)return;const r=this._hass.states[e];if(!r||"unavailable"===r.state||"unknown"===r.state)return;const s=parseFloat(r.state);if(isNaN(s))return;const o="kw"===(r.attributes.unit_of_measurement??t??"").toLowerCase()?s:s/1e3,n=o>=1?1:o>=.01?2:3;return String(parseFloat(o.toFixed(n)))}get sunData(){return function(e){const t=Ue(e,"sun.sun");if(!t)return null;const r=t.attributes.elevation??0,s=t.attributes.azimuth??180,o=t.state,n=t.attributes.next_rising,i=t.attributes.next_setting;if(!n||!i)return null;let a=new Date(n),l=new Date(i);const c=new Date;if("above_horizon"===o){const e=new Date(a.getTime()-864e5);a=e}else{const e=new Date(l.getTime()-864e5);l=e;const t=new Date(a.getTime()-864e5);a=t}const d=l.getTime()-a.getTime(),p=c.getTime()-a.getTime(),u=d>0?p/d:0,A=Math.round(d/6e4),h=Math.max(0,Math.round((l.getTime()-c.getTime())/6e4));return{state:o,elevation:r,azimuth:s,rising:a,setting:l,progress:u,daylight_minutes:A,remaining_minutes:h}}(this.hass)}get totalZones(){return this.sections.reduce((e,t)=>e+t.zones.length,0)}get zoneOptions(){return mt(this.hass,this._config)}get haAreas(){return Te(this.hass)}get floorOptions(){return He(this._config)}async setEntityHaArea(e,t){const r=this.hass;r.callWS&&await r.callWS({type:"config/entity_registry/update",entity_id:e,area_id:t})}async updateSensorAssignment(e,t){if(t.startsWith("area:")){const r=t.slice(5);try{await this.setEntityHaArea(e,r)}catch(t){console.error("Failed to set HA area",e,r,t)}return void this.updateSensorMap(e,"__auto__")}this.updateSensorMap(e,t)}updateZoneFloor(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t;const s={...this._config,zone_floors:r};this._config=s,this._persistConfig(s)}updateZoneKind(e,t){const r={...this._config.zone_kinds??{}};r[e]=t;const s={...this._config,zone_kinds:r};this._config=s,this._persistConfig(s)}toggleSetupMode(){this._setupMode?(this._setupMode=!1,this._setupSaveReminder=!0):(this._setupMode=!0,this._editSensors=!1,this._setupSaveReminder=!1)}updateFloorSystem(e,t){if("disabled"===e){const e="true"===t?{...this._config,floor_system:!1}:{...this._config,floor_system:void 0};return this._config=e,void this._persistConfig(e)}if(!1===this._config.floor_system)return;const r={...this._config.floor_system??{}};""===t||"__auto__"===t?delete r[e]:r[e]=t;const s=r.supply_temp||r.return_temp||r.flow_rate||r.pump_status||r.heater_image||(r.extra_sensors?.length??0)>0,o={...this._config,floor_system:s?r:void 0};this._config=o,this._persistConfig(o)}floorSystemEntityOptions(e){const t=Object.values(this.hass.states),r=(e,t)=>t.some(t=>e.includes(t)),s=e=>{const t=(e.attributes.friendly_name??"").toLowerCase();return`${e.entity_id.toLowerCase()} ${t}`};switch(e){case"supply_temp":case"return_temp":{const o="supply_temp"===e?["supply","hot","outlet","output"]:["return","cold","inlet","input"];return t.filter(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const t=s(e);return!("temperature"!==e.attributes.device_class&&"°F"!==e.attributes.unit_of_measurement&&"°C"!==e.attributes.unit_of_measurement&&!t.includes("temperature")&&!t.includes("temp"))&&(!!r(t,o)||!(!t.includes("water")||!t.includes("heater")))}).map(e=>e.entity_id).sort()}case"flow_rate":return t.filter(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const t=s(e);return r(t,["flow","gpm","gallons","flow_rate"])}).map(e=>e.entity_id).sort();case"pump_status":return t.filter(e=>{const t=e.entity_id.toLowerCase();if(!t.startsWith("switch.")&&!t.startsWith("binary_sensor.")&&!t.startsWith("input_boolean."))return!1;const o=s(e);return r(o,["pump","boiler","circulator","heater","water_heater"])}).map(e=>e.entity_id).sort();default:return[]}}floorSystemFieldValue(e){if(!1===this._config.floor_system)return"__auto__";const t=this._config.floor_system;return t?t[e]??"__auto__":"__auto__"}floorSystemStatusLabel(){if(!1===this._config.floor_system)return"Disabled";const e=this._config.floor_system;if(!e)return"Auto-discovered";return e.supply_temp||e.return_temp||e.flow_rate||e.pump_status?"Configured":"Auto-discovered"}entityOptionLabel(e){const t=this.hass.states[e];return`${t?.attributes?.friendly_name??e} (${e})`}renderFloorSystemFieldSelect(e,t){const r=this.floorSystemEntityOptions(t),s=this.floorSystemFieldValue(t),o=!1===this._config.floor_system;return L`
    ...
    `:null}renderHeightBadge(e){return null==e?null:L`<span class="height-badge">${e} ft</span>`}renderZoneHeightStats(e,t){const r=Re(e,this._config,t);return r?L`
    ...
    `}renderSensorAssign(e){if(!this._editSensors)return null;const t=this._config.sensor_map?.[e.entity_id]??(this._config.exclude_entities?.includes(e.entity_id)?"__hidden__":"__auto__"),r=ht(e,this.zoneOptions),s=e.area?`Auto (HA: ${e.area}${r?` → ${r.name}`:""})`:r?`Auto (→ ${r.name})`:"Auto (by HA area)";return L`
      <select
    ...
    `}};e([he({attribute:!1})],It.prototype,"_config",void 0),e([fe()],It.prototype,"_expandedZone",void 0),e([fe()],It.prototype,"_editSensors",void 0),e([fe()],It.prototype,"_setupMode",void 0),e([fe()],It.prototype,"_setupSaveReminder",void 0),e([fe()],It.prototype,"_view",void 0),e([fe()],It.prototype,"_placingThermostat",void 0),e([fe()],It.prototype,"_forecast",void 0),It=e([pe("climate-command-center")],It),window.customCards=window.customCards??[],window.customCards.push({type:"climate-command-center",name:"Climate Command Center",description:"Unified dashboard for thermostats, heated floors, and weather sensors",preview:!0}),console.info("%c CLIMATE-COMMAND-CENTER %c v0.5.1 ","color: white; background: #0288d1; font-weight: 700;","color: #0288d1; background: white; font-weight: 700;");const Rt=()=>It,Zt=()=>document.createElement("climate-command-center-editor");export{It as ClimateCommandCenterCard,Rt as getCard,Zt as getCardEditor};
