    ...
    `}tempToColor(e){if(null==e)return"#64b5f6";const t=(Math.max(50,Math.min(140,e))-50)/90;if(t<.33){return`rgb(${Math.round(30+3*t*70)},${Math.round(130+3*t*70)},${Math.round(245-3*t*50)})`}if(t<.66){const e=(t-.33)/.33;return`rgb(${Math.round(100+155*e)},${Math.round(200-50*e)},${Math.round(195-145*e)})`}{const e=(t-.66)/.34;return`rgb(${Math.round(255)},${Math.round(150-80*e)},${Math.round(50-30*e)})`}}renderFloorSystem(){const e=this.floorSystem;if(!e)return null;const t=e.return_temp?.value,r=e.supply_temp?.value,s=this.tempToColor(t),o=this.tempToColor(r),n=e.return_temp?.unit??"°",i=e.supply_temp?.unit??"°",a=this._config.floor_system,l=(!1!==a&&a?.heater_image?.trim()?a.heater_image.trim():void 0)??"data:image/png;base64,",c=null!=e.flow_rate?.value?Number(e.flow_rate.value):NaN,d=!isNaN(c)&&c>=.02,p=136,u=136,A=132,h=12,f=14,m=164.64,g=197.28;return G`
      <div class="floor-system tankless-visual">
        <svg class="tankless-svg" viewBox="0 0 400 230" preserveAspectRatio="xMidYMid meet">
          ...
          <rect x="${190.28}" y="${146}" width="14" height="10" rx="2" fill="#b87333" stroke="#8b5a2b" stroke-width="0.5"/>
          ...
          <path d="M 400,${169} L ${237.28},${169} Q ${g},${169} ${g},${156}"
            fill="none" stroke="rgba(200,200,210,0.35)" stroke-width="${f}" stroke-linecap="round"/>
          <path d="M 400,${169} L ${237.28},${169} Q ${g},${169} ${g},${156}"
            fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="${12}" stroke-linecap="round"/>
          <path d="M 397,${169} L ${237.28},${169} Q ${g},${169} ${g},${156}"
            fill="none" stroke="${d?"url(#inletFlow)":"rgba(120,130,150,0.25)"}" stroke-width="${10}" stroke-linecap="round"/>
          <!-- Glass highlight on horizontal section -->
          <path d="M ${241.28},${164} L 394,${164}"
            fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="2" stroke-linecap="round"/>
