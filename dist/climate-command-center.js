...
`;function me(e,t,r){const s=t.sensor_heights?.[e];return null==s||Number.isNaN(s)?r?.isFloor?0:r?.isRoom?5:void 0:s}function ge(e,t,r){const s=t.reference_height_ft??5,o=function(e,t,r){const s=[],o=t.sensor_heights??{},i=t.zone_heights??{},n=(e,r,i,n)=>{if(null==r)return;const a=(i?o[i]:void 0)??me(i??"",t,n);null!=a&&s.push({label:e,temp:r,height_ft:a})};if(null!=e.sensors.floor&&n("Floor",e.sensors.floor,e.linked_sensor_ids?.floor,{isFloor:!0}),null!=e.sensors.room&&n("Room",e.sensors.room,e.linked_sensor_ids?.room,{isRoom:!0}),null!=r){const o=i[e.climate_entity]??t.reference_height_ft??5;s.push({label:"Thermostat",temp:r,height_ft:o})}for(const t of e.roomSensors)null!=t.value&&null!=t.height_ft&&s.push({label:t.name,temp:t.value,height_ft:t.height_ft});return s}(e,t,r);if(!o.length)return null;const i=Math.round(o.reduce((e,t)=>e+t.temp,0)/o.length*10)/10,{value:n,gradient:a}=function(e,t){if(!e.length)return{};if(1===e.length)return{value:e[0].temp};const r=e.length,s=e.reduce((e,t)=>e+t.height_ft,0),o=e.reduce((e,t)=>e+t.temp,0),i=e.reduce((e,t)=>e+t.height_ft*t.temp,0),n=e.reduce((e,t)=>e+t.height_ft*t.height_ft,0),a=r*n-s*s;if(Math.abs(a)<1e-6){const e=o/r;return{value:Math.round(10*e)/10}}const l=(r*i-s*o)/a,c=l*t+(o-l*s)/r;return{value:Math.round(10*c)/10,gradient:Math.round(100*l)/100}}(o,s);return{reference_height_ft:s,point_count:o.length,simple_average:i,estimated_at_reference:n,gradient_per_ft:a}}const be=["deye","sunsynk","sol-ark","battery","oven","cavity","inverter","outdoor","outside","exterior","sensorlinx","ubiquiti","unifi","udm","usg","usw","uap","uxg","udr","unvr","unifi_","dream machine","dream router","ultra switch","ap ","ap_backyard","ap_","xgs","_poe","port_","clients","wlan","speedtest","wan ","lan ","firmware","device tracker","poe temperature","switch temperature","cpu","memory","utilization","uptime","signal level","cloud connection","access point","printer","toner","cartridge"," ink","officejet","laserjet","envy","deskjet","tankless","water heater","hot water","inlet temp","outlet temp","weather","tempest","weatherflow","wet bulb","dew point","feels like","heat index","wind chill","wind speed","wind gust","wind bearing","wind direction","barometric","sea level pressure","air density","solar radiation","uv index","lightning","precipitation","rain rate","rain accumulation","visibility","cloud base","beaufort"],ve=["outlet","plug","switch","hallway","flex","unifi","usw","uap","udm","signal level","cloud connection","network","uptime","cpu","memory","mac","energy","power","voltage","current","consumption","co2","voc","aqi","auto-off","auto-update","led","overheated","smooth on","smooth off"],xe=[{name:"Main Floor",zones:["Laundry","Living Room","Main Area","Main Office","Redmond Thermostat"],room_sensors:["Family Room","Kitchen","Hallway","Stairs","Entryway","Primary Bath","Primary Bedroom"]},{name:"Upper Floor",zones:[],room_sensors:["Hunters","Sydney","Upstair Office","Upstairs Office"]}],ye={office:"Main Floor","Main Office":"Main Floor",upstairs_office:"Upper Floor",upstairs_hallway:"Upper Floor",hunters_room:"Upper Floor",sidney_s_room:"Upper Floor","Upstairs Office":"Upper Floor","Upstairs Hallway":"Upper Floor","Hunters Room":"Upper Floor","Sidney's Room":"Upper Floor"},ze={};function we(e,t){const r=Ce(e),s=Ce(t);if(r===s)return!0;const o=r.split(" "),i=s.split(" ");return o[0]===i[0]&&o.length>1&&i.length>1&&"main"===o[0]?o.slice(1).join(" ")===i.slice(1).join(" "):r.includes(s)||s.includes(r)}function ke(e){const t=e.areas;return t?Object.entries(t).map(([e,t])=>({area_id:e,name:t.name??e})).filter(e=>!["weather","whole_house_energy"].includes(e.area_id)).sort((e,t)=>e.name.localeCompare(t.name)):[]}function Ee(e){return(e.floors??xe).map(e=>e.name)}function Se(e,t,r){const s=function(e){return{...ye,...e.area_floor_map??{}}}(r);return e&&s[e]?s[e]:t&&s[t]?s[t]:void 0}function We(e,t,r=t.floors??xe){const s=function(e){return{...ze,...e.zone_floors??{}}}(t);if(s[e.climate_entity])return s[e.climate_entity];for(const t of r)if(t.zones?.some(t=>we(e.name,t)))return t.name;const o=Se(e.area_id,e.area,t);return o||(e.floor?e.floor:Qe(e.name,e.area,r))}function Re(e){const t=e.trim().split(/\s+/);if(t.length>=2&&t.length%2==0){const e=t.length/2;if(t.slice(0,e).join(" ")===t.slice(e).join(" "))return t.slice(0,e).join(" ")}return e}function Ce(e){return e.toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Ze(e){return e.attributes.friendly_name??e.entity_id}function Ne(e,t){const r=e.entities?.[t];if(r?.area_id)return r.area_id;const s=r?.device_id;if(s){const t=e.devices?.[s]?.area_id;if(t)return t}}function Ie(e,t){if(!t)return;const r=e.areas;return r?.[t]?.name}function Oe(e){if(!e||"unavailable"===e.state||"unknown"===e.state)return;const t=parseFloat(e.state);return isNaN(t)?void 0:Math.round(10*t)/10}function Pe(e,t){if(t)return e.states[t]}function je(e){const t=new Set(e.exclude_entities??[]);for(const r of e.sensor_assignments??[])r.hidden&&t.add(r.entity_id);return t}function Ve(e){const t=new Map(Object.entries(e.sensor_map??{}));for(const r of e.sensor_assignments??[])r.zone&&!r.hidden&&t.set(r.entity_id,r.zone);return t}function Me(e,t,r=[]){const s=`${Ce(e)} ${Ce(t)}`;return[...be,...r].some(e=>s.includes(Ce(e)))}function qe(e){const t=e.replace(/^climate\./,""),r=t.split("_");if(r.length>=2&&r.length%2==0){const e=r.length/2,t=r.slice(0,e).join("_");if(t===r.slice(e).join("_"))return t}return t}function He(e,t,r){if(r.has(e))return!0;const s=Ce(t);return s.includes("current temperature")&&s.includes("thermostat")}function Xe(e){const t=e.attributes.device_class;if("temperature"===t||"humidity"===t)return!0;const r=e.attributes.state_class,s=e.attributes.unit_of_measurement;if("measurement"===r&&s){if("%"===s)return!0;if(/°|deg/i.test(s))return!0}return!1}function Fe(e,t,r,s){return function(e,t,r){const s=`${Ce(e)} ${Ce(t)}`;return r.some(e=>s.includes(Ce(e)))}(e,t,s)?"other":"temperature"===r||"humidity"===r?"room":"other"}function Te(e,t,r,s){const o=Ce(e),i=Ce(r),n=Ce(t),a=Ce(s);let l=0;return(o.includes(i)||n.includes(i.replace(/\s+/g,"_")))&&(l+=3),o.includes(a)&&(l+=4),"humidity"===a&&(e.includes("%")||t.includes("humidity"))&&(l+=2),l}function Le(e,t,r,s,o){const i=o?Ne(e,o):void 0;let n;for(const o of Object.values(e.states)){if(!o.entity_id.startsWith("sensor."))continue;if(o.attributes.device_class!==s)continue;const a=Ze(o);if(Me(a,o.entity_id))continue;let l=Te(a,o.entity_id,t,r);i&&Ne(e,o.entity_id)===i&&(l+=6),l>=5&&(!n||l>n.score)&&(n={id:o.entity_id,score:l})}return n?.id}function De(e,t){return{floor:t.floor_sensor??Le(e,t.name,"floor temperature","temperature",t.climate_entity),room:t.room_sensor??Le(e,t.name,"room temperature","temperature",t.climate_entity),humidity:t.humidity_sensor??Le(e,t.name,"humidity","humidity",t.climate_entity)}}function Je(e,t,r,s){const o=s?.zone_kinds?.[t.climate_entity];if(o)return o;if(null!=r.floor)return"floor_heat";if(Ce(t.name).includes("thermostat"))return"thermostat";const i=Pe(e,t.climate_entity);return(i?.attributes.hvac_modes??[]).includes("heat_cool")?"thermostat":"floor_heat"}function Qe(e,t,r){const s=Ce(`${e} ${t??""}`);for(const e of r){const t=e.zones?.some(e=>s.includes(Ce(e))),r=e.room_sensors?.some(e=>s.includes(Ce(e)));if(t||r)return e.name}return/hunter|sydney|upstair/.test(s)?"Upper Floor":"Main Floor"}function Be(e,t){let r=Re(e.replace(/\s+(temperature|humidity|temp)$/i,""));const s=`${Ce(e)} ${Ce(t)}`;if(s.includes("outdoor reset")){const t=e.match(/:\s*(.+)$/);return t?`Outdoor reset target (${t[1].trim()})`:"Outdoor reset target"}return s.includes("ecobee")&&s.includes("remote")&&(r=r.replace(/\s*ecobee\s*/i," ").trim(),/remote/i.test(r)||(r=`${r} (Remote)`)),r}function Ge(e,t,r,s){const o=Pe(e,t);if(!o)return;const i=o.attributes.device_class,n=Ze(o),a=Be(n,t),l=o.attributes.unit_of_measurement??("humidity"===i?"%":"°"),c=Fe(n,t,i,r),d=/floor/i.test(n)||/floor/i.test(t),p=Ne(e,t);return{name:a,entity_id:t,area:Ie(e,p),area_id:p,value:Oe(o),unit:l,kind:c,height_ft:me(t,s,{isFloor:d,isRoom:"room"===c&&!d})}}function Ke(e,t,r){if(t.room_sensors?.length)return[...t.room_sensors];const s=function(e,t,r){const s=new Set;for(const e of t.zones??[])e.floor_sensor&&s.add(e.floor_sensor),e.room_sensor&&s.add(e.room_sensor),e.humidity_sensor&&s.add(e.humidity_sensor);for(const o of r){const r=t.zones?.find(e=>e.climate_entity===o.climate_entity)??{name:o.name,climate_entity:o.climate_entity};for(const t of[r.floor_sensor??Le(e,o.name,"floor temperature","temperature",o.climate_entity),r.room_sensor??Le(e,o.name,"room temperature","temperature",o.climate_entity),r.humidity_sensor??Le(e,o.name,"humidity","humidity",o.climate_entity)])t&&s.add(t)}return s}(e,t,r),o=function(e){const t=new Set;for(const r of Object.values(e.states)){if(!r.entity_id.startsWith("climate."))continue;const e=qe(r.entity_id);t.add(`sensor.${e}_floor_temperature`),t.add(`sensor.${e}_room_temperature`)}return t}(e),i=[];for(const t of Object.values(e.states)){if(!t.entity_id.startsWith("sensor."))continue;if(!Xe(t))continue;if(s.has(t.entity_id))continue;const e=Ze(t);Me(e,t.entity_id)||(He(t.entity_id,e,o)||i.push(t.entity_id))}for(const e of Ve(t).keys())i.includes(e)||i.push(e);return i.sort()}function Ue(e,t){if(e.area_id){const r=t.find(t=>t.area_id&&t.area_id===e.area_id);if(r)return r}const r=t.find(t=>function(e,t){return!(!e||!t)&&Ce(e)===Ce(t)}(e.area,t.area));return r||t.find(t=>function(e,t){const r=Ce(e),s=Ce(t.name);return r.includes(s)||s.includes(r)}(e.name,t))}function Ye(e,t,r){const s=Ve(r).get(e.entity_id);return s?function(e,t){return t.find(t=>t.climate_entity===e||Ce(t.name)===Ce(e)||Ce(t.climate_entity)===Ce(e))}(s,t):Ue(e,t)}function _e(e,t){const r=t.zones?.length?t.zones:t.auto_discover?function(e){return Object.values(e.states).filter(e=>e.entity_id.startsWith("climate.")).map(t=>{const r=t.attributes.friendly_name??t.entity_id.replace("climate.","").replace(/_/g," "),s=Ne(e,t.entity_id);return{name:Re(r),climate_entity:t.entity_id,area:Ie(e,s),area_id:s}}).sort((e,t)=>e.name.localeCompare(t.name))}(e):[];return r.map(r=>{const s=function(e,t){const r=De(e,t)??{},s=Pe(e,r.floor),o=Pe(e,r.room),i=Pe(e,r.humidity);return{floor:Oe(s),room:Oe(o),humidity:Oe(i)}}(e,r),o=r.area_id??Ne(e,r.climate_entity),i=r.area??Ie(e,o),n=De(e,r),a=function(e,t,r){const s=qe(t),o=s.split("_").filter(e=>e.length>2),i=Ce(s.replace(/_/g," ")),n=e.states;if(r?.valve_entity){const e=n[r.valve_entity];if(e){const t=parseFloat(e.state);if(!isNaN(t))return{entity_id:r.valve_entity,position:t,active:t>0};const s="on"===e.state;return{entity_id:r.valve_entity,position:s?100:0,active:s}}}for(const[e,t]of Object.entries(n))if(e.includes(s)&&e.includes("valve")){if(e.startsWith("number.")||e.startsWith("sensor.")){const r=parseFloat(t.state);return{entity_id:e,position:isNaN(r)?void 0:r,active:!isNaN(r)&&r>0}}if(e.startsWith("switch.")||e.startsWith("binary_sensor.")){const r="on"===t.state;return{entity_id:e,position:r?100:0,active:r}}}for(const[e,t]of Object.entries(n)){if(!e.startsWith("switch.")||!e.includes("floor_control_mode"))continue;const r=e.split("floor_control_mode_").pop()??"",o=Ce(r.replace(/_/g," "));if(o!==i&&Ce(r)!==Ce(s)&&o!==Ce(s.replace(/_/g," ")))continue;const n="on"===t.state;return{entity_id:e,position:n?100:0,active:n}}const a=Object.entries(n).filter(([e])=>e.startsWith("binary_sensor.")&&e.includes("redawghome_zone"));if(a.length){const e=n[t],r=Ce(e?.attributes?.friendly_name??"").replace(/thm|climate|thermostat/g,"").trim().split(/\s+/).filter(e=>e.length>2),s=Object.entries(n).filter(([e])=>e.startsWith("number.")&&e.includes("valve_count")).map(([e,t])=>({eid:e,state:t,idNorm:Ce(e)})).sort((e,t)=>e.idNorm.localeCompare(t.idNorm));let l,c=0;for(const e of s){const t=parseFloat(e.state.state),s=e.idNorm.includes(i)||o.every(t=>e.idNorm.includes(Ce(t))),n=r.some(t=>e.idNorm.includes(t));if(s||n){!isNaN(t)&&t>0&&(l=t);break}!isNaN(t)&&t>0&&(c+=t)}const d=a.map(([e,t])=>{const r=parseInt(e.match(/zone_(\d+)/)?.[1]??"",10);return{eid:e,state:t,zoneNum:r}}).filter(e=>!isNaN(e.zoneNum)).sort((e,t)=>e.zoneNum-t.zoneNum),p=null!=l&&l>0?d.slice(c,c+l):d.filter(({eid:e})=>{const t=Ce(e);return o.some(e=>t.includes(Ce(e)))});if(p.length){const e=p.some(({state:e})=>"on"===e.state);return{entity_id:(p.find(({state:e})=>"on"===e.state)??p[0]).eid,position:e?100:0,active:e}}}const l=Ne(e,t);if(l)for(const[t,r]of Object.entries(n)){if(!t.startsWith("binary_sensor."))continue;const s=r.attributes,o=s.device_class;if("running"!==o&&"heat"!==o)continue;const i=s.icon,n=i?.includes("valve")||i?.includes("pipe"),a=`${s.friendly_name??""} ${t}`.toLowerCase();if((n||a.includes("valve")||a.includes("relay")||a.includes("zone")||t.includes("redawghome_zone"))&&Ne(e,t)===l){const e="on"===r.state;return{entity_id:t,position:e?100:0,active:e}}}const c=n[t],d=Ce(c?.attributes?.friendly_name??"");if(d)for(const[e,t]of Object.entries(n)){if(!e.startsWith("binary_sensor."))continue;const r=t.attributes,s=r.device_class;if("running"!==s&&"heat"!==s)continue;const o=Ce(r.friendly_name??""),i=d.replace(/thm|climate|thermostat/g,"").trim().split(/\s+/).filter(e=>e.length>2);if(i.some(e=>o.includes(e))){const r="on"===t.state;return{entity_id:e,position:r?100:0,active:r}}}return{}}(e,r.climate_entity,r);return{name:r.name,climate_entity:r.climate_entity,area:i,area_id:o,floor:r.floor,kind:Je(e,r,s,t),sensors:s,roomSensors:[],otherSensors:[],linked_sensor_ids:n,valve_entity:a.entity_id,valve_position:a.position,valve_active:a.active}})}function $e(e,t){const r=t.floors??xe,s=_e(e,t),{zones:o,unassigned:i}=function(e,t,r){if(!1===t.show_room_sensors)return{zones:r,unassigned:[]};const s=je(t),o=t.other_sensor_patterns??ve,i=[],n=r.map(e=>({...e,roomSensors:[],otherSensors:[]}));for(const a of Ke(e,t,r)){if(s.has(a))continue;const r=Ge(e,a,o,t);if(!r||null==r.value)continue;const l=Ye(r,n,t);if(!l){i.push(r);continue}const c=n.find(e=>e.climate_entity===l.climate_entity);"other"===r.kind?c.otherSensors.push(r):c.roomSensors.push(r)}for(const e of n)e.roomSensors.sort((e,t)=>e.name.localeCompare(t.name)),e.otherSensors.sort((e,t)=>e.name.localeCompare(t.name));return i.sort((e,t)=>e.name.localeCompare(t.name)),{zones:n,unassigned:i}}(e,t,s);if(!(!1!==t.group_by_floor))return[{name:"Climate Zones",zones:o,unassignedSensors:i}];const n=new Map;for(const e of r)n.set(e.name,{name:e.name,zones:[],unassignedSensors:[]});const a={name:"Other",zones:[],unassignedSensors:[]},l=e=>We(e,t,r);for(const e of o){const t=l(e),r=n.get(t);r?r.zones.push(e):a.zones.push(e)}for(const e of i){const s=Se(e.area_id,e.area,t)??Qe(e.name,e.area,r),o=n.get(s);o?o.unassignedSensors.push(e):a.unassignedSensors.push(e)}const c=r.map(e=>n.get(e.name)).filter(e=>e.zones.length||e.unassignedSensors.length);return(a.zones.length||a.unassignedSensors.length)&&c.push(a),c}const et=["supply","return","flow","manifold","boiler","water_temp","pump","optimal","inlet","outlet","water heater","tankless","hot water"],tt=["supply","supply temp","supply water","supply temperature","outlet","outlet temp","hot water","outgoing"],rt=["return","return temp","return water","return temperature","inlet","inlet temp","cold water","incoming"],st=["flow rate","flow","water flow"],ot=["pump","boiler","circulator","manifold pump"];function it(e,t){const r=`${Ce(e)} ${Ce(t)}`;return et.some(e=>r.includes(Ce(e)))}function nt(e,t,r){const s=`${Ce(e)} ${Ce(t)}`;return r.some(e=>s.includes(Ce(e)))}function at(e,t){const r=Pe(e,t);if(!r)return;const s=Oe(r);if(null==s)return;return{entity_id:t,value:s,unit:r.attributes.unit_of_measurement??("humidity"===r.attributes.device_class?"%":"°")}}function lt(e,t,r){const s=`${Ce(t)} ${Ce(r)}`,o=s.includes("inlet"),i=s.includes("outlet");let n=0;return"supply"===e?(i&&(n+=10),o&&!i&&(n-=12),(r.includes("outlet_temp")||r.endsWith("outlet_temperature"))&&(n+=6)):(o&&(n+=10),i&&!o&&(n-=12),(r.includes("inlet_temp")||r.endsWith("inlet_temperature"))&&(n+=6)),n}function ct(e,t){const r=t.floor_system;if(!1===r)return null;const s=r||{auto_discover:!0},o=s.supply_temp||s.return_temp||s.flow_rate||s.pump_status||(s.extra_sensors?.length??0)>0,i=s.auto_discover||!o,n=new Set,a={},l=(t,r)=>t||(i?function(e,t,r){const s={supply:tt,return:rt,flow:st,pump:ot}[t];let o;for(const i of Object.values(e.states)){if(r.has(i.entity_id))continue;const e=Ze(i);if(!it(e,i.entity_id))continue;if("pump"===t){if(!i.entity_id.startsWith("binary_sensor.")&&!i.entity_id.startsWith("switch."))continue}else if(!i.entity_id.startsWith("sensor."))continue;if(!nt(e,i.entity_id,s))continue;let n=0;(Ce(e).includes("optimal")||Ce(i.entity_id).includes("optimal"))&&(n+=2),"supply"!==t&&"return"!==t||(n+=lt(t,e,i.entity_id)),"supply"===t&&Ce(e).includes("supply")&&(n+=2),"return"===t&&Ce(e).includes("return")&&(n+=2),"flow"===t&&Ce(e).includes("flow")&&(n+=4),"pump"===t&&(Ce(e).includes("pump")||Ce(e).includes("boiler")||Ce(e).includes("heating"))&&(n+=4),n<0||(!o||n>o.score)&&(o={id:i.entity_id,score:n})}return o?.id}(e,r,n):void 0),c=l(s.supply_temp,"supply");c&&(n.add(c),a.supply_temp=at(e,c));const d=l(s.return_temp,"return");d&&(n.add(d),a.return_temp=at(e,d)),null!=a.supply_temp?.value&&null!=a.return_temp?.value&&(a.delta_t=Math.round(10*(a.supply_temp.value-a.return_temp.value))/10);const p=l(s.flow_rate,"flow");p&&(n.add(p),a.flow_rate=at(e,p));const u=l(s.pump_status,"pump");if(u){n.add(u);const t=Pe(e,u);t&&(a.pump_entity=u,a.pump_active=function(e){const t=e.state;return"unavailable"!==t&&"unknown"!==t&&(e.entity_id.startsWith("binary_sensor.")||e.entity_id.startsWith("switch.")?"on"===t:"on"===t||"running"===t||"heat"===t||"heating"===t)}(t))}const A=Object.values(e.states).find(e=>e.entity_id.startsWith("water_heater."));if(A){a.heater_entity=A.entity_id;const e=A.attributes.temperature;null!=e&&(a.set_temp=e,a.set_temp_unit=A.attributes.unit_of_measurement??A.attributes.temperature_unit??"°")}const h=s.extra_sensors??[],f=[];for(const t of h){if(n.has(t))continue;const r=Pe(e,t);if(!r)continue;const s=Oe(r);if(null==s)continue;const o=Be(Ze(r),t),i=r.attributes.unit_of_measurement??("humidity"===r.attributes.device_class?"%":"");f.push({entity_id:t,name:o,value:s,unit:i}),n.add(t)}f.length&&(a.extra=f);return a.supply_temp||a.return_temp||a.flow_rate||a.pump_entity||(a.extra?.length??0)>0?a:null}let dt=class extends ae{setConfig(e){this._config={auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e}}_valueChanged(e,t){const r=new CustomEvent("config-changed",{detail:{config:{...this._config,[e]:t}}});this.dispatchEvent(r)}_zoneChanged(e,t,r){const s=[...this._config.zones??[]];s[e]={...s[e],[t]:r},this._valueChanged("zones",s),this._valueChanged("auto_discover",!1)}_addZone(){const e=[...this._config.zones??[],{name:"New Zone",climate_entity:""}];this._valueChanged("zones",e),this._valueChanged("auto_discover",!1)}_removeZone(e){const t=(this._config.zones??[]).filter((t,r)=>r!==e);this._valueChanged("zones",t)}_sensorAssignmentChanged(e,t){const r={...this._config.sensor_map??{}},s=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(s.add(e),delete r[e]):"__auto__"===t?(s.delete(e),delete r[e]):(s.delete(e),r[e]=t),this._valueChanged("sensor_map",r),this._valueChanged("exclude_entities",[...s])}_climateEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("climate."))}_sensorEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("sensor."))}_zoneOptions(){return _e(this.hass,this._config).map(e=>({id:e.climate_entity,name:`${e.name}${e.area?` (${e.area})`:""}`}))}_sensorHeightChanged(e,t){const r={...this._config.sensor_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];this._valueChanged("sensor_heights",r)}_referenceHeightChanged(e){const t=parseFloat(e);Number.isNaN(t)||t<0||this._valueChanged("reference_height_ft",t)}_zoneFloorChanged(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t,this._valueChanged("zone_floors",r)}render(){if(!this.hass)return L``;const e=function(e,t){const r=_e(e,t),s=je(t),o=Ve(t),i=t.other_sensor_patterns??ve;return Ke(e,t,r).map(n=>{const a=Ge(e,n,i,t),l=o.get(n),c=a?Ue(a,r):void 0;return{entity_id:n,name:a?.name??n,area:a?.area,area_id:a?.area_id,value:a?.value,unit:a?.unit,kind:a?.kind??"other",assigned_zone:l,auto_zone:c?.climate_entity,auto_zone_name:c?.name,hidden:s.has(n),height_ft:a?.height_ft}})}(this.hass,this._config),t=_e(this.hass,this._config),r=ke(this.hass),s=Ee(this._config);return L`
    ...
    `:null}renderHeightBadge(e){return null==e?null:L`<span class="height-badge">${e} ft</span>`}renderZoneHeightStats(e,t){const r=ge(e,this._config,t);return r?L`
    ...
    `}tempToColor(e){if(null==e)return"#64b5f6";const t=(Math.max(50,Math.min(140,e))-50)/90;if(t<.33){return`rgb(${Math.round(30+3*t*70)},${Math.round(130+3*t*70)},${Math.round(245-3*t*50)})`}if(t<.66){const e=(t-.33)/.33;return`rgb(${Math.round(100+155*e)},${Math.round(200-50*e)},${Math.round(195-145*e)})`}{const e=(t-.66)/.34;return`rgb(${Math.round(255)},${Math.round(150-80*e)},${Math.round(50-30*e)})`}}renderFloorSystem(){const e=this.floorSystem;if(!e)return null;const t=e.return_temp?.value,r=e.supply_temp?.value,s=this.tempToColor(t),o=this.tempToColor(r),i=e.return_temp?.unit??"°",n=e.supply_temp?.unit??"°",a=this._config.floor_system,l=!1!==a&&a?.heater_image?.trim()?a.heater_image.trim():void 0,c=100,d=38,p=200,u=92,A=14,h=125,f=275;return L`
      <div class="floor-system tankless-visual">
        <svg class="tankless-svg" viewBox="0 0 400 180" preserveAspectRatio="xMidYMid meet">
          ...
          <path d="M 0,${145} L ${103},${145} Q ${h},${145} ${h},${132} L ${h},${137}"
          ...
          <path d="M 400,${145} L ${297},${145} Q ${f},${145} ${f},${132} L ${f},${137}"
            fill="none" stroke="rgba(200,200,210,0.35)" stroke-width="${A}" stroke-linecap="round"/>
          <path d="M 400,${145} L ${297},${145} Q ${f},${145} ${f},${132} L ${f},${137}"
            fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="${12}" stroke-linecap="round"/>
          <path d="M 397,${145} L ${297},${145} Q ${f},${145} ${f},${132} L ${f},${138}"
            fill="none" stroke="url(#inletFlow)" stroke-width="${10}" stroke-linecap="round"/>
          <!-- Glass highlight on horizontal section -->
          <path d="M ${301},${140} L 394,${140}"
            fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="2" stroke-linecap="round"/>
    ...
    `}renderSensorAssign(e){if(!this._editSensors)return null;const t=this._config.sensor_map?.[e.entity_id]??(this._config.exclude_entities?.includes(e.entity_id)?"__hidden__":"__auto__"),r=Ue(e,this.zoneOptions),s=e.area?`Auto (HA: ${e.area}${r?` → ${r.name}`:""})`:r?`Auto (→ ${r.name})`:"Auto (by HA area)";return L`
      <select
