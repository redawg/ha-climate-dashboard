      ...
      <div class="weather-strip">
        ...
        ${e.forecast?.length?T`
              <div class="weather-forecast">
                ${e.forecast.map(e=>{const t=new Date(e.datetime).toLocaleTimeString("en-US",{hour:"numeric",hour12:!0});return T`
