...
`;function be(e,t,r){const s=t.sensor_heights?.[e];return null==s||Number.isNaN(s)?r?.isFloor?0:r?.isRoom?5:void 0:s}function ve(e,t,r){const s=t.reference_height_ft??5,o=function(e,t,r){const s=[],o=t.sensor_heights??{},n=t.zone_heights??{},i=(e,r,n,i)=>{if(null==r)return;const a=(n?o[n]:void 0)??be(n??"",t,i);null!=a&&s.push({label:e,temp:r,height_ft:a})};if(null!=e.sensors.floor&&i("Floor",e.sensors.floor,e.linked_sensor_ids?.floor,{isFloor:!0}),null!=e.sensors.room&&i("Room",e.sensors.room,e.linked_sensor_ids?.room,{isRoom:!0}),null!=r){const o=n[e.climate_entity]??t.reference_height_ft??5;s.push({label:"Thermostat",temp:r,height_ft:o})}for(const t of e.roomSensors)null!=t.value&&null!=t.height_ft&&s.push({label:t.name,temp:t.value,height_ft:t.height_ft});return s}(e,t,r);if(!o.length)return null;const n=Math.round(o.reduce((e,t)=>e+t.temp,0)/o.length*10)/10,{value:i,gradient:a}=function(e,t){if(!e.length)return{};if(1===e.length)return{value:e[0].temp};const r=e.length,s=e.reduce((e,t)=>e+t.height_ft,0),o=e.reduce((e,t)=>e+t.temp,0),n=e.reduce((e,t)=>e+t.height_ft*t.temp,0),i=e.reduce((e,t)=>e+t.height_ft*t.height_ft,0),a=r*i-s*s;if(Math.abs(a)<1e-6){const e=o/r;return{value:Math.round(10*e)/10}}const A=(r*n-s*o)/a,l=A*t+(o-A*s)/r;return{value:Math.round(10*l)/10,gradient:Math.round(100*A)/100}}(o,s);return{reference_height_ft:s,point_count:o.length,simple_average:n,estimated_at_reference:i,gradient_per_ft:a}}const xe=["deye","sunsynk","sol-ark","battery","oven","cavity","inverter","weather","tempest","wet bulb","dew point","feels like"],ze=["outlet","plug","switch","hallway","flex","unifi","usw","uap","udm","signal level","cloud connection","network","uptime","cpu","memory","mac","energy","power","voltage","current","consumption","co2","voc","aqi","auto-off","auto-update","led","overheated","smooth on","smooth off"],ye=[{name:"Main Floor",zones:["Laundry","Living Room","Main Area","Main Office","Redmond Thermostat"],room_sensors:["Family Room","Kitchen","Hallway","Stairs","Entryway","Primary Bath","Primary Bedroom"]},{name:"Upper Floor",zones:[],room_sensors:["Hunters","Sydney","Upstair Office","Upstairs Office"]}],Ee={office:"Main Floor","Main Office":"Main Floor",upstairs_office:"Upper Floor",upstairs_hallway:"Upper Floor",hunters_room:"Upper Floor",sidney_s_room:"Upper Floor","Upstairs Office":"Upper Floor","Upstairs Hallway":"Upper Floor","Hunters Room":"Upper Floor","Sidney's Room":"Upper Floor"},ke={};function We(e,t){const r=Ie(e),s=Ie(t);if(r===s)return!0;const o=r.split(" "),n=s.split(" ");return o[0]===n[0]&&o.length>1&&n.length>1&&"main"===o[0]?o.slice(1).join(" ")===n.slice(1).join(" "):r.includes(s)||s.includes(r)}function we(e){const t=e.areas;return t?Object.entries(t).map(([e,t])=>({area_id:e,name:t.name??e})).filter(e=>!["weather","whole_house_energy"].includes(e.area_id)).sort((e,t)=>e.name.localeCompare(t.name)):[]}function Se(e){return(e.floors??ye).map(e=>e.name)}function Re(e,t,r){const s=function(e){return{...Ee,...e.area_floor_map??{}}}(r);return e&&s[e]?s[e]:t&&s[t]?s[t]:void 0}function Ze(e,t,r=t.floors??ye){const s=function(e){return{...ke,...e.zone_floors??{}}}(t);if(s[e.climate_entity])return s[e.climate_entity];for(const t of r)if(t.zones?.some(t=>We(e.name,t)))return t.name;const o=Re(e.area_id,e.area,t);return o||(e.floor?e.floor:Qe(e.name,e.area,r))}function Ce(e){const t=e.trim().split(/\s+/);if(t.length>=2&&t.length%2==0){const e=t.length/2;if(t.slice(0,e).join(" ")===t.slice(e).join(" "))return t.slice(0,e).join(" ")}return e}function Ie(e){return e.toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Pe(e){return e.attributes.friendly_name??e.entity_id}function Ve(e,t){const r=e.entities?.[t];if(r?.area_id)return r.area_id;const s=r?.device_id;if(s){const t=e.devices?.[s]?.area_id;if(t)return t}}function Ne(e,t){if(!t)return;const r=e.areas;return r?.[t]?.name}function je(e){if(!e||"unavailable"===e.state||"unknown"===e.state)return;const t=parseFloat(e.state);return isNaN(t)?void 0:Math.round(10*t)/10}function Oe(e,t){if(t)return e.states[t]}function qe(e){const t=new Set(e.exclude_entities??[]);for(const r of e.sensor_assignments??[])r.hidden&&t.add(r.entity_id);return t}function He(e){const t=new Map(Object.entries(e.sensor_map??{}));for(const r of e.sensor_assignments??[])r.zone&&!r.hidden&&t.set(r.entity_id,r.zone);return t}function Xe(e,t,r=[]){const s=`${Ie(e)} ${Ie(t)}`;return[...xe,...r].some(e=>s.includes(Ie(e)))}function Me(e){const t=Ie(e);return t.includes("floor temperature")||t.includes("room temperature")||t.includes("current temperature")&&t.includes("thermostat")}function Te(e,t,r,s){return function(e,t,r){const s=`${Ie(e)} ${Ie(t)}`;return r.some(e=>s.includes(Ie(e)))}(e,t,s)?"other":"temperature"===r||"humidity"===r?"room":"other"}function Fe(e,t,r,s){const o=Ie(e),n=Ie(r),i=Ie(t),a=Ie(s);let A=0;return(o.includes(n)||i.includes(n.replace(/\s+/g,"_")))&&(A+=3),o.includes(a)&&(A+=4),"humidity"===a&&(e.includes("%")||t.includes("humidity"))&&(A+=2),A}function De(e,t,r,s,o){const n=o?Ve(e,o):void 0;let i;for(const o of Object.values(e.states)){if(!o.entity_id.startsWith("sensor."))continue;if(o.attributes.device_class!==s)continue;const a=Pe(o);if(Xe(a,o.entity_id))continue;let A=Fe(a,o.entity_id,t,r);n&&Ve(e,o.entity_id)===n&&(A+=6),A>=5&&(!i||A>i.score)&&(i={id:o.entity_id,score:A})}return i?.id}function Le(e,t){return{floor:t.floor_sensor??De(e,t.name,"floor temperature","temperature",t.climate_entity),room:t.room_sensor??De(e,t.name,"room temperature","temperature",t.climate_entity),humidity:t.humidity_sensor??De(e,t.name,"humidity","humidity",t.climate_entity)}}function Je(e,t,r){if(null!=r.floor)return"floor_heat";if(Ie(t.name).includes("thermostat"))return"thermostat";const s=Oe(e,t.climate_entity);return(s?.attributes.hvac_modes??[]).includes("heat_cool")?"thermostat":"floor_heat"}function Qe(e,t,r){const s=Ie(`${e} ${t??""}`);for(const e of r){const t=e.zones?.some(e=>s.includes(Ie(e))),r=e.room_sensors?.some(e=>s.includes(Ie(e)));if(t||r)return e.name}return/hunter|sydney|upstair/.test(s)?"Upper Floor":"Main Floor"}function Be(e,t,r,s){const o=Oe(e,t);if(!o)return;const n=o.attributes.device_class,i=Pe(o),a=Ce(i.replace(/\s+(temperature|humidity|temp)$/i,"")),A=o.attributes.unit_of_measurement??("humidity"===n?"%":"°"),l=Te(i,t,n,r),d=/floor/i.test(i)||/floor/i.test(t),c=Ve(e,t);return{name:a,entity_id:t,area:Ne(e,c),area_id:c,value:je(o),unit:A,kind:l,height_ft:be(t,s,{isFloor:d,isRoom:"room"===l&&!d})}}function Ge(e,t,r){if(t.room_sensors?.length)return[...t.room_sensors];const s=function(e,t,r){const s=new Set;for(const e of t.zones??[])e.floor_sensor&&s.add(e.floor_sensor),e.room_sensor&&s.add(e.room_sensor),e.humidity_sensor&&s.add(e.humidity_sensor);for(const o of r){const r=t.zones?.find(e=>e.climate_entity===o.climate_entity)??{name:o.name,climate_entity:o.climate_entity};for(const t of[r.floor_sensor??De(e,o.name,"floor temperature","temperature",o.climate_entity),r.room_sensor??De(e,o.name,"room temperature","temperature",o.climate_entity),r.humidity_sensor??De(e,o.name,"humidity","humidity",o.climate_entity)])t&&s.add(t)}return s}(e,t,r),o=[];for(const t of Object.values(e.states)){if(!t.entity_id.startsWith("sensor."))continue;const e=t.attributes.device_class;if("temperature"!==e&&"humidity"!==e)continue;if(s.has(t.entity_id))continue;const r=Pe(t);Xe(r,t.entity_id)||(Me(r)||o.push(t.entity_id))}for(const e of He(t).keys())o.includes(e)||o.push(e);return o.sort()}function Ke(e,t){if(e.area_id){const r=t.find(t=>t.area_id&&t.area_id===e.area_id);if(r)return r}const r=t.find(t=>function(e,t){return!(!e||!t)&&Ie(e)===Ie(t)}(e.area,t.area));return r||t.find(t=>function(e,t){const r=Ie(e),s=Ie(t.name);return r.includes(s)||s.includes(r)}(e.name,t))}function Ye(e,t,r){const s=He(r).get(e.entity_id);return s?function(e,t){return t.find(t=>t.climate_entity===e||Ie(t.name)===Ie(e)||Ie(t.climate_entity)===Ie(e))}(s,t):Ke(e,t)}function Ue(e,t){const r=t.zones?.length?t.zones:t.auto_discover?function(e){return Object.values(e.states).filter(e=>e.entity_id.startsWith("climate.")).map(t=>{const r=t.attributes.friendly_name??t.entity_id.replace("climate.","").replace(/_/g," "),s=Ve(e,t.entity_id);return{name:Ce(r),climate_entity:t.entity_id,area:Ne(e,s),area_id:s}}).sort((e,t)=>e.name.localeCompare(t.name))}(e):[];return r.map(t=>{const r=function(e,t){const r=Le(e,t),s=Oe(e,r.floor),o=Oe(e,r.room),n=Oe(e,r.humidity);return{floor:je(s),room:je(o),humidity:je(n)}}(e,t),s=t.area_id??Ve(e,t.climate_entity),o=t.area??Ne(e,s),n=Le(e,t);return{name:t.name,climate_entity:t.climate_entity,area:o,area_id:s,floor:t.floor,kind:Je(e,t,r),sensors:r,roomSensors:[],otherSensors:[],linked_sensor_ids:n}})}function _e(e,t){const r=t.floors??ye,s=Ue(e,t),{zones:o,unassigned:n}=function(e,t,r){if(!1===t.show_room_sensors)return{zones:r,unassigned:[]};const s=qe(t),o=t.other_sensor_patterns??ze,n=[],i=r.map(e=>({...e,roomSensors:[],otherSensors:[]}));for(const a of Ge(e,t,r)){if(s.has(a))continue;const r=Be(e,a,o,t);if(!r||null==r.value)continue;const A=Ye(r,i,t);if(!A){n.push(r);continue}const l=i.find(e=>e.climate_entity===A.climate_entity);"other"===r.kind?l.otherSensors.push(r):l.roomSensors.push(r)}for(const e of i)e.roomSensors.sort((e,t)=>e.name.localeCompare(t.name)),e.otherSensors.sort((e,t)=>e.name.localeCompare(t.name));return n.sort((e,t)=>e.name.localeCompare(t.name)),{zones:i,unassigned:n}}(e,t,s);if(!(!1!==t.group_by_floor))return[{name:"Climate Zones",zones:o,unassignedSensors:n}];const i=new Map;for(const e of r)i.set(e.name,{name:e.name,zones:[],unassignedSensors:[]});const a={name:"Other",zones:[],unassignedSensors:[]},A=e=>Ze(e,t,r);for(const e of o){const t=A(e),r=i.get(t);r?r.zones.push(e):a.zones.push(e)}for(const e of n){const s=Re(e.area_id,e.area,t)??Qe(e.name,e.area,r),o=i.get(s);o?o.unassignedSensors.push(e):a.unassignedSensors.push(e)}const l=r.map(e=>i.get(e.name)).filter(e=>e.zones.length||e.unassignedSensors.length);return(a.zones.length||a.unassignedSensors.length)&&l.push(a),l}let $e=class extends ae{setConfig(e){this._config={auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e}}_valueChanged(e,t){const r=new CustomEvent("config-changed",{detail:{config:{...this._config,[e]:t}}});this.dispatchEvent(r)}_zoneChanged(e,t,r){const s=[...this._config.zones??[]];s[e]={...s[e],[t]:r},this._valueChanged("zones",s),this._valueChanged("auto_discover",!1)}_addZone(){const e=[...this._config.zones??[],{name:"New Zone",climate_entity:""}];this._valueChanged("zones",e),this._valueChanged("auto_discover",!1)}_removeZone(e){const t=(this._config.zones??[]).filter((t,r)=>r!==e);this._valueChanged("zones",t)}_sensorAssignmentChanged(e,t){const r={...this._config.sensor_map??{}},s=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(s.add(e),delete r[e]):"__auto__"===t?(s.delete(e),delete r[e]):(s.delete(e),r[e]=t),this._valueChanged("sensor_map",r),this._valueChanged("exclude_entities",[...s])}_climateEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("climate."))}_sensorEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("sensor."))}_zoneOptions(){return Ue(this.hass,this._config).map(e=>({id:e.climate_entity,name:`${e.name}${e.area?` (${e.area})`:""}`}))}_sensorHeightChanged(e,t){const r={...this._config.sensor_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];this._valueChanged("sensor_heights",r)}_referenceHeightChanged(e){const t=parseFloat(e);Number.isNaN(t)||t<0||this._valueChanged("reference_height_ft",t)}_zoneFloorChanged(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t,this._valueChanged("zone_floors",r)}render(){if(!this.hass)return D``;const e=function(e,t){const r=Ue(e,t),s=qe(t),o=He(t),n=t.other_sensor_patterns??ze;return Ge(e,t,r).map(i=>{const a=Be(e,i,n,t),A=o.get(i),l=a?Ke(a,r):void 0;return{entity_id:i,name:a?.name??i,area:a?.area,area_id:a?.area_id,value:a?.value,unit:a?.unit,kind:a?.kind??"other",assigned_zone:A,auto_zone:l?.climate_entity,auto_zone_name:l?.name,hidden:s.has(i),height_ft:a?.height_ft}})}(this.hass,this._config),t=Ue(this.hass,this._config),r=we(this.hass),s=Se(this._config);return D`
      <div class="editor">
        <div class="field">
          <label>Title</label>
          <input
    ...
    `}};e([pe({attribute:!1})],$e.prototype,"hass",void 0),e([ue()],$e.prototype,"_config",void 0),$e=e([le("climate-command-center-editor")],$e);let et=class extends ae{constructor(){super(...arguments),this._expandedZone=null,this._editSensors=!1,this._view="floorplan",this._placingThermostat=null}static get styles(){return ge}setConfig(e){if(!e.zones?.length&&!e.auto_discover)throw new Error("Configure zones or enable auto_discover");this._config={title:"Climate Command Center",auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e,floors:e.floors?.length?e.floors:ye}}getCardSize(){return 6}get sections(){return _e(this.hass,this._config)}get weather(){return this._config.show_weather?function(e,t){const r=(t,r="temperature")=>Object.values(e.states).find(e=>{const s=Ie(Pe(e));return e.entity_id.startsWith("sensor.")&&e.attributes.device_class===r&&(s.includes("weather")||s.includes("tempest"))&&s.includes(Ie(t))})?.entity_id,s=Oe(e,t.weather_temperature??r("temperature")??Object.values(e.states).find(e=>{const t=Ie(Pe(e));return e.entity_id.startsWith("sensor.")&&"temperature"===e.attributes.device_class&&t.includes("weather station")&&t.includes("temperature")&&!t.includes("wet bulb")&&!t.includes("dew")&&!t.includes("feels")})?.entity_id);return s?{label:Pe(s).replace(/\s+(Temperature|Temp)$/i,"")||"Outside",temperature:je(s),humidity:je(Oe(e,t.weather_humidity??r("humidity","humidity"))),feels_like:je(Oe(e,t.weather_feels_like??Object.values(e.states).find(e=>Ie(Pe(e)).includes("feels like"))?.entity_id)),dew_point:je(Oe(e,t.weather_dew_point??Object.values(e.states).find(e=>Ie(Pe(e)).includes("dew point"))?.entity_id))}:null}(this.hass,this._config):null}get totalZones(){return this.sections.reduce((e,t)=>e+t.zones.length,0)}get zoneOptions(){return Ue(this.hass,this._config)}get haAreas(){return we(this.hass)}get floorOptions(){return Se(this._config)}async setEntityHaArea(e,t){const r=this.hass;r.callWS&&await r.callWS({type:"config/entity_registry/update",entity_id:e,area_id:t})}async updateSensorAssignment(e,t){if(t.startsWith("area:")){const r=t.slice(5);try{await this.setEntityHaArea(e,r)}catch(t){console.error("Failed to set HA area",e,r,t)}return void this.updateSensorMap(e,"__auto__")}this.updateSensorMap(e,t)}updateZoneFloor(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t;const s={...this._config,zone_floors:r};this._config=s,fe(this,"config-changed",{config:s})}async updateZoneHaArea(e,t){if(t)try{await this.setEntityHaArea(e,t)}catch(r){console.error("Failed to set zone HA area",e,t,r)}}callService(e,t,r){this.hass.callService(e,t,r)}setClimate(e,t){this.callService("climate","set_temperature",{entity_id:e,...t})}setHvacMode(e,t){this.callService("climate","set_hvac_mode",{entity_id:e,hvac_mode:t})}adjustSetpoint(e,t,r){const s=t??70;this.setClimate(e,{temperature:Math.round(s+r)})}toggleExpand(e){this._expandedZone=this._expandedZone===e?null:e}updateSensorMap(e,t){const r={...this._config.sensor_map??{}},s=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(s.add(e),delete r[e]):"__auto__"===t?(s.delete(e),delete r[e]):(s.delete(e),r[e]=t);const o={...this._config,sensor_map:r,exclude_entities:[...s]};this._config=o,fe(this,"config-changed",{config:o})}updateSensorHeight(e,t){const r={...this._config.sensor_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];const o={...this._config,sensor_heights:r};this._config=o,fe(this,"config-changed",{config:o})}updateZoneHeight(e,t){const r={...this._config.zone_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];const o={...this._config,zone_heights:r};this._config=o,fe(this,"config-changed",{config:o})}renderHeightEditor(e,t){return this._editSensors?D`
    ...
    `:D``}renderZone(e){const t=this.hass.states[e.climate_entity];if(!t)return D``;const r=t.attributes,s=r.current_temperature,o=r.temperature,n=r.humidity,i=r.hvac_action,a=t.state,A=this._expandedZone===e.climate_entity,l=e.sensors,d=r.hvac_modes??["heat","off"],c="floor_heat"===e.kind?d.filter(e=>"heat"===e||"off"===e):d;return D`
      <div class="zone-card ${A?"expanded":""} ${e.kind} ${this.modeClass(a)} ${this.actionClass(i)}">
        ...
        <div class="zone-temp-grid">
          ${null!=l.floor?D`
                <div class="temp-cell">
                  ...
                  <span class="temp-cell-value">${l.floor}\u00B0</span>
                </div>
              `:""}
          ${null!=l.room?D`
                <div class="temp-cell">
                  <span class="temp-cell-label">Room</span>
                  <span class="temp-cell-value">${l.room}\u00B0</span>
                </div>
              `:""}
          ${null!=s&&null==l.floor&&null==l.room?D`
                <div class="temp-cell">
          ...
          ${null!=n?D`
              ...
              `:null!=l.humidity?D`
                  <div class="temp-cell">
                    <span class="temp-cell-label">Humidity</span>
                    <span class="temp-cell-value">${l.humidity}%</span>
                  </div>
                `:""}
        </div>
