...
`;function ge(e,t,r){const s=t.sensor_heights?.[e];return null==s||Number.isNaN(s)?r?.isFloor?0:r?.isRoom?5:void 0:s}function be(e,t,r){const s=t.reference_height_ft??5,o=function(e,t,r){const s=[],o=t.sensor_heights??{},i=t.zone_heights??{},n=(e,r,i,n)=>{if(null==r)return;const a=(i?o[i]:void 0)??ge(i??"",t,n);null!=a&&s.push({label:e,temp:r,height_ft:a})};if(null!=e.sensors.floor&&n("Floor",e.sensors.floor,e.linked_sensor_ids?.floor,{isFloor:!0}),null!=e.sensors.room&&n("Room",e.sensors.room,e.linked_sensor_ids?.room,{isRoom:!0}),null!=r){const o=i[e.climate_entity]??t.reference_height_ft??5;s.push({label:"Thermostat",temp:r,height_ft:o})}for(const t of e.roomSensors)null!=t.value&&null!=t.height_ft&&s.push({label:t.name,temp:t.value,height_ft:t.height_ft});return s}(e,t,r);if(!o.length)return null;const i=Math.round(o.reduce((e,t)=>e+t.temp,0)/o.length*10)/10,{value:n,gradient:a}=function(e,t){if(!e.length)return{};if(1===e.length)return{value:e[0].temp};const r=e.length,s=e.reduce((e,t)=>e+t.height_ft,0),o=e.reduce((e,t)=>e+t.temp,0),i=e.reduce((e,t)=>e+t.height_ft*t.temp,0),n=e.reduce((e,t)=>e+t.height_ft*t.height_ft,0),a=r*n-s*s;if(Math.abs(a)<1e-6){const e=o/r;return{value:Math.round(10*e)/10}}const l=(r*i-s*o)/a,c=l*t+(o-l*s)/r;return{value:Math.round(10*c)/10,gradient:Math.round(100*l)/100}}(o,s);return{reference_height_ft:s,point_count:o.length,simple_average:i,estimated_at_reference:n,gradient_per_ft:a}}const ve=["deye","sunsynk","sol-ark","battery","oven","cavity","inverter","outdoor","outside","exterior","sensorlinx","ubiquiti","unifi","udm","usg","usw","uap","uxg","udr","unvr","unifi_","dream machine","dream router","ultra switch","ap ","ap_backyard","ap_","xgs","_poe","port_","clients","wlan","speedtest","wan ","lan ","firmware","device tracker","poe temperature","switch temperature","cpu","memory","utilization","uptime","signal level","cloud connection","access point","printer","toner","cartridge"," ink","officejet","laserjet","envy","deskjet","tankless","water heater","hot water","inlet temp","outlet temp","weather","tempest","weatherflow","wet bulb","dew point","feels like","heat index","wind chill","wind speed","wind gust","wind bearing","wind direction","barometric","sea level pressure","air density","solar radiation","uv index","lightning","precipitation","rain rate","rain accumulation","visibility","cloud base","beaufort"],ye=["outlet","plug","switch","hallway","flex","unifi","usw","uap","udm","signal level","cloud connection","network","uptime","cpu","memory","mac","energy","power","voltage","current","consumption","co2","voc","aqi","auto-off","auto-update","led","overheated","smooth on","smooth off"],xe=[{name:"Main Floor",zones:["Laundry","Living Room","Main Area","Main Office","Redmond Thermostat"],room_sensors:["Family Room","Kitchen","Hallway","Stairs","Entryway","Primary Bath","Primary Bedroom"]},{name:"Upper Floor",zones:[],room_sensors:["Hunters","Sydney","Upstair Office","Upstairs Office"]}],ze={office:"Main Floor","Main Office":"Main Floor",upstairs_office:"Upper Floor",upstairs_hallway:"Upper Floor",hunters_room:"Upper Floor",sidney_s_room:"Upper Floor","Upstairs Office":"Upper Floor","Upstairs Hallway":"Upper Floor","Hunters Room":"Upper Floor","Sidney's Room":"Upper Floor"},we={};function ke(e,t){const r=Ve(e),s=Ve(t);if(r===s)return!0;const o=r.split(" "),i=s.split(" ");return o[0]===i[0]&&o.length>1&&i.length>1&&"main"===o[0]?o.slice(1).join(" ")===i.slice(1).join(" "):r.includes(s)||s.includes(r)}function Se(e){const t=e.areas;return t?Object.entries(t).map(([e,t])=>({area_id:e,name:t.name??e})).filter(e=>!["weather","whole_house_energy"].includes(e.area_id)).sort((e,t)=>e.name.localeCompare(t.name)):[]}function Ee(e){return(e.floors??xe).map(e=>e.name)}function We(e,t,r){const s=function(e){return{...ze,...e.area_floor_map??{}}}(r);return e&&s[e]?s[e]:t&&s[t]?s[t]:void 0}function Ce(e,t,r=t.floors??xe){const s=function(e){return{...we,...e.zone_floors??{}}}(t);if(s[e.climate_entity])return s[e.climate_entity];for(const t of r)if(t.zones?.some(t=>ke(e.name,t)))return t.name;const o=We(e.area_id,e.area,t);return o||(e.floor?e.floor:Ye(e.name,e.area,r))}function Ne(e){const t=e.trim().split(/\s+/);if(t.length>=2&&t.length%2==0){const e=t.length/2;if(t.slice(0,e).join(" ")===t.slice(e).join(" "))return t.slice(0,e).join(" ")}return e}function Ve(e){return e.toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Re(e){return e.attributes.friendly_name??e.entity_id}function Ze(e,t){const r=e.entities?.[t];if(r?.area_id)return r.area_id;const s=r?.device_id;if(s){const t=e.devices?.[s]?.area_id;if(t)return t}}function qe(e,t){if(!t)return;const r=e.areas;return r?.[t]?.name}function Ie(e,t=1){if(!e||"unavailable"===e.state||"unknown"===e.state)return;const r=parseFloat(e.state);if(isNaN(r))return;const s=10**t;return Math.round(r*s)/s}function Oe(e,t){if(t)return e.states[t]}function Pe(e){const t=new Set(e.exclude_entities??[]);for(const r of e.sensor_assignments??[])r.hidden&&t.add(r.entity_id);return t}function Me(e){const t=new Map(Object.entries(e.sensor_map??{}));for(const r of e.sensor_assignments??[])r.zone&&!r.hidden&&t.set(r.entity_id,r.zone);return t}function je(e,t,r=[]){const s=`${Ve(e)} ${Ve(t)}`;return[...ve,...r].some(e=>s.includes(Ve(e)))}function Xe(e){const t=e.replace(/^climate\./,""),r=t.split("_");if(r.length>=2&&r.length%2==0){const e=r.length/2,t=r.slice(0,e).join("_");if(t===r.slice(e).join("_"))return t}return t}function He(e,t,r){if(r.has(e))return!0;const s=Ve(t);return s.includes("current temperature")&&s.includes("thermostat")}function Te(e){const t=e.attributes.device_class;if("temperature"===t||"humidity"===t)return!0;const r=e.attributes.state_class,s=e.attributes.unit_of_measurement;if("measurement"===r&&s){if("%"===s)return!0;if(/°|deg/i.test(s))return!0}return!1}function Fe(e,t,r,s){return function(e,t,r){const s=`${Ve(e)} ${Ve(t)}`;return r.some(e=>s.includes(Ve(e)))}(e,t,s)?"other":"temperature"===r||"humidity"===r?"room":"other"}function De(e,t,r,s){const o=Ve(e),i=Ve(r),n=Ve(t),a=Ve(s);let l=0;return(o.includes(i)||n.includes(i.replace(/\s+/g,"_")))&&(l+=3),o.includes(a)&&(l+=4),"humidity"===a&&(e.includes("%")||t.includes("humidity"))&&(l+=2),l}function Le(e,t,r,s,o){const i=o?Ze(e,o):void 0;let n;for(const o of Object.values(e.states)){if(!o.entity_id.startsWith("sensor."))continue;if(o.attributes.device_class!==s)continue;const a=Re(o);if(je(a,o.entity_id))continue;let l=De(a,o.entity_id,t,r);i&&Ze(e,o.entity_id)===i&&(l+=6),l>=5&&(!n||l>n.score)&&(n={id:o.entity_id,score:l})}return n?.id}function Ge(e,t){const r="on"===t;return{entity_id:e,position:r?100:0,active:r}}function Qe(e,t){const r=parseFloat(t);if(!isNaN(r))return{entity_id:e,position:r,active:r>0}}function Be(e,t){return{floor:t.floor_sensor??Le(e,t.name,"floor temperature","temperature",t.climate_entity),room:t.room_sensor??Le(e,t.name,"room temperature","temperature",t.climate_entity),humidity:t.humidity_sensor??Le(e,t.name,"humidity","humidity",t.climate_entity)}}function Je(e,t,r,s){const o=s?.zone_kinds?.[t.climate_entity];if(o)return o;if(null!=r.floor)return"floor_heat";if(Ve(t.name).includes("thermostat"))return"thermostat";const i=Oe(e,t.climate_entity);return(i?.attributes.hvac_modes??[]).includes("heat_cool")?"thermostat":"floor_heat"}function Ye(e,t,r){const s=Ve(`${e} ${t??""}`);for(const e of r){const t=e.zones?.some(e=>s.includes(Ve(e))),r=e.room_sensors?.some(e=>s.includes(Ve(e)));if(t||r)return e.name}return/hunter|sydney|upstair/.test(s)?"Upper Floor":"Main Floor"}function Ue(e,t){let r=Ne(e.replace(/\s+(temperature|humidity|temp)$/i,""));const s=`${Ve(e)} ${Ve(t)}`;if(s.includes("outdoor reset")){const t=e.match(/:\s*(.+)$/);return t?`Outdoor reset target (${t[1].trim()})`:"Outdoor reset target"}return s.includes("ecobee")&&s.includes("remote")&&(r=r.replace(/\s*ecobee\s*/i," ").trim(),/remote/i.test(r)||(r=`${r} (Remote)`)),r}function Ke(e,t,r,s){const o=Oe(e,t);if(!o)return;const i=o.attributes.device_class,n=Re(o),a=Ue(n,t),l=o.attributes.unit_of_measurement??("humidity"===i?"%":"°"),c=Fe(n,t,i,r),d=/floor/i.test(n)||/floor/i.test(t),p=Ze(e,t);return{name:a,entity_id:t,area:qe(e,p),area_id:p,value:Ie(o),unit:l,kind:c,height_ft:ge(t,s,{isFloor:d,isRoom:"room"===c&&!d})}}function _e(e,t,r){if(t.room_sensors?.length)return[...t.room_sensors];const s=function(e,t,r){const s=new Set;for(const e of t.zones??[])e.floor_sensor&&s.add(e.floor_sensor),e.room_sensor&&s.add(e.room_sensor),e.humidity_sensor&&s.add(e.humidity_sensor);for(const o of r){const r=t.zones?.find(e=>e.climate_entity===o.climate_entity)??{name:o.name,climate_entity:o.climate_entity};for(const t of[r.floor_sensor??Le(e,o.name,"floor temperature","temperature",o.climate_entity),r.room_sensor??Le(e,o.name,"room temperature","temperature",o.climate_entity),r.humidity_sensor??Le(e,o.name,"humidity","humidity",o.climate_entity)])t&&s.add(t)}return s}(e,t,r),o=function(e){const t=new Set;for(const r of Object.values(e.states)){if(!r.entity_id.startsWith("climate."))continue;const e=Xe(r.entity_id);t.add(`sensor.${e}_floor_temperature`),t.add(`sensor.${e}_room_temperature`)}return t}(e),i=[];for(const t of Object.values(e.states)){if(!t.entity_id.startsWith("sensor."))continue;if(!Te(t))continue;if(s.has(t.entity_id))continue;const e=Re(t);je(e,t.entity_id)||(He(t.entity_id,e,o)||i.push(t.entity_id))}for(const e of Me(t).keys())i.includes(e)||i.push(e);return i.sort()}function $e(e,t){if(e.area_id){const r=t.find(t=>t.area_id&&t.area_id===e.area_id);if(r)return r}const r=t.find(t=>function(e,t){return!(!e||!t)&&Ve(e)===Ve(t)}(e.area,t.area));return r||t.find(t=>function(e,t){const r=Ve(e),s=Ve(t.name);return r.includes(s)||s.includes(r)}(e.name,t))}function et(e,t,r){const s=Me(r).get(e.entity_id);return s?function(e,t){return t.find(t=>t.climate_entity===e||Ve(t.name)===Ve(e)||Ve(t.climate_entity)===Ve(e))}(s,t):$e(e,t)}function tt(e,t){const r=t.zones?.length?t.zones:t.auto_discover?function(e){return Object.values(e.states).filter(e=>e.entity_id.startsWith("climate.")).map(t=>{const r=t.attributes.friendly_name??t.entity_id.replace("climate.","").replace(/_/g," "),s=Ze(e,t.entity_id);return{name:Ne(r),climate_entity:t.entity_id,area:qe(e,s),area_id:s}}).sort((e,t)=>e.name.localeCompare(t.name))}(e):[];return r.map(r=>{const s=function(e,t){const r=Be(e,t)??{},s=Oe(e,r.floor),o=Oe(e,r.room),i=Oe(e,r.humidity);return{floor:Ie(s),room:Ie(o),humidity:Ie(i)}}(e,r),o=r.area_id??Ze(e,r.climate_entity),i=r.area??qe(e,o),n=Be(e,r),a=function(e,t,r){const s=Xe(t),o=s.split("_").filter(e=>e.length>2),i=Ve(s.replace(/_/g," ")),n=e.states;if(r?.valve_entity){const e=n[r.valve_entity];if(e){const t=Qe(r.valve_entity,e.state);return t?[t]:[Ge(r.valve_entity,e.state)]}}const a=[];for(const[e,t]of Object.entries(n))if(e.includes(s)&&e.includes("valve"))if(e.startsWith("number.")||e.startsWith("sensor.")){const r=Qe(e,t.state);r&&a.push(r)}else(e.startsWith("switch.")||e.startsWith("binary_sensor."))&&a.push(Ge(e,t.state));if(a.length)return a;for(const[e,t]of Object.entries(n)){if(!e.startsWith("switch.")||!e.includes("floor_control_mode"))continue;const r=e.split("floor_control_mode_").pop()??"",o=Ve(r.replace(/_/g," "));if(o===i||Ve(r)===Ve(s)||o===Ve(s.replace(/_/g," ")))return[Ge(e,t.state)]}const l=Object.entries(n).filter(([e])=>e.startsWith("binary_sensor.")&&e.includes("redawghome_zone"));if(l.length){const e=n[t],r=Ve(e?.attributes?.friendly_name??"").replace(/thm|climate|thermostat/g,"").trim().split(/\s+/).filter(e=>e.length>2),s=Object.entries(n).filter(([e])=>e.startsWith("number.")&&e.includes("valve_count")).map(([e,t])=>({eid:e,state:t,idNorm:Ve(e)})).sort((e,t)=>e.idNorm.localeCompare(t.idNorm));let a,c=0;for(const e of s){const t=parseFloat(e.state.state),s=e.idNorm.includes(i)||o.every(t=>e.idNorm.includes(Ve(t))),n=r.some(t=>e.idNorm.includes(t));if(s||n){!isNaN(t)&&t>0&&(a=t);break}!isNaN(t)&&t>0&&(c+=t)}const d=l.map(([e,t])=>{const r=parseInt(e.match(/zone_(\d+)/)?.[1]??"",10);return{eid:e,state:t,zoneNum:r}}).filter(e=>!isNaN(e.zoneNum)).sort((e,t)=>e.zoneNum-t.zoneNum),p=null!=a&&a>0?d.slice(c,c+a):d.filter(({eid:e})=>{const t=Ve(e);return o.some(e=>t.includes(Ve(e)))});if(p.length)return p.map(({eid:e,state:t})=>Ge(e,t.state))}const c=Ze(e,t);if(c){const t=[];for(const[r,s]of Object.entries(n)){if(!r.startsWith("binary_sensor."))continue;const o=s.attributes,i=o.device_class;if("running"!==i&&"heat"!==i)continue;const n=o.icon,a=n?.includes("valve")||n?.includes("pipe"),l=`${o.friendly_name??""} ${r}`.toLowerCase();(a||l.includes("valve")||l.includes("relay")||l.includes("zone")||r.includes("redawghome_zone"))&&(Ze(e,r)===c&&t.push(Ge(r,s.state)))}if(t.length)return t}const d=n[t],p=Ve(d?.attributes?.friendly_name??"");if(p){const e=[];for(const[t,r]of Object.entries(n)){if(!t.startsWith("binary_sensor."))continue;const s=r.attributes,o=s.device_class;if("running"!==o&&"heat"!==o)continue;const i=Ve(s.friendly_name??""),n=p.replace(/thm|climate|thermostat/g,"").trim().split(/\s+/).filter(e=>e.length>2);n.some(e=>i.includes(e))&&e.push(Ge(t,r.state))}if(e.length)return e}return[]}(e,r.climate_entity,r),l=a[0];return{name:r.name,climate_entity:r.climate_entity,area:i,area_id:o,floor:r.floor,kind:Je(e,r,s,t),sensors:s,roomSensors:[],otherSensors:[],linked_sensor_ids:n,valves:a.length?a:void 0,valve_entity:l?.entity_id,valve_position:l?.position,valve_active:l?.active}})}function rt(e,t){const r=t.floors??xe,s=tt(e,t),{zones:o,unassigned:i}=function(e,t,r){if(!1===t.show_room_sensors)return{zones:r,unassigned:[]};const s=Pe(t),o=t.other_sensor_patterns??ye,i=[],n=r.map(e=>({...e,roomSensors:[],otherSensors:[]}));for(const a of _e(e,t,r)){if(s.has(a))continue;const r=Ke(e,a,o,t);if(!r||null==r.value)continue;const l=et(r,n,t);if(!l){i.push(r);continue}const c=n.find(e=>e.climate_entity===l.climate_entity);"other"===r.kind?c.otherSensors.push(r):c.roomSensors.push(r)}for(const e of n)e.roomSensors.sort((e,t)=>e.name.localeCompare(t.name)),e.otherSensors.sort((e,t)=>e.name.localeCompare(t.name));return i.sort((e,t)=>e.name.localeCompare(t.name)),{zones:n,unassigned:i}}(e,t,s);if(!(!1!==t.group_by_floor))return[{name:"Climate Zones",zones:o,unassignedSensors:i}];const n=new Map;for(const e of r)n.set(e.name,{name:e.name,zones:[],unassignedSensors:[]});const a={name:"Other",zones:[],unassignedSensors:[]},l=e=>Ce(e,t,r);for(const e of o){const t=l(e),r=n.get(t);r?r.zones.push(e):a.zones.push(e)}for(const e of i){const s=We(e.area_id,e.area,t)??Ye(e.name,e.area,r),o=n.get(s);o?o.unassignedSensors.push(e):a.unassignedSensors.push(e)}const c=r.map(e=>n.get(e.name)).filter(e=>e.zones.length||e.unassignedSensors.length);return(a.zones.length||a.unassignedSensors.length)&&c.push(a),c}const st=["supply","return","flow","manifold","boiler","water_temp","pump","optimal","inlet","outlet","water heater","tankless","hot water"],ot=["supply","supply temp","supply water","supply temperature","outlet","outlet temp","hot water","outgoing"],it=["return","return temp","return water","return temperature","inlet","inlet temp","cold water","incoming"],nt=["flow rate","flow","water flow"],at=["pump","boiler","circulator","manifold pump"],lt=["power","watt","consumption","current consumption","energy usage","power draw"];function ct(e,t){const r=`${Ve(e)} ${Ve(t)}`;return st.some(e=>r.includes(Ve(e)))}function dt(e,t,r){const s=`${Ve(e)} ${Ve(t)}`;return r.some(e=>s.includes(Ve(e)))}function pt(e,t,r=1){const s=Oe(e,t);if(!s)return;const o=Ie(s,r);if(null==o)return;return{entity_id:t,value:o,unit:s.attributes.unit_of_measurement??("humidity"===s.attributes.device_class?"%":"°")}}function ut(e,t,r){const s=`${Ve(t)} ${Ve(r)}`,o=s.includes("inlet"),i=s.includes("outlet");let n=0;return"supply"===e?(i&&(n+=10),o&&!i&&(n-=12),(r.includes("outlet_temp")||r.endsWith("outlet_temperature"))&&(n+=6)):(o&&(n+=10),i&&!o&&(n-=12),(r.includes("inlet_temp")||r.endsWith("inlet_temperature"))&&(n+=6)),n}function At(e,t){const r=t.floor_system;if(!1===r)return null;const s=r||{auto_discover:!0},o=s.supply_temp||s.return_temp||s.flow_rate||s.pump_status||s.power||(s.extra_sensors?.length??0)>0,i=s.auto_discover||!o,n=new Set,a=(t,r)=>t||(i?function(e,t,r){const s={supply:ot,return:it,flow:nt,pump:at,power:lt}[t];let o;for(const i of Object.values(e.states)){if(r.has(i.entity_id))continue;const e=Re(i);if(!ct(e,i.entity_id))continue;if("pump"===t){if(!i.entity_id.startsWith("binary_sensor.")&&!i.entity_id.startsWith("switch."))continue}else if(!i.entity_id.startsWith("sensor."))continue;if(!dt(e,i.entity_id,s))continue;let n=0;if((Ve(e).includes("optimal")||Ve(i.entity_id).includes("optimal"))&&(n+=2),"supply"!==t&&"return"!==t||(n+=ut(t,e,i.entity_id)),"supply"===t&&Ve(e).includes("supply")&&(n+=2),"return"===t&&Ve(e).includes("return")&&(n+=2),"flow"===t&&Ve(e).includes("flow")&&(n+=4),"pump"===t&&(Ve(e).includes("pump")||Ve(e).includes("boiler")||Ve(e).includes("heating"))&&(n+=4),"power"===t){const t=(i.attributes.unit_of_measurement??"").toLowerCase();"w"!==t&&"kw"!==t||(n+=4),(Ve(e).includes("power")||Ve(e).includes("watt"))&&(n+=3),Ve(e).includes("consumption")&&(n+=2)}n<0||(!o||n>o.score)&&(o={id:i.entity_id,score:n})}return o?.id}(e,r,n):void 0),l={},c=a(s.supply_temp,"supply");c&&n.add(c),l.supply_temp=c;const d=a(s.return_temp,"return");d&&n.add(d),l.return_temp=d;const p=a(s.flow_rate,"flow");p&&n.add(p),l.flow_rate=p;const u=a(s.pump_status,"pump");u&&n.add(u),l.pump_status=u;const A=a(s.power,"power");A&&n.add(A),l.power=A;const h=Object.values(e.states).find(e=>e.entity_id.startsWith("water_heater."));h&&(l.heater=h.entity_id);const f=s.extra_sensors??[];f.length&&(l.extra=f.filter(e=>!n.has(e)));return l.supply_temp||l.return_temp||l.flow_rate||l.pump_status||l.power||l.heater||(l.extra?.length??0)>0?l:null}let ht=class extends ce{setConfig(e){this._config={auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e}}_valueChanged(e,t){const r=new CustomEvent("config-changed",{detail:{config:{...this._config,[e]:t}}});this.dispatchEvent(r)}_zoneChanged(e,t,r){const s=[...this._config.zones??[]];s[e]={...s[e],[t]:r},this._valueChanged("zones",s),this._valueChanged("auto_discover",!1)}_addZone(){const e=[...this._config.zones??[],{name:"New Zone",climate_entity:""}];this._valueChanged("zones",e),this._valueChanged("auto_discover",!1)}_removeZone(e){const t=(this._config.zones??[]).filter((t,r)=>r!==e);this._valueChanged("zones",t)}_sensorAssignmentChanged(e,t){const r={...this._config.sensor_map??{}},s=new Set(this._config.exclude_entities??[]);"__hidden__"===t?(s.add(e),delete r[e]):"__auto__"===t?(s.delete(e),delete r[e]):(s.delete(e),r[e]=t),this._valueChanged("sensor_map",r),this._valueChanged("exclude_entities",[...s])}_climateEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("climate."))}_sensorEntities(){return Object.keys(this.hass.states).filter(e=>e.startsWith("sensor."))}_zoneOptions(){return tt(this.hass,this._config).map(e=>({id:e.climate_entity,name:`${e.name}${e.area?` (${e.area})`:""}`}))}_sensorHeightChanged(e,t){const r={...this._config.sensor_heights??{}},s=t.trim();if(s){const t=parseFloat(s);if(Number.isNaN(t)||t<0)return;r[e]=t}else delete r[e];this._valueChanged("sensor_heights",r)}_referenceHeightChanged(e){const t=parseFloat(e);Number.isNaN(t)||t<0||this._valueChanged("reference_height_ft",t)}_zoneFloorChanged(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t,this._valueChanged("zone_floors",r)}render(){if(!this.hass)return L``;const e=function(e,t){const r=tt(e,t),s=Pe(t),o=Me(t),i=t.other_sensor_patterns??ye;return _e(e,t,r).map(n=>{const a=Ke(e,n,i,t),l=o.get(n),c=a?$e(a,r):void 0;return{entity_id:n,name:a?.name??n,area:a?.area,area_id:a?.area_id,value:a?.value,unit:a?.unit,kind:a?.kind??"other",assigned_zone:l,auto_zone:c?.climate_entity,auto_zone_name:c?.name,hidden:s.has(n),height_ft:a?.height_ft}})}(this.hass,this._config),t=tt(this.hass,this._config),r=Se(this.hass),s=Ee(this._config);return L`
      <div class="editor">
        <div class="field">
          <label>Title</label>
          <input
    ...
    `}};e([he({attribute:!1})],ht.prototype,"hass",void 0),e([fe()],ht.prototype,"_config",void 0),ht=e([pe("climate-command-center-editor")],ht);let ft=class extends ce{constructor(){super(...arguments),this._expandedZone=null,this._editSensors=!1,this._setupMode=!1,this._setupSaveReminder=!1,this._view="cards",this._placingThermostat=null,this._forecast=null,this._savePending=!1}_persistConfig(e){this._config=e,function(e,t,r){const s=new CustomEvent(t,{detail:r,bubbles:!0,composed:!0});e.dispatchEvent(s)}(this,"config-changed",{config:e}),this._saveToLovelace(e)}async _saveToLovelace(e){if(this._hass&&!this._savePending){this._savePending=!0;try{const t=this._detectUrlPath(),r=await this._hass.callWS({type:"lovelace/config",url_path:t});if(!r?.views)return;const s=r.views,o={...e};delete o._llInstances,this._findAndReplace(s,o)&&await this._hass.callWS({type:"lovelace/config/save",config:r,url_path:t})}catch(e){console.warn("climate-command-center: config save failed",e)}finally{this._savePending=!1}}}_findAndReplace(e,t){for(const r of e)if(this._replaceInCards(r.cards,t))return!0;return!1}_replaceInCards(e,t){if(!e)return!1;for(let r=0;r<e.length;r++){const s=e[r];if("custom:climate-command-center"===s.type)return e[r]=t,!0;const o=s.cards??s.card;if(Array.isArray(o)&&this._replaceInCards(o,t))return!0;if(o&&!Array.isArray(o)&&"custom:climate-command-center"===o.type)return s.card&&(s.card=t),!0}return!1}_detectUrlPath(){try{const e=window.location.pathname.match(/^\/([^/]+)/),t=e?.[1];return t&&"lovelace"!==t?t:null}catch{return null}}static get styles(){return me}get hass(){return this._hass}set hass(e){const t=this._hass;this._hass=e,!this._floorSystemEntityIds&&e&&this._config&&(this._floorSystemEntityIds=At(e,this._config)),!this._forecastUnsub&&e&&this._subscribeForecast(),(!t||t!==e||this._floorSystemStatesChanged(t,e)||this._sunStateChanged(t,e))&&this.requestUpdate()}_sunStateChanged(e,t){const r=e.states["sun.sun"],s=t.states["sun.sun"];return r&&s?r.last_updated!==s.last_updated:r!==s}_floorSystemStatesChanged(e,t){const r=this._floorSystemEntityIds;if(!r)return!1;for(const s of function(e){const t=[];return e.supply_temp&&t.push(e.supply_temp),e.return_temp&&t.push(e.return_temp),e.flow_rate&&t.push(e.flow_rate),e.pump_status&&t.push(e.pump_status),e.power&&t.push(e.power),e.heater&&t.push(e.heater),e.extra?.length&&t.push(...e.extra),t}(r)){const r=e.states[s],o=t.states[s];if(r?.state!==o?.state)return!0;if(r?.last_updated!==o?.last_updated)return!0}return!1}setConfig(e){if(!e.zones?.length&&!e.auto_discover)throw new Error("Configure zones or enable auto_discover");this._config={title:"Climate Command Center",auto_discover:!0,show_weather:!0,show_room_sensors:!0,group_by_floor:!0,allow_sensor_reassign:!0,reference_height_ft:5,...e,floors:e.floors?.length?e.floors:xe},this._floorSystemEntityIds=void 0,this._hass&&(this._floorSystemEntityIds=At(this._hass,this._config))}getCardSize(){return 6}connectedCallback(){super.connectedCallback(),this._subscribeForecast()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeForecast()}async _subscribeForecast(){if(this._unsubscribeForecast(),!this.hass)return;const e=this._config.weather_entity??Object.keys(this.hass.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(this.hass.states).find(e=>e.startsWith("weather."));if(e)try{this._forecastUnsub=await this.hass.connection.subscribeMessage(e=>{e.forecast&&(this._forecast=e.forecast.slice(0,8))},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:e})}catch{}}_unsubscribeForecast(){this._forecastUnsub&&(this._forecastUnsub(),this._forecastUnsub=void 0)}get sections(){return rt(this.hass,this._config)}get weather(){if(!this._config.show_weather)return null;const e=function(e,t){const r=t.weather_entity??Object.keys(e.states).find(e=>e.startsWith("weather.")&&(e.includes("weatherflow")||e.includes("tempest")))??Object.keys(e.states).find(e=>e.startsWith("weather.")),s=r?Oe(e,r):null,o=s?.attributes??{},i=(t,r,s=[])=>Object.values(e.states).find(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const o=Ve(Re(e)),i=`${Ve(e.entity_id)} ${o}`;if(r&&e.attributes.device_class!==r)return!1;if(!(i.includes("weather")||i.includes("tempest")||i.includes("weatherflow")))return!1;const n=t.some(e=>i.includes(Ve(e))),a=s.some(e=>i.includes(Ve(e)));return n&&!a})?.entity_id,n=o.temperature??Ie(Oe(e,t.weather_temperature??i(["temperature"],"temperature",["wet bulb","dew","feels","heat index","wind chill"])));if(null==n&&!s)return null;const a={label:s?Re(s).replace(/\s*(Weather|Forecast|Cloud)$/i,"")||"Weather":"Outside",temperature:n,condition:s?.state,humidity:o.humidity??Ie(Oe(e,t.weather_humidity??i(["humidity"],"humidity"))),feels_like:Ie(Oe(e,t.weather_feels_like??i(["feels like","apparent"],"temperature"))),dew_point:Ie(Oe(e,t.weather_dew_point??i(["dew point"],"temperature"))),wind_speed:o.wind_speed??Ie(Oe(e,i(["wind speed","wind avg"],void 0))),wind_bearing:o.wind_bearing,wind_gust:Ie(Oe(e,i(["wind gust","gust"],void 0))),pressure:o.pressure??Ie(Oe(e,i(["pressure","barometric"],"pressure"))),uv_index:Ie(Oe(e,i(["uv","ultraviolet"],void 0,["solar"]))),visibility:o.visibility,precipitation:Ie(Oe(e,i(["precipitation","rain"],void 0,["probability","lightning"])))};if(r&&s){const e=o.forecast;e?.length&&(a.forecast=e.slice(0,8))}return a}(this.hass,this._config);return e&&this._forecast?.length&&!e.forecast?.length&&(e.forecast=this._forecast),e}get floorSystem(){return this._hass?(void 0===this._floorSystemEntityIds&&(this._floorSystemEntityIds=At(this._hass,this._config)),this._floorSystemEntityIds?function(e,t){const r={};if(t.supply_temp&&(r.supply_temp=pt(e,t.supply_temp)),t.return_temp&&(r.return_temp=pt(e,t.return_temp)),null!=r.supply_temp?.value&&null!=r.return_temp?.value&&(r.delta_t=Math.round(10*(r.supply_temp.value-r.return_temp.value))/10),t.flow_rate&&(r.flow_rate=pt(e,t.flow_rate)),t.pump_status){const s=Oe(e,t.pump_status);s&&(r.pump_entity=t.pump_status,r.pump_active=function(e){const t=e.state;return"unavailable"!==t&&"unknown"!==t&&(e.entity_id.startsWith("binary_sensor.")||e.entity_id.startsWith("switch.")?"on"===t:"on"===t||"running"===t||"heat"===t||"heating"===t)}(s))}if(t.power&&(r.power=pt(e,t.power,3)),t.heater){const s=Oe(e,t.heater);if(s){r.heater_entity=t.heater,r.heater_state=s.state;const e=s.attributes.temperature;null!=e&&(r.set_temp=e,r.set_temp_unit=s.attributes.unit_of_measurement??s.attributes.temperature_unit??"°")}}if(t.extra?.length){const s=[];for(const r of t.extra){const t=Oe(e,r);if(!t)continue;const o=Ie(t);if(null==o)continue;const i=Ue(Re(t),r),n=t.attributes.unit_of_measurement??("humidity"===t.attributes.device_class?"%":"");s.push({entity_id:r,name:i,value:o,unit:n})}s.length&&(r.extra=s)}return r.supply_temp||r.return_temp||r.flow_rate||r.pump_entity||r.power||(r.extra?.length??0)>0?r:null}(this._hass,this._floorSystemEntityIds):null):null}formatPowerKw(e,t){if(!e||!this._hass)return;const r=this._hass.states[e];if(!r||"unavailable"===r.state||"unknown"===r.state)return;const s=parseFloat(r.state);if(isNaN(s))return;const o="kw"===(r.attributes.unit_of_measurement??t??"").toLowerCase()?s:s/1e3,i=o>=1?1:o>=.01?2:3;return String(parseFloat(o.toFixed(i)))}get sunData(){return function(e){const t=Oe(e,"sun.sun");if(!t)return null;const r=t.attributes.elevation??0,s=t.attributes.azimuth??180,o=t.state,i=t.attributes.next_rising,n=t.attributes.next_setting;if(!i||!n)return null;let a=new Date(i),l=new Date(n);const c=new Date;if("above_horizon"===o){const e=new Date(a.getTime()-864e5);a=e}else{const e=new Date(l.getTime()-864e5);l=e;const t=new Date(a.getTime()-864e5);a=t}const d=l.getTime()-a.getTime(),p=c.getTime()-a.getTime(),u=d>0?p/d:0,A=Math.round(d/6e4),h=Math.max(0,Math.round((l.getTime()-c.getTime())/6e4));return{state:o,elevation:r,azimuth:s,rising:a,setting:l,progress:u,daylight_minutes:A,remaining_minutes:h}}(this.hass)}get totalZones(){return this.sections.reduce((e,t)=>e+t.zones.length,0)}get zoneOptions(){return tt(this.hass,this._config)}get haAreas(){return Se(this.hass)}get floorOptions(){return Ee(this._config)}async setEntityHaArea(e,t){const r=this.hass;r.callWS&&await r.callWS({type:"config/entity_registry/update",entity_id:e,area_id:t})}async updateSensorAssignment(e,t){if(t.startsWith("area:")){const r=t.slice(5);try{await this.setEntityHaArea(e,r)}catch(t){console.error("Failed to set HA area",e,r,t)}return void this.updateSensorMap(e,"__auto__")}this.updateSensorMap(e,t)}updateZoneFloor(e,t){const r={...this._config.zone_floors??{}};"__default__"===t?delete r[e]:r[e]=t;const s={...this._config,zone_floors:r};this._config=s,this._persistConfig(s)}updateZoneKind(e,t){const r={...this._config.zone_kinds??{}};r[e]=t;const s={...this._config,zone_kinds:r};this._config=s,this._persistConfig(s)}toggleSetupMode(){this._setupMode?(this._setupMode=!1,this._setupSaveReminder=!0):(this._setupMode=!0,this._editSensors=!1,this._setupSaveReminder=!1)}updateFloorSystem(e,t){if("disabled"===e){const e="true"===t?{...this._config,floor_system:!1}:{...this._config,floor_system:void 0};return this._config=e,void this._persistConfig(e)}if(!1===this._config.floor_system)return;const r={...this._config.floor_system??{}};""===t||"__auto__"===t?delete r[e]:r[e]=t;const s=r.supply_temp||r.return_temp||r.flow_rate||r.pump_status||r.heater_image||(r.extra_sensors?.length??0)>0,o={...this._config,floor_system:s?r:void 0};this._config=o,this._persistConfig(o)}floorSystemEntityOptions(e){const t=Object.values(this.hass.states),r=(e,t)=>t.some(t=>e.includes(t)),s=e=>{const t=(e.attributes.friendly_name??"").toLowerCase();return`${e.entity_id.toLowerCase()} ${t}`};switch(e){case"supply_temp":case"return_temp":{const o="supply_temp"===e?["supply","hot","outlet","output"]:["return","cold","inlet","input"];return t.filter(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const t=s(e);return!("temperature"!==e.attributes.device_class&&"°F"!==e.attributes.unit_of_measurement&&"°C"!==e.attributes.unit_of_measurement&&!t.includes("temperature")&&!t.includes("temp"))&&(!!r(t,o)||!(!t.includes("water")||!t.includes("heater")))}).map(e=>e.entity_id).sort()}case"flow_rate":return t.filter(e=>{if(!e.entity_id.startsWith("sensor."))return!1;const t=s(e);return r(t,["flow","gpm","gallons","flow_rate"])}).map(e=>e.entity_id).sort();case"pump_status":return t.filter(e=>{const t=e.entity_id.toLowerCase();if(!t.startsWith("switch.")&&!t.startsWith("binary_sensor.")&&!t.startsWith("input_boolean."))return!1;const o=s(e);return r(o,["pump","boiler","circulator","heater","water_heater"])}).map(e=>e.entity_id).sort();default:return[]}}floorSystemFieldValue(e){if(!1===this._config.floor_system)return"__auto__";const t=this._config.floor_system;return t?t[e]??"__auto__":"__auto__"}floorSystemStatusLabel(){if(!1===this._config.floor_system)return"Disabled";const e=this._config.floor_system;if(!e)return"Auto-discovered";return e.supply_temp||e.return_temp||e.flow_rate||e.pump_status?"Configured":"Auto-discovered"}entityOptionLabel(e){const t=this.hass.states[e];return`${t?.attributes?.friendly_name??e} (${e})`}renderFloorSystemFieldSelect(e,t){const r=this.floorSystemEntityOptions(t),s=this.floorSystemFieldValue(t),o=!1===this._config.floor_system;return L`
    ...
    `:null}renderHeightBadge(e){return null==e?null:L`<span class="height-badge">${e} ft</span>`}renderZoneHeightStats(e,t){const r=be(e,this._config,t);return r?L`
    ...
    `:null}modeClass(e){return"heat"===e?"mode-heat":"cool"===e?"mode-cool":"heat_cool"===e?"mode-auto":"off"===e?"mode-off":""}actionLabel(e){return e&&"off"!==e?"heating"===e?"Heating":"cooling"===e?"Cooling":"idle"===e?"Idle":"drying"===e?"Drying":"fan"===e?"Fan":e:"Off"}actionClass(e){return"heating"===e?"action-heating":"cooling"===e?"action-cooling":"idle"===e?"action-idle":"action-off"}tempDelta(e,t){if(null!=e&&null!=t)return Math.round(10*(e-t))/10}renderValveLine(e){if("thermostat"===e.kind)return null;const t=e.valves?.length?e.valves:e.valve_entity?[{entity_id:e.valve_entity,position:e.valve_position??0,active:!0===e.valve_active}]:[];if(!t.length)return null;const r=e.sensors.floor,s=this.tempToColor(r),o=e.climate_entity.replace(/\./g,"-");return L`
      ${t.map((e,t)=>{const r=e.active,i=e.position,n=e.entity_id.replace(/\./g,"-"),a=`valve-flow-${o}-${n}-${t}`,l=r?s.replace("rgb(","rgba(").replace(")",",0.1)"):"rgba(100,100,120,0.15)";return L`
        ...
        `})}
    `}renderHydronicLoop(e,t){if("thermostat"===e.kind)return null;const r=e.valves?.length?e.valves:e.valve_entity?[{entity_id:e.valve_entity,position:e.valve_position??0,active:!0===e.valve_active}]:[],s=r.some(e=>e.active),o="heating"===t||s,i=e.sensors.floor,n=this.tempToColor(i),a=e.climate_entity.replace(/\./g,"-"),l="M 10,12 L 270,12 Q 280,12 280,22 L 280,32",c="M 280,32 Q 280,42 270,42 L 10,42",d="rgba(100,110,130,0.25)",p="rgba(130,130,150,0.2)",u=n.replace("rgb(","rgba(").replace(")",",0.12)");return L`
      <div class="hydronic-loop">
        <svg class="hydronic-svg" viewBox="0 0 290 54" preserveAspectRatio="xMidYMid meet">
          ...
          <path d="${l}" fill="none" stroke="${o?n:p}" stroke-width="8" stroke-linecap="round" opacity="0.3"/>
          <path d="${l}" fill="none" stroke="${o?`url(#hflow-s-${a})`:d}" stroke-width="6" stroke-linecap="round"/>

          <!-- Return pipe (bottom, right to left) -->
          <path d="${c}" fill="none" stroke="${o?n:p}" stroke-width="8" stroke-linecap="round" opacity="0.3"/>
          <path d="${c}" fill="none" stroke="${o?`url(#hflow-r-${a})`:d}" stroke-width="6" stroke-linecap="round"/>

          <!-- Supply label -->
          <text x="14" y="9" font-size="5.5" fill="${o?n:"rgba(150,150,170,0.5)"}" font-family="sans-serif" font-weight="700" opacity="0.7">SUPPLY</text>
          <!-- Return label -->
          <text x="14" y="50" font-size="5.5" fill="${o?n:"rgba(150,150,170,0.5)"}" font-family="sans-serif" font-weight="700" opacity="0.7">RETURN</text>
    ...
    `}tempToColor(e){if(null==e)return"#64b5f6";const t=(Math.max(50,Math.min(140,e))-50)/90;if(t<.33){return`rgb(${Math.round(30+3*t*70)},${Math.round(130+3*t*70)},${Math.round(245-3*t*50)})`}if(t<.66){const e=(t-.33)/.33;return`rgb(${Math.round(100+155*e)},${Math.round(200-50*e)},${Math.round(195-145*e)})`}{const e=(t-.66)/.34;return`rgb(${Math.round(255)},${Math.round(150-80*e)},${Math.round(50-30*e)})`}}renderFloorSystem(){const e=this.floorSystem;if(!e)return null;const t=e.return_temp?.value,r=e.supply_temp?.value,s=this.tempToColor(t),o=this.tempToColor(r),i=e.return_temp?.unit??"°",n=e.supply_temp?.unit??"°",a=this._config.floor_system,l=(!1!==a&&a?.heater_image?.trim()?a.heater_image.trim():void 0)??"data:image/png;base64,",c=null!=e.flow_rate?.value?Number(e.flow_rate.value):NaN,d=!isNaN(c)&&c>=.02,p=136,u=136,A=132,h=12,f=14,m=164.64,g=A+97.92;return L`
      <div class="floor-system tankless-visual">
        <svg class="tankless-svg" viewBox="0 0 400 230" preserveAspectRatio="xMidYMid meet">
          ...
          ${(()=>{const t=e.heater_state??"",s="idle"!==t&&"off"!==t&&""!==t&&"unavailable"!==t,o=s?"#1b5e20":"#1a1a1a",i=s?"rgba(27,94,32,0.7)":"rgba(0,0,0,0.45)";return G`
              <text x="${220.4}" y="${null!=e.set_temp?43.28:48.72}" font-size="11" text-anchor="middle"
                fill="${o}" font-family="sans-serif" font-weight="800"
              >${null!=e.set_temp?`${e.set_temp}°`:null!=r?`${r}${n}`:"—"}</text>
              ${null!=e.set_temp?G`
                <text x="${220.4}" y="${54.16}" font-size="5" text-anchor="middle"
                  fill="${i}" font-family="sans-serif" font-weight="700">SET</text>
              `:""}
            `})()}
          ...
          <text x="42" y="${158}" font-size="11" text-anchor="middle" fill="${o}" font-family="sans-serif" font-weight="700">${null!=r?`${r}${n}`:"—"}</text>
          ...
          <text x="358" y="${158}" font-size="11" text-anchor="middle" fill="${s}" font-family="sans-serif" font-weight="700">${null!=t?`${t}${i}`:"—"}</text>
    ...
    `:null}renderSunTracker(){if(!1===this._config.show_sun_tracker)return null;const e=this.sunData;if(!e)return null;const t="above_horizon"===e.state,r=200,s=95,o=[];for(let e=0;e<=120;e++){const t=Math.PI+e/120*Math.PI;o.push({x:r+170*Math.cos(t),y:s+75*Math.sin(t)})}const i=`M ${o.map(e=>`${e.x},${e.y}`).join(" L ")}`,n=Math.max(0,Math.min(1,(e.azimuth-60)/240)),a=Math.PI+n*Math.PI,l=r+170*Math.cos(a),c=s+75*Math.sin(a),d=o.length-1,p=o[0],u=o[d],A=Math.round(120*n),h=`M ${o.slice(0,Math.min(A+1,o.length)).map(e=>`${e.x},${e.y}`).join(" L ")}`,f=e=>e.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}),m=f(e.rising),g=f(e.setting),b=(new Date).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}),v=Math.floor(e.remaining_minutes/60),y=e.remaining_minutes%60,x=t?`${v}h ${y}m`:"";return L`
      <div class="sun-tracker">
        <svg class="sun-tracker-svg" viewBox="0 0 400 110">
          ...
          <path d="${i}" fill="none" stroke="rgba(255,235,59,0.15)" stroke-width="1" stroke-dasharray="4,3"/>
    ...
    `}renderSensorAssign(e){if(!this._editSensors)return null;const t=this._config.sensor_map?.[e.entity_id]??(this._config.exclude_entities?.includes(e.entity_id)?"__hidden__":"__auto__"),r=$e(e,this.zoneOptions),s=e.area?`Auto (HA: ${e.area}${r?` → ${r.name}`:""})`:r?`Auto (→ ${r.name})`:"Auto (by HA area)";return L`
      <select
    ...
    `:L``}renderZone(e){const t=this.hass.states[e.climate_entity];if(!t)return L``;const r=t.attributes,s=r.current_temperature,o=r.temperature,i=r.humidity,n=r.hvac_action,a=t.state,l=this._expandedZone===e.climate_entity,c=e.sensors,d=r.hvac_modes??["heat","off"],p="floor_heat"===e.kind?d.filter(e=>"heat"===e||"off"===e):d;return L`
      <div class="zone-card ${l?"expanded":""} ${e.kind} ${this.modeClass(a)} ${this.actionClass(n)}">
        <div class="zone-header" @click=${()=>this.toggleExpand(e.climate_entity)}>
          <div class="zone-info">
            ...
            <div class="zone-status-row">
              ...
              <span class="zone-action ${this.actionClass(n)}">
                ${"heating"===n?"🔥 ":"cooling"===n?"❄️ ":""}${this.actionLabel(n)}
              </span>
            </div>
        ...
        <div class="zone-temp-grid">
          ...
          ${null!=i?L`
                <div class="temp-cell">
                  ...
                  <span class="temp-cell-value">${i}%</span>
                </div>
              `:null!=c.humidity?L`
                  <div class="temp-cell">
                    <span class="temp-cell-label">Humidity</span>
    ...
    `}get fpThermostats(){return this._config.floor_plan?.thermostats??[]}fpEntityData(e){const t=this.hass.states[e];if(!t)return null;const r=t.attributes??{},s=e.startsWith("climate.");return{state:t.state,action:s?r.hvac_action:void 0,current:s?r.current_temperature:parseFloat(t.state)||void 0,target:s?r.temperature:void 0,name:r.friendly_name??e,unit:r.unit_of_measurement??""}}handleFpClick(e){if(!this._placingThermostat)return;const t=e.currentTarget.getBoundingClientRect(),r=Math.round((e.clientX-t.left)/t.width*100),s=Math.round((e.clientY-t.top)/t.height*100),o={entity_id:"",label:"wall"===this._placingThermostat?"Wall Thermostat":"Floor Sensor",kind:this._placingThermostat,x:Math.max(0,Math.min(100,r)),y:Math.max(0,Math.min(100,s))},i=[...this.fpThermostats];i.push(o);const n={...this._config,floor_plan:{...this._config.floor_plan,thermostats:i}};this._config=n,this._persistConfig(n),this._placingThermostat=null}removeFpThermostat(e){const t=[...this.fpThermostats];t.splice(e,1);const r={...this._config,floor_plan:{...this._config.floor_plan,thermostats:t}};this._config=r,this._persistConfig(r)}updateFpThermostat(e,t,r){const s=this.fpThermostats.map((s,o)=>o===e?{...s,[t]:r}:s),o={...this._config,floor_plan:{...this._config.floor_plan,thermostats:s}};this._config=o,this._persistConfig(o)}renderFloorPlan(){const e=this.fpThermostats,t=this._placingThermostat,r=Object.keys(this.hass.states).filter(e=>e.startsWith("climate.")||e.startsWith("sensor.")).sort();return L`
    ...
    `}};e([he({attribute:!1})],ft.prototype,"_config",void 0),e([fe()],ft.prototype,"_expandedZone",void 0),e([fe()],ft.prototype,"_editSensors",void 0),e([fe()],ft.prototype,"_setupMode",void 0),e([fe()],ft.prototype,"_setupSaveReminder",void 0),e([fe()],ft.prototype,"_view",void 0),e([fe()],ft.prototype,"_placingThermostat",void 0),e([fe()],ft.prototype,"_forecast",void 0),ft=e([pe("climate-command-center")],ft),window.customCards=window.customCards??[],window.customCards.push({type:"climate-command-center",name:"Climate Command Center",description:"Unified dashboard for thermostats, heated floors, and weather sensors",preview:!0}),console.info("%c CLIMATE-COMMAND-CENTER %c v0.5.1 ","color: white; background: #0288d1; font-weight: 700;","color: #0288d1; background: white; font-weight: 700;");const mt=()=>ft,gt=()=>document.createElement("climate-command-center-editor");export{ft as ClimateCommandCenterCard,mt as getCard,gt as getCardEditor};
