        ...
        <svg class="tankless-svg" viewBox="0 0 400 180" preserveAspectRatio="xMidYMid meet">
          <defs>
            ...
            <pattern id="outletFlow" x="0" y="0" width="28" height="16" patternUnits="userSpaceOnUse">
              ...
              <circle r="1.5" cx="8" cy="12" fill="${outletColor}" opacity="0.6">
